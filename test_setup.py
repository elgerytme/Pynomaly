...
def test_setup():
    ...
    if externally_managed:
        print("🔍 Attempting alternative validation for externally managed environment...")
        ...
        try:
            ...
            print("💡 Note: Full pip validation skipped due to externally managed environment")
            return True
