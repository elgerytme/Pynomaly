...
def test_complete_workflow():
    ...
    try:
        ...
        df = pd.DataFrame(all_data, columns=['feature_1', 'feature_2', 'feature_3', 'feature_4', 'feature_5'])
        ...
        print(f"✓ Training dataset created: {training_dataset.n_samples} samples x {training_dataset.n_features} features")
        ...
        try:
            ...
            print(f"     Detector is fitted: {training_response.trained_detector.is_fitted}")
            ...
            if hasattr(detector, 'fit'):
                ...
                print("       The detector domain entity should not have algorithm-specific methods")
        ...
        if reloaded_dataset:
            ...
            print(f"     Shape: {reloaded_dataset.n_samples}x{reloaded_dataset.n_features}")
        else:
