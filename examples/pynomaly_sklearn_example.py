...
def run_pynomaly_sklearn_example():
    ...
    print(f"Training time: {detector.metadata.get('training_time_ms', 'unknown'):.2f}ms")
    ...
    print("\nNext steps:")
    print("- Try different algorithms: LocalOutlierFactor, OneClassSVM, EllipticEnvelope")
