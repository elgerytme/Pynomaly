...
from pynomaly.application.services.anomaly_classification_service import (
...
def test_basic_classification():
    ...
    anomaly = Anomaly(
        score=score, data_point={"feature1": 1.0}, detector_name="test_detector"
    )
...
def test_dependency_injection():
    ...
    custom_severity_classifier = DefaultSeverityClassifier(
        {"critical": 0.8, "high": 0.6, "medium": 0.4, "low": 0.0}
    )
...
def test_dashboard_classifiers():
    ...
    assert (
        "Anomaly" in anomaly_type
    ), f"Expected dashboard-friendly type, got '{anomaly_type}'"
...
def test_severity_levels():
    ...
    test_cases = [(0.95, "critical"), (0.75, "high"), (0.55, "medium"), (0.25, "low")]
    ...
    for score_value, expected_severity in test_cases:
        ...
        ), f"Score {score_value}: expected '{expected_severity}', got '{actual_severity}'"
