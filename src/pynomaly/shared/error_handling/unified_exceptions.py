...
class PynamolyError(Exception):
    ...
    def set_retry_info(self, retry_possible: bool, retry_after: Optional[int] = None) -> None:
...
class ValidationError(PynamolyError):
    ...
    def __init__(self, error_code: str, message: str, field_name: Optional[str] = None, **kwargs):
        super().__init__(
            error_code=error_code,
            message=message,
