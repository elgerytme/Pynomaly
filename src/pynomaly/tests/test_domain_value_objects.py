...
class TestAnomalyScore:
    ...
    def test_anomaly_score_confidence_level(self):
        ...
        assert confidence == 0.4  # Distance from threshold is 0.9 - 0.5 = 0.4
...
class TestContaminationRate:
    ...
    def test_high_contamination_rate(self):
        ...
        assert rate.as_percentage() == 30.0
...
class TestThresholdConfig:
    ...
    def test_invalid_threshold_config(self):
        ...
        with pytest.raises(InvalidValueError):
            ThresholdConfig(method="percentile", value=150.0)  # Invalid percentile value
