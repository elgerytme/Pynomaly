...
class DetectAnomaliesUseCase:
    ...
    async def execute(self, request: DetectAnomaliesRequest) -> DetectAnomaliesResponse:
        ...
        try:
            ...
            scores = self.adapter_registry.score_with_detector(detector, request.dataset)
            predictions = self.adapter_registry.predict_with_detector(detector, request.dataset)
