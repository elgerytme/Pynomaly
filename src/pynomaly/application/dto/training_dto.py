...
from pynomaly.domain.value_objects.hyperparameters import HyperparameterSet, HyperparameterSpace
...
class AutoMLConfigDTO:
    ...
    model_selection_strategy: str = "best_single_metric"  # best_single_metric, weighted_score, pareto_optimal
...
class TrainingConfigDTO:
    ...
    resource_constraints: ResourceConstraintsDTO = field(default_factory=ResourceConstraintsDTO)
    notification_config: NotificationConfigDTO = field(default_factory=NotificationConfigDTO)
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'TrainingConfigDTO':
        ...
        if 'validation_config' in data:
            data['validation_config'] = ValidationConfigDTO.from_dict(data['validation_config'])
        
        if 'optimization_config' in data and data['optimization_config']:
            data['optimization_config'] = OptimizationConfigDTO.from_dict(data['optimization_config'])
        
        if 'resource_constraints' in data:
            data['resource_constraints'] = ResourceConstraintsDTO.from_dict(data['resource_constraints'])
        
        if 'notification_config' in data:
            data['notification_config'] = NotificationConfigDTO.from_dict(data['notification_config'])
...
class TrainingResultDTO:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'TrainingResultDTO':
        ...
        if 'baseline_metrics' in data and data['baseline_metrics']:
            data['baseline_metrics'] = ModelMetricsDTO.from_dict(data['baseline_metrics'])
