...
class BackupCodeVerificationRequest(BaseModel):
    ...
    backup_code: str = Field(..., min_length=6, max_length=10, description="Backup recovery code")
...
class MFAEnableRequest(BaseModel):
    ...
    verification_code: str = Field(..., description="Verification code to confirm setup")
...
class MFADisableRequest(BaseModel):
    ...
    verification_code: str = Field(..., description="Verification code to confirm disable")
...
class MFALoginRequest(BaseModel):
    ...
    remember_device: bool = Field(False, description="Remember this device for future logins")
