...
from pynomaly.domain.entities.integrations import (
    Integration, IntegrationType, IntegrationStatus, IntegrationConfig, IntegrationCredentials,
    NotificationPayload, NotificationTemplate, NotificationHistory, IntegrationMetrics,
    TriggerType, NotificationLevel, DEFAULT_TEMPLATES
)
...
class IntegrationService:
    ...
    # Public API Methods
    async def get_integration_metrics(self, integration_id: str) -> Optional[IntegrationMetrics]:
