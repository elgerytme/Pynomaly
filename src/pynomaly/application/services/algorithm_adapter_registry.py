...
class BaseAlgorithmAdapter(ABC):
    ...
    def score(self, detector: Detector, dataset: Dataset) -> List[AnomalyScore]:
        ...
        return [
            AnomalyScore(
                value=float(score),
                method=detector.algorithm_name
            )
...
class AlgorithmAdapterRegistry:
    ...
    def get_adapter_for_algorithm(self, algorithm_name: str) -> Optional[AlgorithmAdapter]:
    ...
    def score_with_detector(self, detector: Detector, dataset: Dataset) -> List[AnomalyScore]:
