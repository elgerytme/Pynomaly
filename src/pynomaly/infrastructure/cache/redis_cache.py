...
class CachedRepository:
    ...
    def _get_from_cache(self, key: str, loader_func, ttl: int | None = None):
...
class DetectorCacheDecorator:
    ...
    def cache_detection(self, ttl: int | None = None):
    ...
    def invalidate_detection(self, detector_id: str):
        ...
        logger.info(
            f"Invalidated {deleted} detection results for detector {detector_id}"
        )
