...
class ConnectionPoolManager:
    ...
    def __init__(self):
        ...
        self._pools: Dict[str, Union[DatabasePool, RedisPool, HTTPConnectionPool]] = {}
    ...
    def get_pool(self, name: str) -> Union[DatabasePool, RedisPool, HTTPConnectionPool]:
        """Get pool by name.
    ...
    async def close_all_pools(self) -> None:
        ...
        if pools_to_close:
            await asyncio.gather(
                *[pool.close() for pool in pools_to_close],
