...
from ...application.services.algorithm_optimization_service import AlgorithmOptimizationService
...
class OptimizedAdapter:
    ...
    def __init__(
        self,
        detector: Detector,
        base_adapter_class: Optional[Type] = None,
        ...
        self.base_adapter: Optional[Any] = None
        self.optimized_detector: Optional[Detector] = None
    ...
    def fit(self, dataset: Dataset) -> None:
        ...
        detector_to_use = self.optimized_detector if self.is_optimized else self.detector
    ...
    def get_optimization_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'base_adapter_class': self.base_adapter_class.__name__ if self.base_adapter_class else None,
    ...
    def _determine_base_adapter_class(self) -> Type:
        ...
        # PyOD algorithms
        pyod_algorithms = {
            'knn', 'abod', 'hbos', 'pca', 'mcd', 'ocsvm', 'lmdd',
            'cblof', 'feature_bagging', 'iforest', 'histogram'
        }
        
        # Sklearn algorithms  
        sklearn_algorithms = {
            'isolationforest', 'localoutlierfactor', 'oneclasssvm', 
            'ellipticenvelope', 'svm'
        }
...
class OptimizedEnsembleAdapter:
    ...
    def __init__(
        ...
        self.ensemble_results: Optional[Dict[str, Any]] = None
    ...
    def get_ensemble_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'individual_optimizations': [
                adapter.get_optimization_status() 
                for adapter in self.optimized_adapters
            ]
        }
    ...
    def _combine_by_weights(self, results: list[DetectionResult]) -> DetectionResult:
        ...
        for result, weight in zip(results, self.ensemble_weights):
