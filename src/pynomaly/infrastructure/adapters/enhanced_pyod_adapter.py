    ...
    ALGORITHM_MAPPING: Dict[str, Tuple[str, str, AlgorithmMetadata]] = {
        ...
        "IsolationForest": (
            ...
            AlgorithmMetadata(
                ...
                typical_use_cases=["General purpose", "Large datasets", "Mixed data types"]
            )
        ),
        "FeatureBagging": (
        ...
        "AutoEncoder": (
            ...
            AlgorithmMetadata(
                ...
                typical_use_cases=["Complex patterns", "High-dimensional data", "Images"]
            )
        ),
        "VAE": (
            "pyod.models.vae", "VAE",
    ...
    def explain(
        ...
        for idx in indices:
            ...
            explanations[idx] = {
                ...
                "anomaly_score": float(self._model.decision_function(X[idx:idx+1])[0]),
                "algorithm": self._algorithm_name,
    ...
    def recommend_algorithms(
        ...
        for name, (_, _, metadata) in cls.ALGORITHM_MAPPING.items():
            ...
            # General recommendations
                ...
                if "n²" not in metadata.complexity_time and "n³" not in metadata.complexity_time:
                    recommendations.append(name)
            else:
