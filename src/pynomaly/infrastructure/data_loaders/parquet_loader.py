        ...
        **kwargs: Any
        ...
        try:
            ...
            metadata = {
                ...
                "created_by": str(parquet_file.metadata.created_by) if parquet_file.metadata.created_by else None
            }
    ...
    def estimate_size(self, source: Union[str, Path]) -> Dict[str, Any]:
        ...
        try:
            ...
            for field in parquet_file.schema:
                ...
                if "int" in str(field.type).lower() or "float" in str(field.type).lower() or "double" in str(field.type).lower():
                    numeric_columns += 1
