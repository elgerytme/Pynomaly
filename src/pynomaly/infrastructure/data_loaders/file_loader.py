...
class CSVLoader:
    ...
    def load(self, source: str | Path, **kwargs: Any) -> Dataset:
        ...
        try:
            ...
            logger.info(f"CSV loaded successfully: {data.shape[0]} rows, {data.shape[1]} columns")
            return dataset
        ...
        try:
            ...
            if file_path.suffix.lower() in {".jsonl", ".ndjson"}:
                ...
                if isinstance(json_data, list):
                    ...
                    raise ValueError("JSON structure not supported for conversion to DataFrame")
            ...
            dataset = Dataset(
                ...
                metadata={
                    ...
                    "file_size": file_path.stat().st_size,
                    "loader": "JSONLoader",
                    "json_format": "lines" if file_path.suffix.lower() in {".jsonl", ".ndjson"} else "standard",
                }
            )
            
            logger.info(f"JSON loaded successfully: {data.shape[0]} rows, {data.shape[1]} columns")
            return dataset
...
class ParquetLoader:
    ...
    def load(self, source: str | Path, **kwargs: Any) -> Dataset:
        ...
        try:
            ...
            logger.info(f"Parquet loaded successfully: {data.shape[0]} rows, {data.shape[1]} columns")
            return dataset
...
class ExcelLoader:
    ...
    def load(self, source: str | Path, **kwargs: Any) -> Dataset:
        ...
        try:
            ...
            logger.info(f"Excel loaded successfully: {data.shape[0]} rows, {data.shape[1]} columns")
            return dataset
...
class DataLoaderService:
    ...
    def load_file(
        ...
        **kwargs: Any
        ...
        try:
            ...
            logger.error(f"Failed to load file {file_path} with {loader_type} loader: {e}")
            raise
    ...
    def get_supported_formats(self) -> dict[str, list[str]]:
        ...
        return {
            loader_name: loader.get_supported_formats() if hasattr(loader, 'get_supported_formats') 
