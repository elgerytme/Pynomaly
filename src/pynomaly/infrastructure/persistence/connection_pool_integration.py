...
from .production_database import ProductionDatabaseManager, get_production_database_manager
    ...
    async def perform_maintenance(self) -> dict[str, Any]:
        ...
        if self.production_manager:
            ...
            try:
                ...
                optimization_report = await self.enhanced_manager.get_optimization_report()
                maintenance_results["optimization_report"] = optimization_report
                maintenance_results["tasks_completed"].append("optimization_report_generated")
