...
class EnhancedConfigLoader:
    ...
    def _apply_config_data(self, config: CoreArchitectureConfig, data: Dict[str, Any]) -> CoreArchitectureConfig:
        ...
        if 'anomaly_detection' in data:
            ...
            if 'default_algorithm' in ad_config:
                config.anomaly_detection.default_algorithm = ad_config['default_algorithm']
