...
class StudyConfig:
    ...
    directions: List[ObjectiveDirection] = field(default_factory=lambda: [ObjectiveDirection.MAXIMIZE])
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'OptimizationConfig':
        ...
        if 'study_config' in data:
            ...
            if 'directions' in study_data:
                study_data['directions'] = [ObjectiveDirection(d) for d in study_data['directions']]
