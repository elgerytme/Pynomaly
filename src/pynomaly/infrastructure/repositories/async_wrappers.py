...
class AsyncDetectorRepositoryWrapper:
    ...
    async def find_by_id(self, entity_id: UUID) -> Optional[Detector]:
    ...
    async def find_by_name(self, name: str) -> Optional[Detector]:
    ...
    async def load_model_artifact(self, detector_id: UUID) -> Optional[bytes]:
    ...
    async def get(self, entity_id: UUID) -> Optional[Detector]:
...
class AsyncDatasetRepositoryWrapper:
    ...
    async def find_by_id(self, entity_id: UUID) -> Optional[Dataset]:
    ...
    async def load_data(self, dataset_id: UUID) -> Optional[Dataset]:
    ...
    # Compatibility methods for legacy code
    async def get(self, entity_id: UUID) -> Optional[Dataset]:
        """Alias for find_by_id for compatibility."""
        return await self.find_by_id(entity_id)
    
    async def get_by_id(self, entity_id: UUID) -> Optional[Dataset]:
        """Alias for find_by_id for compatibility."""
        return await self.find_by_id(entity_id)
...
class AsyncDetectionResultRepositoryWrapper:
    ...
    async def find_by_id(self, entity_id: UUID) -> Optional[DetectionResult]:
    ...
    # Compatibility methods for legacy code
    async def get(self, entity_id: UUID) -> Optional[DetectionResult]:
        """Alias for find_by_id for compatibility."""
        return await self.find_by_id(entity_id)
    
    async def get_by_id(self, entity_id: UUID) -> Optional[DetectionResult]:
        """Alias for find_by_id for compatibility."""
        return await self.find_by_id(entity_id)