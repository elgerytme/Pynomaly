...
class ConfigurationCaptureMiddleware(BaseHTTPMiddleware):
    ...
    def _extract_parameters(
        ...
        if request_data.query_parameters:
            parameters.update(
                self._extract_anomaly_params(request_data.query_parameters)
            )
    ...
    def _extract_execution_results(
        self, response_data: ResponseConfigurationDTO
    ) -> dict[str, Any]:
    ...
    def _extract_api_version(self, request: Request) -> str | None:
    ...
    def _parse_platform(self, user_agent: str | None) -> str:
    ...
    def _determine_client_type(self, user_agent: str | None) -> str:
...
class ConfigurationAPIMiddleware:
    ...
    def create_middleware(
        configuration_service: ConfigurationCaptureService, **kwargs
        ...
        return lambda app: ConfigurationCaptureMiddleware(
            app=app, configuration_service=configuration_service, **kwargs
        )
