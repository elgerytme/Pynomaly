...
class JWTAuthService:
    ...
    def create_access_token(self, user: UserModel) -> TokenResponse:
        ...
        refresh_payload = payload.model_copy(update={
            "exp": refresh_expire,
            "type": "refresh"
        })
    ...
    def check_permissions(self, user: UserModel, required_permissions: List[str]) -> bool:
    ...
    def require_permissions(self, user: UserModel, permissions: List[str]) -> None:
        ...
        if not self.check_permissions(user, permissions):
            raise AuthorizationError(
                f"User lacks required permissions: {permissions}"
            )
    ...
    def _get_permissions_for_roles(self, roles: List[str]) -> List[str]:
        ...
        role_permissions = {
            "admin": [
                "detectors:read", "detectors:write", "detectors:delete",
    ...
    def create_user(self, username: str, email: str, password: str, 
                   full_name: Optional[str] = None, roles: Optional[List[str]] = None) -> UserModel:
        """Create a new user.
...
def get_auth() -> Optional[JWTAuthService]:
