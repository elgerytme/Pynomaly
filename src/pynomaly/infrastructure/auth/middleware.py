...
async def get_current_user(
    ...
    auth_service: Annotated[Optional[JWTAuthService], Depends(get_auth)]
) -> Optional[UserModel]:
...
async def get_current_active_user(
    current_user: Annotated[Optional[UserModel], Depends(get_current_user)],
...
class PermissionChecker:
    ...
    async def __call__(
        self,
        current_user: Annotated[Optional[UserModel], Depends(get_current_active_user)],
        auth_service: Annotated[Optional[JWTAuthService], Depends(get_auth)]
    ) -> UserModel:
...
def create_auth_context(user: Optional[UserModel]) -> Dict[str, any]:
