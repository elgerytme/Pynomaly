...
class EncryptionService:
    ...
    def create_key(self, password: Optional[str] = None, key_id: Optional[str] = None) -> str:
...
class DataEncryption:
    ...
    def decrypt_sensitive_data(self, encrypted_data: str, return_type: type = str) -> Any:
...
_encryption_service: Optional[DataEncryption] = None
...
def init_encryption_service(config: Optional[EncryptionConfig] = None) -> DataEncryption:
