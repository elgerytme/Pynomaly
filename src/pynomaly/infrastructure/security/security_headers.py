...
class CSPConfig(BaseModel):
    ...
    style_src: List[str] = Field(default_factory=lambda: [CSPSource.SELF, CSPSource.UNSAFE_INLINE])
...
class SecurityHeaders(BaseModel):
    ...
    csp_config: Optional[CSPConfig] = Field(default_factory=CSPConfig)
    ...
    remove_headers: Set[str] = Field(default_factory=lambda: {
    ...
    def get_permissions_policy_header(self) -> Optional[str]:
...
class SecurityHeadersMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(self, app, config: Optional[SecurityHeaders] = None):
...
def create_development_csp() -> CSPConfig:
    ...
    return CSPConfig(
        ...
        script_src=[CSPSource.SELF, CSPSource.UNSAFE_INLINE, CSPSource.UNSAFE_EVAL, "localhost:*"],
