...
class Model:
    ...
    def __post_init__(self) -> None:
        ...
        if not isinstance(self.model_type, ModelType):
            raise TypeError(f"Model type must be ModelType, got {type(self.model_type)}")
    ...
    def update_metadata(self, key: str, value: Any, updated_by: Optional[str] = None) -> None:
    ...
    def get_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "latest_version_id": str(self.latest_version_id) if self.latest_version_id else None,
    ...
    def can_deploy(self) -> tuple[bool, List[str]]:
        ...
        required_metadata = ["business_impact", "data_validation", "performance_baseline"]
