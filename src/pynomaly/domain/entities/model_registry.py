...
class AccessPolicy:
    ...
    def can_read(self, user: str, groups: Optional[List[str]] = None) -> bool:
    ...
    def can_write(self, user: str, groups: Optional[List[str]] = None) -> bool:
        ...
        if groups:
            for group in groups:
                ...
                if group_level and group_level in {AccessLevel.WRITE, AccessLevel.ADMIN}:
                    return True
        
        return False
    
    def is_admin(self, user: str, groups: Optional[List[str]] = None) -> bool:
...
class Model:
    ...
    production_version_id: Optional[UUID] = None
    staging_version_id: Optional[UUID] = None
    ...
    def get_latest_version(self) -> Optional[ModelVersion]:
        ...
        latest_version_str = max(
            self.versions.keys(),
            key=lambda v: SemanticVersion.from_string(v)
        )
    ...
    def get_staging_version(self) -> Optional[ModelVersion]:
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "production_version": production_version.version_string if production_version else None,
    ...
    def get_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "production_version_id": str(self.production_version_id) if self.production_version_id else None,
            "staging_version_id": str(self.staging_version_id) if self.staging_version_id else None,
        }
...
class ModelRegistry:
    ...
    def register_model(self, model: Model, user: str, groups: Optional[List[str]] = None) -> None:
    ...
    def get_model(self, model_id: UUID, user: str, groups: Optional[List[str]] = None) -> Optional[Model]:
        """Get a model by ID.
    ...
    def get_model_by_name(self, name: str, user: str, groups: Optional[List[str]] = None) -> Optional[Model]:
        """Get a model by name.
    ...
    def get_models_by_domain(self, domain: str, user: str, groups: Optional[List[str]] = None) -> List[Model]:
        """Get all models for a specific domain."""
        return self.list_models(user, groups, domain_filter=domain)
    
    def get_models_by_algorithm(self, algorithm: str, user: str, groups: Optional[List[str]] = None) -> List[Model]:
        """Get all models using a specific algorithm."""
        return self.list_models(user, groups, algorithm_filter=algorithm)
    
    def get_models_by_owner(self, owner: str, user: str, groups: Optional[List[str]] = None) -> List[Model]:
        """Get all models owned by a specific user."""
        return self.list_models(user, groups, owner_filter=owner)
    
    def remove_model(self, model_id: UUID, user: str, groups: Optional[List[str]] = None) -> bool:
    ...
    def get_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "access_policy": {
                "users": {user: level.value for user, level in self.access_policy.users.items()},
                "groups": {group: level.value for group, level in self.access_policy.groups.items()},
