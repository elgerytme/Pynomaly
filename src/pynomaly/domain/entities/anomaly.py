...
class Anomaly:
    ...
    score: Union[AnomalyScore, float]
    ...
    def __post_init__(self) -> None:
        ...
        if not isinstance(self.score, (AnomalyScore, int, float)):
            raise TypeError(f"Score must be AnomalyScore or number, got {type(self.score)}")
