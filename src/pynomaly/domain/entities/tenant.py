...
class TenantConfiguration:
    ...
    allowed_data_formats: Set[str] = field(default_factory=lambda: {"csv", "json", "parquet"})
...
class Tenant:
    ...
    # Resource management
    resource_quotas: Dict[ResourceQuotaType, ResourceQuota] = field(default_factory=dict)
    ...
    def _initialize_default_quotas(self):
        ...
        tier_limits = quota_limits.get(self.subscription_tier, quota_limits[SubscriptionTier.FREE])
    ...
    def can_access_feature(self, feature_name: str) -> bool:
        ...
        feature_access = {
            SubscriptionTier.FREE: {
                "basic_detection", "csv_import", "json_export"
            },
            SubscriptionTier.BASIC: {
                "basic_detection", "csv_import", "json_export", "advanced_algorithms", 
                "batch_processing", "api_access"
            },
            SubscriptionTier.PROFESSIONAL: {
                "basic_detection", "csv_import", "json_export", "advanced_algorithms",
                "batch_processing", "api_access", "real_time_detection", "custom_models",
                "advanced_analytics", "webhooks"
            },
            SubscriptionTier.ENTERPRISE: {
                "basic_detection", "csv_import", "json_export", "advanced_algorithms",
                "batch_processing", "api_access", "real_time_detection", "custom_models",
                "advanced_analytics", "webhooks", "sso", "advanced_security",
                "dedicated_resources", "priority_support", "custom_integrations"
            }
        }
