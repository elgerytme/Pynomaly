...
class ModelPerformanceMetrics:
    ...
    cross_validation_scores: Optional[Dict[str, list]] = None
    ...
    def compare_with(self, other: 'ModelPerformanceMetrics', metric_name: str = 'f1_score') -> Dict[str, Any]:
        """
        ...
        relative_improvement = (difference / other_value) * 100 if other_value != 0 else 0
        ...
        return {
            ...
            'better_model': self.model_id if self_value > other_value else other.model_id,
    ...
    def get_efficiency_score(self) -> float:
        ...
        performance = self.get_metric_value('f1_score') or self.get_metric_value('accuracy') or 0.0
