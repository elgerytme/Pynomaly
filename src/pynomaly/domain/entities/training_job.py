...
class AlgorithmResult:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'hyperparameters': self.hyperparameters.to_dict() if self.hyperparameters else None,
...
class TrainingJob:
    ...
    def success_rate(self) -> float:
        ...
        successful = sum(
            1 for result in self.algorithm_results
    ...
    def update_progress(self, progress: float, current_algorithm: Optional[str] = None) -> None:
        """Update job progress."""
    ...
    def add_algorithm_result(self, result: AlgorithmResult) -> None:
        ...
        self.algorithm_results = [
            r for r in self.algorithm_results 
        ...
        if (result.status == TrainingStatus.COMPLETED and 
            result.metrics and result.metrics.best_score is not None):
    ...
    def get_algorithm_result(self, algorithm_name: str) -> Optional[AlgorithmResult]:
    ...
    def get_successful_results(self) -> List[AlgorithmResult]:
        ...
        return [
            result for result in self.algorithm_results
            if result.status == TrainingStatus.COMPLETED
        ]
    ...
    def can_retry(self) -> bool:
        ...
        return (
            self.status == TrainingStatus.FAILED and
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'algorithm_results': [result.to_dict() for result in self.algorithm_results],
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'TrainingJob':
        ...
        datetime_fields = ['created_at', 'started_at', 'completed_at', 'updated_at', 'estimated_completion']
        ...
        if 'algorithm_results' in data:
            ...
            for result_data in data['algorithm_results']:
                result = AlgorithmResult(
                    ...
                    hyperparameters=HyperparameterSet.from_dict(result_data['hyperparameters']) 
                                  if result_data.get('hyperparameters') else None,
                    metrics=TrainingMetrics(**result_data['metrics']) 
                           if result_data.get('metrics') else None,
