...
class ThresholdSeverityClassifier:
    ...
    def __init__(
        self,
        threshold_table: Optional[Dict[str, Dict[str, float]]] = None,
    ...
    def classify_single(self, score: Union[float, AnomalyScore]) -> str:
    ...
    def get_severity_for_threshold_range(self, min_val: float, max_val: float) -> Optional[str]:
