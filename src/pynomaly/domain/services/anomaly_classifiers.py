...
class DefaultSeverityClassifier:
    ...
    def classify_severity(self, anomaly: Anomaly) -> str:
        ...
        # Extract score value
        score_value = (
            anomaly.score.value if hasattr(anomaly.score, "value") else anomaly.score
        )
...
class MLSeverityClassifier:
    ...
    def __init__(self, ml_classifier: Any | None = None):
    ...
    def classify_severity(self, anomaly: Anomaly) -> str:
        ...
        try:
            ...
            score_value = (
                anomaly.score.value
                if hasattr(anomaly.score, "value")
                else anomaly.score
            )
...
class BatchProcessingSeverityClassifier:
    ...
    def __init__(self, base_classifier: SeverityClassifier | None = None):
...
class DashboardTypeClassifier:
    ...
    def __init__(self, base_classifier: TypeClassifier | None = None):
        """Initialize with base classifier.
