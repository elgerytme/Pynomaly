...
class ModelNotFoundError(EntityNotFoundError):
    ...
    def __init__(self, model_id: UUID, message: str | None = None):
...
class ExperimentNotFoundError(EntityNotFoundError):
    ...
    def __init__(self, experiment_id: UUID, message: str | None = None):
...
class PipelineNotFoundError(EntityNotFoundError):
    ...
    def __init__(self, pipeline_id: UUID, message: str | None = None):
...
class AlertNotFoundError(EntityNotFoundError):
    ...
    def __init__(self, alert_id: UUID, message: str | None = None):
