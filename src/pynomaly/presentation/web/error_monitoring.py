...
from .error_handling import WebUIError, ErrorCode, ErrorLevel, get_web_ui_logger
...
class ErrorMonitor:
    ...
    def record_error(self, error: WebUIError, request_info: Optional[Dict[str, Any]] = None):
...
def record_error_for_monitoring(error: WebUIError, request_info: Optional[Dict[str, Any]] = None):
