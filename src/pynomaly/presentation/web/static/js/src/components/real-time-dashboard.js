...
export class RealTimeDashboard {
    ...
    createAlertsWidget() {
        ...
        const update = () => {
            ...
            alertsList.innerHTML = unacknowledged.slice(0, 10).map(alert => `
    ...
    createDataStreamWidget() {
        ...
        const update = () => {
            ...
            streamContent.innerHTML = recentData.map(item => `
    ...
    bindEvents() {
        ...
        this.header.querySelector('#settings-btn').onclick = () => this.showSettings();
        this.header.querySelector('#fullscreen-btn').onclick = () => this.toggleFullscreen();
    ...
    onAnomalyDetected(anomaly) {
        ...
        if (recentScores.length > 0) {
            this.data.statistics.avgScore = recentScores.reduce((a, b) => a + b) / recentScores.length;
        }
