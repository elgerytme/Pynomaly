...
window.AdvancedViz = {
  ...
  initTimeSeriesExplorer() {
    ...
    const xScale2 = d3.scaleTime().domain(xScale.domain()).range([0, width]);
  ...
  initInteractiveScatterplot() {
    ...
    const option = {
      ...
      tooltip: {
        ...
        formatter: function (params) {
          const type =
            params.seriesName === "Normal" ? "Normal Point" : "Anomaly";
...
document.addEventListener("DOMContentLoaded", function () {
  if (typeof d3 !== "undefined" && typeof echarts !== "undefined") {
    ...
    console.warn(
      "D3.js or ECharts not loaded. Advanced visualizations disabled.",
    );
  }
});
