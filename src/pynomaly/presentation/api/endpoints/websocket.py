...
from pynomaly.application.services.task_tracking_service import TaskTrackingService, TaskInfo
    ...
    async def event_generator():
        ...
        try:
            while True:
                ...
                try:
                    task_info = await asyncio.wait_for(updates_queue.get(), timeout=30.0)
                    yield f"data: {json.dumps(task_info.to_dict())}\n\n"
