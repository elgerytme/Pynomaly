...
async def get_query_performance_summary(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to get query performance summary: {str(e)}")
...
async def get_frequent_queries(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to get frequent queries: {str(e)}")
...
async def get_optimization_report(
    ...
    try:
        ...
        return OptimizationReportResponse(
            performance_summary=PerformanceSummaryResponse(**report["performance_summary"]),
...
async def optimize_database(
    ...
    try:
        ...
        return OptimizationResultResponse(
            ...
            performance_summary=PerformanceSummaryResponse(**result["performance_summary"]),
