...
class ValidationError(PynomaliSDKError):
    ...
    def __init__(self, message: str = "Validation failed", 
                 validation_errors: Optional[Dict[str, Any]] = None, **kwargs):
...
def map_http_error(status_code: int, message: str, 
                   details: Optional[Dict[str, Any]] = None) -> PynomaliSDKError:
    ...
    error_map = {
        ...
        404: lambda msg, **kwargs: ResourceNotFoundError("Resource", "unknown", **kwargs),
        409: ConflictError,
        429: RateLimitError,
        500: ServerError,
    ...
    if status_code == 404:
        ...
        resource_type = details.get("resource_type", "Resource") if details else "Resource"
