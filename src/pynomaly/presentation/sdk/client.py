...
import json
import time
from typing import List, Dict, Any, Optional, Union, Iterator, IO
...
class PynomaliClient:
    ...
    def create_dataset(self,
        ...
        if isinstance(data_source, (str, Path)):
            ...
            with open(file_path, 'rb') as f:
                ...
                response = self._make_request('POST', 'datasets', data=data, files=files)
    ...
    def download_dataset(self, 
        ...
        response = self._make_request('GET', f'datasets/{dataset_id}/download', params=params)
    ...
    def train_detector(self,
        ...
        response = self._make_request('POST', f'detectors/{detector.id}/train', data=training_data)
    ...
    def _wait_for_training(self, detector_id: str, timeout: Optional[float] = None) -> Detector:
    ...
    def batch_detect(self,
                    ...
                    return_scores: bool = True,
                    return_explanations: bool = False) -> List[DetectionResult]:
    ...
    def list_detection_results(self,
