...
from pynomaly.presentation.cli.security import security_commands
...
app.add_typer(security_commands, name="security", help="🔒 Security & compliance (SOC2, GDPR, HIPAA, encryption)")
