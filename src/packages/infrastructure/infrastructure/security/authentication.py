...
class SecurityManager:
    ...
    def create_jwt_token(self, user_id: str, additional_claims: dict[str, Any] | None = None) -> str:
    ...
    def _calculate_risk_score(self, action: str, success: bool, details: dict[str, Any] | None) -> int:
...
class SecurityMiddleware:
    ...
    def authenticate_request(self, request_headers: dict[str, str]) -> str | None:
    ...
    def process_request(self, request_headers: dict[str, str], ip_address: str, resource: str, action: str) -> tuple[bool, str | None, str | None]:
