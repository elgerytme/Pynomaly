"""Synchronous client for Anomaly Detection API."""
...
class AnomalyDetectionClient:
    """Synchronous client for the Anomaly Detection service."""
    ...
    def detect_anomalies(
        ...
        response = self._make_request("POST", "/api/v1/detect", data=request_data)
        return DetectionResult(**response)
    
    def batch_detect(self, request: BatchProcessingRequest) -> DetectionResult:
    ...
    def explain_anomaly(
        ...
        response = self._make_request("POST", "/api/v1/explain", data=request_data)
    ...
    def upload_data(
        ...
        return self._make_request("POST", "/api/v1/data/upload", data=request_data)