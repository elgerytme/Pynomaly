...
from interfaces.application.dto.active_learning_dto import CreateSessionRequest
from interfaces.application.use_cases.manage_active_learning import (
    ManageActiveLearningUseCase,
)
from interfaces.domain.entities.active_learning_session import SamplingStrategy
from interfaces.domain.entities.human_feedback import FeedbackConfidence, FeedbackType
from interfaces.domain.services.active_learning_service import ActiveLearningService
...
async def submit_feedback(
    ...
    try:
        ...
        # Convert to domain request
        from interfaces.application.dto.active_learning_dto import SubmitFeedbackRequest
        from interfaces.domain.value_objects.anomaly_score import AnomalyScore
...
async def get_session_status(
    ...
    try:
        # Create domain request
        from interfaces.application.dto.active_learning_dto import SessionStatusRequest
...
async def update_model(
    ...
    try:
        ...
        from interfaces.application.dto.active_learning_dto import UpdateModelRequest
