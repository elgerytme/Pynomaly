...
from anomaly_detection.enterprise.enterprise_service import router as enterprise_router
from anomaly_detection.infrastructure.config import get_settings
...
from anomaly_detection.mlops.mlops_service import router as mlops_router
