...
class MLQualityDetectionService:
    ...
    def detect_quality_anomalies(self, 
                                ...
                                historical_profiles: List[DataQualityProfile] = None) -> List[QualityIssue]:
    ...
    def _detect_with_method(self, 
                          ...
                          dataset_id: str,
                          baseline_profile: Optional[DataQualityProfile] = None) -> List[QualityIssue]:
        ...
        try:
            ...
            if anomaly_score > threshold:
                ...
                # Create anomaly
                anomaly = QualityIssue(
                    anomaly_id=QualityIssueId(),
                    dataset_id=dataset_id,
    ...
    def _temporal_anomaly_detection(self, 
                                  df: pd.DataFrame,
                                  dataset_id: str,
                                  historical_profiles: List[DataQualityProfile]) -> List[QualityIssue]:
    ...
    def _determine_severity(self, anomaly_score: float) -> ImpactLevel:
    ...
    def _deduplicate_and_rank_anomalies(self, anomalies: List[QualityIssue]) -> List[QualityIssue]:
    ...
    def _identify_anomaly_patterns(self, anomalies: List[QualityIssue]) -> List[Dict[str, Any]]:
    ...
    def _generate_pattern_insights(self, patterns: List[Dict[str, Any]], anomalies: List[QualityIssue]) -> List[str]:
    ...
    def _update_detection_stats(self, anomalies: List[QualityIssue]) -> None:
