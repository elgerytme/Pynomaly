...
# TODO: Replace quality_anomaly with quality_issue - from ...domain.entities.quality_issue import QualityIssue, ImpactLevel
...
class QualityLineageService:
    ...
    def analyze_quality_impact(self,
                             ...
                             quality_issue: Optional[QualityIssue] = None) -> QualityImpactAnalysis:
    ...
    def _analyze_downstream_impact(self,
                                 ...
                                 quality_issue: Optional[QualityIssue],
                                 current_depth: int = 0,
