...
class AirflowIntegrator(PipelineIntegrator):
    ...
    def _generate_airflow_recommendations(self, quality_score: float, issues: List[QualityIssue]) -> List[str]:
...
class PrefectIntegrator(PipelineIntegrator):
    ...
    def _generate_prefect_recommendations(self, quality_score: float, issues: List[QualityIssue]) -> List[str]:
...
class StreamingIntegrator(PipelineIntegrator):
    ...
    def _generate_streaming_recommendations(self, quality_score: float, issues: List[QualityIssue]) -> List[str]:
