...
class ProductionRedisCache:
    ...
    def _initialize_cluster(self) -> None:
        ...
        try:
            ...
            startup_nodes = []
            cluster_hosts = getattr(
                self.settings, "redis_cluster_hosts", ["localhost:7000"]
            )
    ...
    def _is_circuit_breaker_open(self) -> bool:
        ...
        if (
            ...
            and datetime.utcnow() - self.circuit_breaker_last_failure
    ...
    async def close(self) -> None:
        ...
        try:
            ...
            if hasattr(self, "redis") and self.redis:
                await self.redis.aclose() if hasattr(
                    self.redis, "aclose"
                ) else self.redis.close()
