...
class DetectorsPage(BasePage):
    ...
    def wait_for_detectors_page_load(self):
        ...
        self.page.wait_for_selector(
            f"{self.detectors_table_selector}, .empty-state",
    ...
    def delete_detector(self, detector_name: str):
        ...
        detector_row = self.page.locator(
            f"{self.detectors_table_selector} tr:has-text('{detector_name}')"
        )

        if detector_row.is_visible():
            delete_button = detector_row.locator(
