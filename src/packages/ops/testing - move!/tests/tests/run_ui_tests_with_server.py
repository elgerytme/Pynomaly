...
"""
            ...
            self.results["server_startup"] = {"success": False, "error": str(e)}
    ...
    def run_ui_tests(self) -> dict[str, Any]:
        ...
        ui_test_script = (
            self.project_root / "tests" / "ui" / "run_comprehensive_ui_tests.py"
        )
        ...
        try:
            ...
            ui_results_file = (
                self.project_root / "tests" / "ui" / "ui_test_results.json"
            )
            ...
            self.results["ui_tests"] = {"success": False, "error": str(e)}
    ...
    def stop_server(self):
        ...
        temp_files = [self.project_root / "temp_server.py"]
    ...
    def generate_summary(self):
        ...
        summary = {
            "server_startup_success": self.results["server_startup"].get(
                "success", False
            ),
        ...
        summary["overall_success"] = (
            summary["server_startup_success"]
            and "error" not in self.results["ui_tests"]
        )
