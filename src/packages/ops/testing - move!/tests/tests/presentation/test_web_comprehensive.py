...
class TestHTMXEndpoints:
    ...
    def test_detector_list_htmx(self, web_client: TestClient):
        ...
        with patch("monorepo.presentation.web.app.get_detectors") as mock_get_detectors:
            ...
            response = web_client.get("/htmx/detectors", headers={"HX-Request": "true"})
    ...
    def test_detection_train_htmx(self, web_client: TestClient):
        ...
        with patch("monorepo.presentation.web.app.train_detector") as mock_train:
            ...
            response = web_client.post(
                "/htmx/detection/train", data=form_data, headers={"HX-Request": "true"}
            )
...
class TestWebUIComponents:
    ...
    def test_detector_detail_modal(self, web_client: TestClient):
        ...
        with patch(
            ...
            response = web_client.get(
                "/htmx/detectors/det123/details", headers={"HX-Request": "true"}
            )
    ...
    def test_dataset_preview_component(self, web_client: TestClient):
        ...
        with patch("monorepo.presentation.web.app.get_dataset_preview") as mock_preview:
            ...
            response = web_client.get(
                "/htmx/datasets/ds123/preview", headers={"HX-Request": "true"}
            )
    ...
    def test_visualization_components(self, web_client: TestClient):
        ...
        with patch(
            ...
            response = web_client.get(
                "/htmx/visualizations/result123", headers={"HX-Request": "true"}
            )
    ...
    def test_performance_dashboard_component(self, web_client: TestClient):
        ...
        with patch(
            ...
            response = web_client.get(
                "/htmx/performance/dashboard", headers={"HX-Request": "true"}
            )
    ...
    def test_experiment_results_component(self, web_client: TestClient):
        ...
        with patch(
            ...
            response = web_client.get(
                "/htmx/experiments/exp123/results", headers={"HX-Request": "true"}
            )
...
class TestPWAFeatures:
    ...
    def test_service_worker(self, web_client: TestClient):
        ...
        if response.status_code == 200:
            ...
            assert any(
                keyword in response.text for keyword in ["cache", "fetch", "install"]
            )
        else:
...
class TestWebUIPerformance:
    ...
    def test_htmx_response_times(self, web_client: TestClient):
        ...
        htmx_endpoints = ["/htmx/detectors", "/htmx/datasets", "/htmx/live-updates"]

        for endpoint in htmx_endpoints:
            start_time = time.time()
            response = web_client.get(endpoint, headers={"HX-Request": "true"})
            end_time = time.time()
    ...
    def test_memory_usage_with_large_data(self, web_client: TestClient):
        ...
        with patch("monorepo.presentation.web.app.get_dataset_preview") as mock_preview:
            ...
            response = web_client.get(
                "/htmx/datasets/large_dataset/preview", headers={"HX-Request": "true"}
            )
