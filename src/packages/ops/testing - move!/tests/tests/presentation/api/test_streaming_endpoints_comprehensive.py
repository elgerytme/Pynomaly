...
from monorepo.domain.entities.streaming_anomaly import StreamingAnomaly
from monorepo.domain.entities.streaming_session import StreamingSession
from monorepo.domain.exceptions import DetectorError, StreamingError
...
class TestStreamingEndpointsComprehensive:
    ...
    def test_create_streaming_session_success(
        ...
        with patch("monorepo.presentation.api.deps.get_streaming_service", return_value=mock_streaming_service):
