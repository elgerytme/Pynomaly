...
from monorepo.domain.exceptions import DetectorError, ExplainabilityError
...
class TestExplainabilityEndpointsComprehensive:
    ...
    def test_explain_anomaly_success(
        ...
        with patch("monorepo.presentation.api.deps.get_explainability_service", return_value=mock_explainability_service):
