...
class TestJSONLoader:
    ...
    def test_init_custom(self):
        ...
        loader = JSONLoader(encoding="latin-1", lines=True, normalize_nested=False)
...
class TestExcelLoader:
    ...
    def test_init_custom(self):
        """Test custom initialization."""
        loader = ExcelLoader(sheet_name="Sheet2", header=[0, 1], skiprows=2)
        ...
        data = [
            {
                ...
                "activity": {"login_count": 150, "last_active": "2023-01-15"},
            },
            {
                "user_id": 2,
                "profile": {
                ...
                "activity": {"login_count": 89, "last_active": "2023-01-14"},
            },
        ]
