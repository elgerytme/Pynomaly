...
class TestInMemoryDetectorRepository:
    ...
    def test_save_and_find_by_id(self):
        ...
        repo = InMemoryDetectorRepository()
        detector = MockDetector(name="test_detector", algorithm_name="TestAlgorithm")
    ...
    def test_find_by_name(self):
        ...
        repo = InMemoryDetectorRepository()
        detector = MockDetector(name="unique_detector", algorithm_name="TestAlgorithm")
    ...
    def test_delete(self):
        ...
        repo = InMemoryDetectorRepository()
        detector = MockDetector(name="to_delete", algorithm_name="TestAlgorithm")
    ...
    def test_save_model_artifact(self):
        ...
        repo = InMemoryDetectorRepository()
        detector = MockDetector(name="with_artifact", algorithm_name="TestAlgorithm")
