...
async def deploy_model(
    ...
    try:
        ...
        response = ModelDeploymentResponse(
            ...
            health_check_url=f"https://api.example.com/models/{deployment_id}/health",
    ...
    try:
        ...
        mock_deployments = [
            ModelDeploymentResponse(
                ...
                status="active" if i % 4 != 0 else "inactive",
                endpoint_url=f"https://api.example.com/models/deploy_{i:06d}/predict",
                health_check_url=f"https://api.example.com/models/deploy_{i:06d}/health",
