...
class Model:
    ...
    It can have multiple versions (ModelVersion entities)
    ...
    Attributes:
        ...
        external_model_id: Optional[str] = None - External tracking ID (MLflow, W&B)
        framework: str = "scikit-learn" - ML framework used
        framework_version: Optional[str] = None - Framework version
        model_uri: Optional[str] = None - Model artifact URI
        deployment_ids: list[UUID] = [] - Active deployment IDs
        experiment_id: Optional[UUID] = None - Associated experiment ID
        approval_status: Optional[str] = None - Model approval status
        approved_by: Optional[str] = None - Approved by user
