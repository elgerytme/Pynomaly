...
class DetectorNotFittedError(NotFittedError, DetectorError):
    ...
    def __init__(
        self, detector_name: str, operation: str = "detect", **kwargs: Any
    ) -> None:
        ...
        """
        message = (
            f"Detector '{detector_name}' must be fitted before calling {operation}()"
        )
        super().__init__(
            message, detector_name=detector_name, operation=operation, **kwargs
        )
...
class DetectorConfigurationError(ConfigurationError, DetectorError):
    ...
    def __init__(self, detector_name: str, message: str, **kwargs: Any) -> None:
