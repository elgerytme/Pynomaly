...
def test_require_role_function():
    ...
    from monorepo.infrastructure.auth import require_role
...
def test_default_roles_and_permissions():
    ...
    from monorepo.domain.entities.user import DEFAULT_PERMISSIONS, UserRole
...
def test_websocket_auth_middleware():
    ...
    from monorepo.infrastructure.auth.jwt_auth import JWTAuthService
    from monorepo.infrastructure.auth.websocket_auth import WebSocketAuthMiddleware
    from monorepo.infrastructure.config import Settings
...
def test_htmx_auth_middleware():
    ...
    from monorepo.infrastructure.auth.jwt_auth import JWTAuthService
    from monorepo.infrastructure.auth.websocket_auth import HTMXAuthMiddleware
    from monorepo.infrastructure.config import Settings
