...
class SecurityIncident:
    ...
    def get_time_to_resolution(self) -> timedelta | None:
...
class ComplianceViolation:
    ...
    remediation_cost_estimate: float | None = None
    ...
    def get_days_until_deadline(self) -> int | None:
...
class ComplianceReport:
    ...
    assessment_period: timedelta | None = None
    scope: str | None = None
    ...
    remediation_timeline: dict[str, datetime] | None = None
    ...
    def is_compliant(self, threshold: float = 0.8) -> bool:
        ...
        return (
            self.overall_score >= threshold and len(self.get_critical_violations()) == 0
        )
...
class PrivacyAssessment:
    ...
    data_retention_period: timedelta | None = None
...
class EncryptionPolicy:
    ...
    key_length: int = 256
    key_rotation_frequency: timedelta = field(
    ...
    def applies_to_data_classification(
    ...
    def get_encryption_summary(self) -> dict[str, Any]:
        ...
        return {
            ...
            "applicable_classifications": [
                dc.value for dc in self.data_classification_levels
            ],
            "compliance_requirements": [
                cr.value for cr in self.compliance_requirements
            ],
        }
