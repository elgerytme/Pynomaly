...
from monorepo.infrastructure.repositories.dataset_repository import DatasetRepository
from monorepo.infrastructure.repositories.detector_repository import DetectorRepository
