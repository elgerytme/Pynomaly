        ...
        if email_service:
            try:
                ...
                await email_service.send_user_invitation_email(
                    ...
                    organization_name=tenant.name if tenant else "Software",
                )
        ...
        return {
            ...
            "usage": {
                ...
                "detections_this_month": {
                    ...
                    "limit": tenant.limits.max_processings_per_month,
    ...
    def _get_plan_limits(self, plan: TenantPlan) -> TenantLimits:
        ...
        plan_limits = {
            TenantPlan.FREE: TenantLimits(
                max_users=3,
                max_data_collections=10,
                max_processors=5,
                max_processings_per_month=1000,
                max_storage_gb=1,
                max_api_calls_per_minute=50,
                max_concurrent_processings=1,
            ),
            TenantPlan.STARTER: TenantLimits(
                max_users=10,
                max_data_collections=50,
                max_processors=20,
                max_processings_per_month=10000,
                max_storage_gb=10,
                max_api_calls_per_minute=200,
                max_concurrent_processings=3,
            ),
            TenantPlan.PROFESSIONAL: TenantLimits(
                max_users=50,
                max_data_collections=200,
                max_processors=100,
                max_processings_per_month=100000,
                max_storage_gb=100,
                max_api_calls_per_minute=1000,
                max_concurrent_processings=10,
            ),
            TenantPlan.ENTERPRISE: TenantLimits(
                max_users=500,
                max_data_collections=1000,
                max_processors=500,
                max_processings_per_month=1000000,
                max_storage_gb=1000,
                max_api_calls_per_minute=5000,
                max_concurrent_processings=50,
            ),
        }
