...
try:
    from monorepo.infrastructure.adapters.deep_learning import PyTorchAdapter
...
try:
    from monorepo.infrastructure.adapters.deep_learning import TensorFlowAdapter
...
try:
    from monorepo.infrastructure.adapters.deep_learning import JAXAdapter
