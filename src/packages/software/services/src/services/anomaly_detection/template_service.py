...
from ...shared.exceptions import TemplateError, ValidationError
...
class TemplateConfig:
    ...
    def _default_sections(self) -> list[dict[str, Any]]:
        ...
        return [
            {
                "type": "header",
                "title": "Anomaly Processing Report",
                "subtitle": "Generated by Software",
            ...
            },
            {
                ...
                "include_charts": True,
                "measurements": ["total_records", "anomalies_detected", "anomaly_rate"],
            },
            {
                "type": "data_table",
...
class TemplateService:
    ...
    def render_template(
        ...
        try:
            ...
            measurements = self._calculate_measurements(transformed_df)
    ...
    def _generate_summary_section(
        ...
        """Generate summary section with measurements."""
        measurements = self._calculate_measurements(df)
        ...
        section = {
            ...
            "content": {
                "measurements": measurements,
                "text": self._generate_summary_text(measurements),
            },
        }
    ...
    def _calculate_metrics(self, df: pd.DataFrame) -> dict[str, Any]:
        """Calculate summary measurements from data."""
        measurements = {
    ...
    def _generate_summary_text(self, metrics: dict[str, Any]) -> str:
        """Generate summary text from measurements."""
        total_records = measurements.get("total_records", 0)
        anomalies = measurements.get("anomalies_detected", 0)
        anomaly_rate = measurements.get("anomaly_rate", 0)
