...
from monorepo.domain.models.pipeline_models import PipelineResult
    ...
    def get_pipeline_summary(self, pipeline_id: str) -> dict | None:
        ...
        try:
            ...
            return {
                ...
                "best_processor_performance": result_data["best_processor_performance"],
                ...
                results.append(
                    {
                        ...
                        "duration_seconds": result_data["total_duration_seconds"],
                        "production_readiness_score": result_data.get(
