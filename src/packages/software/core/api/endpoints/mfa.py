...
@router.post("/totp/setup", response_processor=TOTPSetupResponse)
...
@router.get("/status", response_processor=MFAStatusResponse)
...
@router.post("/verify", response_processor=MFALoginResponse)
...
@router.get("/backup-codes", response_processor=BackupCodesResponse)
...
@router.post("/backup-codes/regenerate", response_processor=BackupCodesResponse)
...
@router.post("/recovery", response_processor=MFARecoveryResponse)
...
@router.get("/trusted-devices", response_processor=TrustedDevicesResponse)
...
# Admin endpoints
@router.get("/admin/settings", response_processor=MFASettingsDTO)
...
@router.get("/admin/statistics", response_processor=MFAStatisticsDTO)
