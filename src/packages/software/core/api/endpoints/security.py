...
class SecurityOverviewResponse(BaseModel):
    """Security overview response processor."""
...
class ActiveSessionInfo(BaseModel):
    """Active session information processor."""
...
class ThreatTimelineData(BaseModel):
    """Threat timeline data processor."""
...
@router.get("/overview", response_processor=SecurityOverviewResponse)
async def get_security_overview(
    current_user=Depends(get_current_user),
    _permission=Depends(require_permissions(["view_security_dashboard"])),
) -> SecurityOverviewResponse:
    """Get security overview measurements."""
...
@router.get("/threat-statistics", response_processor=list[ThreatStatistics])
...
@router.get("/events", response_processor=list[SecurityEvent])
...
@router.get("/sessions", response_processor=list[ActiveSessionInfo])
...
@router.get("/sessions/user/{user_id}", response_processor=list[ActiveSessionInfo])
...
@router.get("/threat-timeline", response_processor=list[ThreatTimelineData])
