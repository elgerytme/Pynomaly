...
from pynomaly_detection.application.dto.automl_dto import (
...
from pynomaly_detection.infrastructure.auth import require_read, require_write
from pynomaly_detection.infrastructure.config.feature_flags import require_automl, require_feature
...
async def optimize_automl(
    ...
    try:
        ...
        from pynomaly_detection.application.dto.automl_dto import AutoMLOptimizationRequest
