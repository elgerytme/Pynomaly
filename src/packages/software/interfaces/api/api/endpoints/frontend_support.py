...
from pynomaly_detection.presentation.api.middleware import CSPViolationReporter
...
async def get_monitoring_dashboard(request: Request):
    ...
    """
    from pynomaly_detection.presentation.web.monitoring import (
        performance_monitor,
        security_monitor,
    )
...
async def report_performance_data(request: Request, data: dict):
    ...
    """
    from pynomaly_detection.presentation.web.monitoring import performance_monitor
...
async def report_security_data(request: Request, data: dict):
    ...
    """
    from pynomaly_detection.presentation.web.monitoring import security_monitor
...
async def get_error_metrics(request: Request):
    ...
    try:
        from pynomaly_detection.presentation.web.error_handling import get_error_monitor
...
async def get_security_events(request: Request, limit: int = 100):
    ...
    try:
        from pynomaly_detection.presentation.web.security_features import get_security_middleware
...
async def get_rate_limit_status(request: Request, ip: str):
    ...
    try:
        from pynomaly_detection.presentation.web.security_features import get_rate_limiter
