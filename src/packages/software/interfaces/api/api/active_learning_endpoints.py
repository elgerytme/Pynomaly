...
from monorepo.application.dto.active_learning_dto import CreateSessionRequest
from monorepo.application.use_cases.manage_active_learning import (
    ManageActiveLearningUseCase,
)
from monorepo.domain.entities.active_learning_session import SamplingStrategy
from monorepo.domain.entities.human_feedback import FeedbackConfidence, FeedbackType
...
async def select_samples(
    ...
    try:
        ...
        from monorepo.application.dto.active_learning_dto import SelectSamplesRequest
...
async def submit_feedback(
    ...
    try:
        ...
        # Convert to domain request
        from monorepo.application.dto.active_learning_dto import SubmitFeedbackRequest
        from monorepo.domain.value_objects.anomaly_score import AnomalyScore
...
async def get_session_status(
    ...
    try:
        # Create domain request
        from monorepo.application.dto.active_learning_dto import SessionStatusRequest
...
async def update_model(
    ...
    try:
        ...
        from monorepo.application.dto.active_learning_dto import UpdateModelRequest
