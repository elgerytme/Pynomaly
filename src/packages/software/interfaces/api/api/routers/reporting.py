...
async def get_reporting_service() -> ReportingService:
    ...
    from monorepo.infrastructure.persistence.sqlalchemy.repositories.reporting_repository import (
        SQLAlchemyReportingRepository,
    )
    from monorepo.infrastructure.persistence.sqlalchemy.session import get_session
