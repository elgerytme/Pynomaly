...
from interfaces.presentation.cli.validation import (
    EnhancedValidator,
    ...
    console.print(
        Panel(
            Text.assemble(
                ...
                ("1. ", "bold"),
                ("Colorised console output (rich) grouping violations by severity", ""),
                ("\n2. ", "bold"),
                ("GitHub PR comments with violation summaries and fix suggestions", ""),
                ("\n3. ", "bold"),
                ("Pre-commit hook integration with developer reminders", ""),
            ),
    ...
    try:
        ...
        console.print(
            Panel(
                Text.assemble(
                    ("✅ ", "green"),
                    ("Rich Console Output: ", "bold"),
                    ("Colorized violations grouped by severity\n", ""),
                    ("✅ ", "green"),
                    ("GitHub Integration: ", "bold"),
                    ("PR comments with fix suggestions\n", ""),
                    ("✅ ", "green"),
                    ("Pre-commit Hooks: ", "bold"),
                    ("Automated validation with developer reminders\n", ""),
                    ("✅ ", "green"),
                    ("CLI Integration: ", "bold"),
                    ("Seamless integration with existing pynomaly CLI\n", ""),
                    ("\n", ""),
                    ("🎯 ", "bold blue"),
                    ("Developer Experience: ", "bold"),
                    ("Enhanced UX with actionable feedback", ""),
                ),
                title="🎉 Demo Complete",
                border_style="green",
            )
