...
from pynomaly_detection.presentation.cli.tutorials import tutorial_manager
...
def info(
    ...
    from pynomaly_detection.presentation.cli.tutorials import tutorial_info_command
