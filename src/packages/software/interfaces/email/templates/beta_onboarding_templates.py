    ...
    def create_email_campaign(self, user_data: List[Dict[str, Any]], template_id: str) -> List[Dict[str, Any]]:
        ...
        for user in user_data:
            ...
            variables = {
                ...
                "registration_url": f"https://beta.monorepo.io/register?token={hash(user.get('email', '')) % 100000}",
                "dashboard_url": "https://app.monorepo.io",
                "docs_url": "https://docs.monorepo.io/beta",
                "api_docs_url": "https://docs.monorepo.io/api",
                "examples_url": "https://docs.monorepo.io/examples",
                "support_url": "https://support.monorepo.io/beta",
                "support_email": "beta-support@monorepo.io",
                "demo_url": "https://calendly.com/pynomaly/beta-demo",
                "feedback_url": "https://feedback.monorepo.io",
                "survey_url": "https://survey.monorepo.io/beta-satisfaction",
                "unsubscribe_url": f"https://beta.monorepo.io/unsubscribe?email={user.get('email')}",
                "contact_url": "mailto:beta-support@monorepo.io",
                "feature_url": "https://app.monorepo.io/features/new",
                "advanced_guide_url": f"https://docs.monorepo.io/guides/{user.get('industry', 'fintech')}",
                "api_examples_url": "https://docs.monorepo.io/api/examples",
                "webinar_url": "https://monorepo.io/webinars",
                "community_url": "https://community.monorepo.io",
...
def main():
    ...
    variables = {
        ...
        "support_email": "beta-support@monorepo.io",
        "demo_url": "https://calendly.com/pynomaly/beta-demo",
        "unsubscribe_url": "https://beta.monorepo.io/unsubscribe?email=sarah.chen@fintechcorp.com",
        **industry_content
    }
