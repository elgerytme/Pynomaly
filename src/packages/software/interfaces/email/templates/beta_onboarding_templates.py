    ...
    def create_email_campaign(self, user_data: List[Dict[str, Any]], template_id: str) -> List[Dict[str, Any]]:
        ...
        for user in user_data:
            ...
            variables = {
                ...
                "registration_url": f"https://beta.example.com/register?token={hash(user.get('email', '')) % 100000}",
                "dashboard_url": "https://app.example.com",
                "docs_url": "https://docs.example.com/beta",
                "api_docs_url": "https://docs.example.com/api",
                "examples_url": "https://docs.example.com/examples",
                "support_url": "https://support.example.com/beta",
                "support_email": "beta-support@example.com",
                "demo_url": "https://calendly.com/pynomaly/beta-demo",
                "feedback_url": "https://feedback.example.com",
                "survey_url": "https://survey.example.com/beta-satisfaction",
                "unsubscribe_url": f"https://beta.example.com/unsubscribe?email={user.get('email')}",
                "contact_url": "mailto:beta-support@example.com",
                "feature_url": "https://app.example.com/features/new",
                "advanced_guide_url": f"https://docs.example.com/guides/{user.get('industry', 'fintech')}",
                "api_examples_url": "https://docs.example.com/api/examples",
                "webinar_url": "https://example.com/webinars",
...
def main():
    ...
    variables = {
        ...
        "support_email": "beta-support@example.com",
        "demo_url": "https://calendly.com/pynomaly/beta-demo",
        "unsubscribe_url": "https://beta.example.com/unsubscribe?email=sarah.chen@fintechcorp.com",
        **industry_content
    }
