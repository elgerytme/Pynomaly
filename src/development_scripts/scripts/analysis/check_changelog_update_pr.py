...
def analyze_changes(significant_files):
    ...
    for category, patterns in categories.items():
        if any(
            any(f.startswith(pattern) for pattern in patterns)
...
def main():
    ...
    is_significant, significant_files, total_lines_changed = is_significant_change_pr(
    ...
    print("\n💡 To fix this:")
    print("   1. Run: python3 scripts/update_changelog_helper.py")
    print("   2. Update CHANGELOG.md with details about your changes")
    print("   3. Follow the format in CLAUDE.md > Changelog Management Rules")
    print("   4. Commit the changelog update to this PR")
