...
def generate_sarif_report(violations: List[str]) -> Dict:
    ...
    for i, violation in enumerate(violations):
        ...
        rule = {
            "id": rule_id,
            "shortDescription": {
                "text": "File organization violation"
            },
            "fullDescription": {
...
def display_validation_results(is_valid: bool, violations: List[str], suggestions: List[str]) -> None:
    """
...
@app.command()
def main(
    output_dir: str = typer.Option("reports/quality", "--output-dir", "-o", help="Output directory for reports"),
    sarif: bool = typer.Option(True, "--sarif/--no-sarif", help="Generate SARIF report for GitHub code scanning"),
    ...
    if verbose:
        console.print("Validating project structure against FILE_ORGANIZATION_STANDARDS...")
