...
def suggest_changelog_entry(significant_files, total_lines_changed):
    ...
    if 'Core functionality' in categories_found:
        print(f"### Added")
        print(f"- [Describe new features or capabilities]")
        print(f"")
        print(f"### Changed")
        print(f"- [Describe changes in existing functionality]")
        print(f"")
        print(f"### Fixed")
        print(f"- [Describe bug fixes or issue resolutions]")
        print(f"")
    
    if 'Documentation' in categories_found:
        print(f"### Documentation")
        print(f"- [Describe documentation updates]")
        print(f"")
    
    if 'Testing infrastructure' in categories_found:
        print(f"### Testing")
        print(f"- [Describe test improvements or additions]")
        print(f"")
    
    if 'Docker and deployment' in categories_found:
        print(f"### Infrastructure")
        print(f"- [Describe deployment or infrastructure changes]")
        print(f"")
    
    print(f"```")
    print(f"")
    print(f"📊 Change summary: {len(significant_files)} files, {total_lines_changed} lines changed")
...
def main():
    ...
    is_significant, significant_files, total_lines_changed = is_significant_change(changed_files, diff_stats)
    ...
    print(f"\n💡 To fix this:")
    print(f"   1. Update CHANGELOG.md with details about your changes")
    print(f"   2. Follow the format in CLAUDE.md > Changelog Management Rules")
    print(f"   3. Add the changelog update to your commit")
