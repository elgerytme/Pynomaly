...
class SmokeTestSuite:
        ...
        async with httpx.AsyncClient(timeout=self.timeout) as client:
            ...
            try:
                ...
                return TestResult(
                    ...
                    passed=success,
                    duration=0,
                    details={"endpoint_count": endpoint_count, "openapi_version": schema.get("openapi")}
                )
            except Exception as e:
                return TestResult(
                    name="OpenAPI Schema",
    ...
    async def test_monitoring_endpoints(self) -> TestResult:
        ...
        async with httpx.AsyncClient(timeout=self.timeout) as client:
            ...
            success = response.status_code in [200, 503]  # Either healthy or unhealthy is fine
    ...
    async def test_prometheus_metrics(self) -> TestResult:
        ...
        async with httpx.AsyncClient(timeout=self.timeout) as client:
            ...
            return TestResult(
                ...
                passed=success,
                duration=0,
                details={"has_help": has_help, "has_type": has_type, "has_metrics": has_metrics}
            )
