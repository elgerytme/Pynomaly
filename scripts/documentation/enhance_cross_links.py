        ...
        self.link_patterns = {
            ...
            'getting-started': {
                'outgoing': [
                    ...
                    ('../user-guides/basic-usage/autonomous-mode.md', 'Autonomous Mode'),
            ...
            'user-guides/basic-usage': {
                'outgoing': [
                    ...
                    ('../../developer-guides/api-integration/README.md', 'API Documentation'),
            ...
            'reference/algorithms': {
                'outgoing': [
                    ('../../user-guides/basic-usage/autonomous-mode.md', 'Autonomous Mode'),
                    ('../../user-guides/advanced-features/performance-tuning.md', 'Performance Tuning'),
                    ('../../examples/README.md', 'Examples'),
                    ('../../developer-guides/api-integration/README.md', 'API Integration')
                ]
            },
            ...
            'deployment': {
                'outgoing': [
                    ...
                    ('../security/security-best-practices.md', 'Security Best Practices'),
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Enhance documentation cross-linking"
    )
    parser.add_argument(
        '--docs-root',
        type=Path,
