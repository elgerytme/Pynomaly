...
def main():
    ...
    # Setup command
    setup_parser = subparsers.add_parser('setup', help='Set up advanced testing infrastructure')
    ...
    config_parser.add_argument('--output', default='advanced_testing_config.json', help='Output file')
    
    # Clean command
    clean_parser = subparsers.add_parser('clean', help='Clean old test reports')
    clean_parser.add_argument('--output-dir', default='reports', help='Reports directory to clean')
    
    # Mutation testing command
    mutation_parser = subparsers.add_parser('mutation', help='Run mutation testing only')
    mutation_parser.add_argument('--source-dir', default='src/pynomaly', help='Source directory')
    mutation_parser.add_argument('--test-dir', default='tests', help='Test directory')
    mutation_parser.add_argument('--target-files', nargs='+', help='Specific files to test')
    mutation_parser.add_argument('--max-mutations', type=int, default=100, help='Maximum mutations to test')
    mutation_parser.add_argument('--output-dir', default='reports', help='Output directory')
    mutation_parser.add_argument('--verbose', '-v', action='store_true', help='Verbose output')
    
    # Property testing command
    property_parser = subparsers.add_parser('property', help='Run property-based testing only')
    property_parser.add_argument('--target-files', nargs='+', help='Specific files to test')
    property_parser.add_argument('--max-examples', type=int, default=100, help='Maximum examples per property')
    property_parser.add_argument('--timeout', type=int, default=60, help='Timeout per property test')
    property_parser.add_argument('--output-dir', default='reports', help='Output directory')
    property_parser.add_argument('--verbose', '-v', action='store_true', help='Verbose output')
    
    # Comprehensive testing command
    comprehensive_parser = subparsers.add_parser('comprehensive', help='Run comprehensive advanced testing')
    comprehensive_parser.add_argument('--source-dir', default='src/pynomaly', help='Source directory')
    comprehensive_parser.add_argument('--test-dir', default='tests', help='Test directory')
    comprehensive_parser.add_argument('--target-files', nargs='+', help='Specific files to test')
    comprehensive_parser.add_argument('--config', type=Path, help='Configuration file')
    comprehensive_parser.add_argument('--max-mutations', type=int, default=50, help='Maximum mutations to test')
    comprehensive_parser.add_argument('--max-examples', type=int, default=50, help='Maximum examples per property')
    comprehensive_parser.add_argument('--output-dir', default='reports', help='Output directory')
    comprehensive_parser.add_argument('--parallel', action='store_true', default=True, help='Run tests in parallel')
    comprehensive_parser.add_argument('--verbose', '-v', action='store_true', help='Verbose output')
    
    # All command (alias for comprehensive)
    all_parser = subparsers.add_parser('all', help='Run all advanced testing (alias for comprehensive)')
    all_parser.add_argument('--source-dir', default='src/pynomaly', help='Source directory')
    ...
    all_parser.add_argument('--max-mutations', type=int, default=50, help='Maximum mutations to test')
    all_parser.add_argument('--max-examples', type=int, default=50, help='Maximum examples per property')
    all_parser.add_argument('--output-dir', default='reports', help='Output directory')
    all_parser.add_argument('--parallel', action='store_true', default=True, help='Run tests in parallel')
    ...
    if args.command == 'setup':
        ...
        parser.print_help()
        print("\nQuick start:")
        print("  python scripts/run_advanced_testing.py setup          # Set up infrastructure")
        print("  python scripts/run_advanced_testing.py validate       # Validate environment")
        print("  python scripts/run_advanced_testing.py comprehensive  # Run all tests")
        print("  python scripts/run_advanced_testing.py mutation       # Run mutation testing only")
        print("  python scripts/run_advanced_testing.py property       # Run property testing only")
        return 0
