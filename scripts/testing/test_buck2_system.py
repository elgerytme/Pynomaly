...
class Buck2SystemTester:
            ...
            if result.returncode == 0:
                ...
                if output_file.exists():
                    ...
                    test_result["details"]["basic_detection"] = {
                        ...
                        "targets_affected": len(
                            analysis_data.get("affected_targets", [])
                        ),
                    }
        ...
        try:
            ...
            if results_file.exists():
                ...
                test_result["details"]["results_file"] = {
                    ...
                    "dry_run_confirmed": results_data.get("run_metadata", {}).get(
                        "dry_run", False
                    ),
                }
            ...
            if result.returncode == 0:
                ...
                if output_file.exists():
                    ...
                    test_result["details"]["basic_analysis"] = {
                        ...
                        "risk_level": impact_data.get("risk_assessment", {}).get(
                            "level", "unknown"
                        ),
                    }
    ...
    def test_file_imports(self) -> Dict:
        ...
        test_result = {"test_name": "file_imports", "status": "pending", "details": {}}
        ...
        try:
            for script in self.required_scripts:
                ...
                cmd = [
                    "python3",
                    "-c",
                    f"import sys; sys.path.append('scripts'); import {script_name}",
                ]
                result = subprocess.run(
                    cmd, capture_output=True, text=True, cwd=self.repo_root
                )
    ...
    def run_comprehensive_test(self) -> Dict:
        ...
        results["overall_status"] = (
            "passed" if failed_tests + error_tests == 0 else "failed"
        )
    ...
    def print_test_summary(self, results: Dict):
        ...
        for test in results["tests"]:
            ...
            if test.get("details") and test["status"] == "passed":
                ...
                passed_details = sum(
                    1 for d in test["details"].values() if d.get("status") == "passed"
                )
