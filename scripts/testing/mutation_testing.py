...
class MutationTester:
    ...
    def _parse_mutmut_output(self, stdout: str, stderr: str, path: str) -> List[Dict[str, any]]:
    ...
    def _calculate_summary(self, mutations: List[Dict[str, any]]) -> Dict[str, any]:
        ...
        mutation_score = (killed / tested_mutations * 100) if tested_mutations > 0 else 0.0
    ...
    def generate_report(self, output_file: str = "mutation_report.html") -> str:
        ...
        if summary["mutation_score"] >= 80:
            ...
            html_content += "<p>❌ Test quality needs significant improvement. Focus on:</p>"
            html_content += "<ul>"
...
@click.option("--fast", is_flag=True, help="Run fast mutation testing (limited mutations)")
