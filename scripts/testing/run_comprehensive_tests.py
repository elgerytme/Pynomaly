...
class TestRunner:
    ...
    def run_unit_tests(self, verbose: bool = False) -> Dict[str, Any]:
        ...
        cmd = [
            "python3", "-m", "pytest",
            "tests/",
            "-m", "unit or not (integration or performance or security or slow)",
            "--cov=src/pynomaly",
...
def main():
    """Main entry point."""
    parser = argparse.ArgumentParser(description="Comprehensive test runner for Pynomaly")
    parser.add_argument(
        "--type",
        choices=["unit", "integration", "security", "performance", "all", "quick", "lint"],
        default="all",
