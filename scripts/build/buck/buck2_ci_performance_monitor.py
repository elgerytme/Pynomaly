...
class Buck2CIPerformanceMonitor:
    ...
    def _benchmark_target(self, buck2_cmd: str, target: str) -> Dict[str, Any]:
        ...
        results = {
            ...
            "performance_metrics": {
                ...
                "cache_effectiveness_pct": ((clean_duration - cached_duration) / clean_duration * 100) if clean_duration > 0 else 0,
    ...
    def _generate_performance_summary(self, results: Dict[str, Any]) -> Dict[str, Any]:
        ...
        summary = {
            ...
            "total_benchmark_time": total_clean_time + total_cached_time + total_incremental_time,
            "average_performance": {
...
def main():
    ...
    parser.add_argument(
        "--ci-summary",
        action="store_true",
        help="Generate CI-friendly summary"
    )
    parser.add_argument(
        "--github-outputs",
        action="store_true",
