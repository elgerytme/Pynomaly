...
def check_hatch_installed() -> bool:
    ...
    try:
        result = run_command(["hatch", "--version"], check=False)
...
def main():
    ...
    if test_hatch_installation():
        ...
        print("\n📋 Next steps:")
        print("1. Review the new pyproject.toml configuration")
        print("2. Test environments: hatch env show")
        print("3. Run tests: hatch env run test")
