...
class MonitoringOrchestrator:
    ...
    def _setup_custom_metrics(self):
        ...
        self.system_health_gauge = Gauge(
            'pynomaly_system_health_score',
            'Overall system health score (0-100)',
            registry=self.registry
        )
        
        self.alert_counter = Counter(
            'pynomaly_alerts_total',
        ...
        self.response_time_histogram = Histogram(
            'pynomaly_response_time_seconds',
        ...
        self.security_events_counter = Counter(
            'pynomaly_security_events_total',
    ...
    def _evaluate_alert_condition(self, rule: AlertRule, current_value: Union[int, float]) -> bool:
