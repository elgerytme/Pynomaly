...
class RootDirectoryFixer:
    ...
    def _ensure_directories_exist(self):
        ...
        directories = [
            'docs/project', 'docs/testing', 'config', 'config/web',
            'config/environments', 'scripts/maintenance', 'scripts/testing',
            'scripts/setup', 'tests/scripts', 'reports/builds', 'storage'
        ]
    ...
    def _fix_test_files(self) -> bool:
        ...
        return self._move_files_by_pattern(
            patterns, target_base, "test files"
        )
    ...
    def _move_files_by_pattern(self, patterns: List[str], target_dir: str, 
