...
class PerformanceRegressionChecker:
    ...
    def compare_results(self) -> Dict[str, Any]:
        ...
        for algo, baseline_list in baseline_metrics.items(): 
            ...
            for baseline, current in zip(baseline_list, current_list):
                regression_data = self._compare_algorithm_metrics(algo, baseline, current)
    ...
    def _compare_algorithm_metrics(self, algorithm: str, baseline: Dict[str, Any], current: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for metric_name, metric_data in metric_comparisons.items():
            ...
            if abs_percent_change >= severity_thresholds.get('minor_threshold', 0.0) * 100:
    ...
    def _calculate_severity(self, percent_change: float, thresholds: Dict[str, float]) -> str:
