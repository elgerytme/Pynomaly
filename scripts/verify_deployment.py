...
class DeploymentVerifier:
    ...
    def _load_environment_config(self) -> Dict:
        ...
        config_map = {
            ...
            "staging": {
                "api_url": "https://staging-api.pynomaly.com",
                "db_host": "staging-db.pynomaly.com",
                "redis_host": "staging-redis.pynomaly.com",
                "expected_services": ["api", "db", "redis", "monitoring"],
                "health_threshold": 0.8,
                "response_timeout": 15,
            },
            "production": {
                "api_url": "https://api.pynomaly.com",
                "db_host": "prod-db.pynomaly.com",
                "redis_host": "prod-redis.pynomaly.com",
