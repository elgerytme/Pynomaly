...
class UIQualityMonitor:
    ...
    def record_metrics(self, test_results: Dict[str, Any], commit_hash: str = None, branch: str = None):
    ...
    def generate_trend_report(self, days: int = 30) -> str:
        ...
        if len(trend_data) >= 2:
            ...
            trend_direction = "📈" if recent_score > older_score else "📉" if recent_score < older_score else "➡️"
...
"""
    ...
    def check_quality_gates(self, thresholds: Dict[str, float] = None) -> Dict[str, Any]:
...
def main():
    ...
    parser.add_argument('--trend-report', type=str, help='Generate trend report HTML file')
    ...
    if args.record:
        ...
        if gates['passed']:
            ...
            for gate in gates['failed_gates']:
                ...
                print(f"  {gate}: {gate_info['current']} (threshold: {gate_info['threshold']})")
