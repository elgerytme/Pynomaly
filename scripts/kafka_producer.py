...
class KafkaStreamProducer:
    ...
    def produce_stream(self, duration_seconds=60, events_per_second=1000):
        ...
        print("🚀 Starting stream production:")
            ...
            while self.running and (time.time() - start_time) < duration_seconds:
                ...
                if current_time >= next_event_time:
                    ...
                    if events_sent % 1000 == 0:
                        ...
                        print(
                            f"📊 Progress: {events_sent:,} events sent, {rate:.1f} events/sec"
                        )
    ...
    def stop(self):
        ...
        if self.stats["start_time"]:
            ...
            print(
                f"   Success rate: {(self.stats['sent'] / total_events * 100):.1f}%"
                if total_events > 0
                else "   Success rate: 0%"
            )
