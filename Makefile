...
help: ## Show this help message
	...
	@echo ""
	@echo "Hatch Shortcuts (recommended):"
	@echo "  hatch run lint:style   - Quick style check (ruff + black + isort)"
	@echo "  hatch run lint:fmt     - Auto-format & re-check (format + style)"
	@echo "  hatch run lint:typing  - Strict mypy type checking"
	@echo "  hatch run lint:all     - All quality checks (style + typing)"
	@echo ""
	@echo "Testing:"
