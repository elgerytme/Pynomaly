...
1. **Scattered anomaly detection logic**: `pynomaly-detection/` package exists outside the standard `src/packages/` structure
...
- `pynomaly-detection/src/pynomaly_detection/` → `src/packages/anomaly_detection/`
...
- [x] Move `pynomaly-detection/` content
