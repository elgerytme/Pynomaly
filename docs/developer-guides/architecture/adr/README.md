...
🍞 **Breadcrumb:** 🏠 [Home](../../../index.md) > 👨‍💻 [Developer Guides](../../README.md) > 🏗️ [Architecture](../README.md) > 📋 ADRs
...
### Architecture
- **[Architecture Overview](../README.md)** - System architecture principles
- **[System Design](../system-design.md)** - High-level system design
- **[Design Patterns](../patterns/README.md)** - Architectural patterns
...
- **[Performance Standards](../../performance/README.md)** - Performance criteria
