        ...
        for contamination in invalid_contamination_values:
            try:
                ...
                try:
                    ...
                    assert "contamination" in str(e).lower() or "invalid" in str(e).lower()
    ...
    def test_random_state_parameter_validation(self, sample_dataset):
        ...
        try:
            ...
            for s1, s2 in zip(scores1, scores2):
                assert abs(s1.value - s2.value) < 1e-10, "Random state not providing reproducibility"
            ...
            for common_config in common_configs:
                try:
                    ...
                    if algorithm == "IsolationForest":
                        config = {**common_config, "contamination": 0.1, "n_estimators": 20}
                    elif algorithm == "LocalOutlierFactor":
                        config = {**common_config, "contamination": 0.1, "n_neighbors": 20, "novelty": True}
        ...
        for config in legacy_configs:
            try:
                ...
                if "contamination_rate" in normalized_config:
                    normalized_config["contamination"] = normalized_config.pop("contamination_rate")
