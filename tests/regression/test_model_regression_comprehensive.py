...
class TestModelOutputConsistency:
    ...
    def test_isolation_forest_output_consistency(self, reference_dataset, reference_model_configs):
    ...
    def test_model_performance_consistency(self, reference_dataset, reference_model_configs):
    ...
    def test_model_serialization_consistency(self, reference_dataset, reference_model_configs):
        ...
        try:
            ...
            for orig_score, pickled_score in zip(original_scores, pickled_scores):
            ...
            try:
                ...
                # Scores should be identical
                for orig_score, joblib_score in zip(original_scores, joblib_scores):
...
class TestModelOutputStability:
    ...
    def test_numerical_stability(self):
        ...
        edge_case_datasets = [
            ...
            pd.DataFrame({
                'tiny_vals': [1e-10, 2e-10, 3e-10, 1e-8, 2e-10]
            }),
            
            # Dataset with very large values
            pd.DataFrame({
                'large_vals': [1e8, 2e8, 3e8, 1e10, 2e8]
            }),
            ...
            # Dataset with zeros
            pd.DataFrame({
                'with_zeros': [0.0, 0.1, 0.0, 5.0, 0.1]
            })
        ]
    ...
    def test_deterministic_behavior(self):
        ...
        try:
            ...
            for run_idx in range(1, len(results)):
                for i, (score1, score2) in enumerate(zip(results[0], results[run_idx])):
