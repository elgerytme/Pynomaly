...
class TestWorkflowSimplificationService:
    ...
    def test_recommend_workflow_basic(self):
        ...
        assert recommendation.workflow_id.startswith('quick_start')  # Should recommend quick start for beginners
    ...
    def test_recommend_workflow_advanced_user(self, mock_feature_enabled):
        ...
        assert recommendation.estimated_duration_minutes > 10  # Should be longer for comprehensive
    ...
    def test_recommend_workflow_production(self, mock_feature_enabled):
        ...
        assert recommendation.estimated_duration_minutes > 20  # Production should take longer
    ...
    def test_get_next_step_guidance(self, mock_feature_enabled):
        ...
        guidance = self.service.get_next_step_guidance(
            workflow_id, first_step.step_id
        )
    ...
    def test_workflow_template_customization(self):
        ...
        assert customized.workflow_id != base_workflow.workflow_id  # Should be different
    ...
    def test_workflow_step_validation(self):
        ...
        user_input = {
            'completed': True,
            'data': {'algorithm': 'IsolationForest'}
        }
