...
class TestDeepLearningIntegrationService:
    ...
    def test_detect_available_frameworks(self):
        ...
        for name, framework_info in frameworks.items():
            ...
            assert framework_info.performance_tier in ["very_high", "high", "medium", "low"]
    ...
    def test_recommend_framework_with_target(self):
        ...
        with patch.object(self.service, 'available_frameworks', {
    ...
    def test_recommend_framework_no_support(self):
        ...
        with patch.object(self.service, 'available_frameworks', {
            ...
            with pytest.raises(ValueError, match="No available framework supports algorithm"):
    ...
    async def test_create_deep_learning_detector(self):
        ...
        with patch.object(self.service, '_create_framework_detector', 
                         return_value=mock_detector) as mock_create:
    ...
    async def test_create_deep_learning_detector_auto_framework(self):
        ...
        with patch.object(self.service, '_create_framework_detector',
            ...
            with patch.object(self.service, 'recommend_framework',
                             return_value="pytorch") as mock_recommend:
    ...
    async def test_create_framework_detector_pytorch(self):
        ...
        with patch('pynomaly.application.services.deep_learning_integration_service.PyTorchAdapter') as MockAdapter:
            mock_detector = Mock()
    ...
    async def test_create_framework_detector_tensorflow(self):
        ...
        with patch('pynomaly.application.services.deep_learning_integration_service.TensorFlowAdapter') as MockAdapter:
            mock_detector = Mock()
            MockAdapter.return_value = mock_detector
    ...
    async def test_create_framework_detector_jax(self):
        ...
        with patch('pynomaly.application.services.deep_learning_integration_service.JAXAdapter') as MockAdapter:
            mock_detector = Mock()
            MockAdapter.return_value = mock_detector
