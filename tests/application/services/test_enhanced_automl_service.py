...
@pytest.fixture
def enhanced_automl_service(mock_repositories, mock_adapter_registry, enhanced_config, temp_storage):
...
class TestEnhancedAutoMLService:
    ...
    def test_dataset_profile_conversion(self, enhanced_automl_service, sample_dataset):
        ...
        with patch.object(service, 'profile_dataset') as mock_profile:
            ...
            mock_profile.return_value = DatasetProfile(
                ...
                feature_types={"feature1": "numerical", "feature2": "numerical", "feature3": "numerical"},
    ...
    def test_final_recommendations_generation(self, enhanced_automl_service):
        ...
        assert "Excellent performance achieved" in " ".join(high_perf_result.optimization_recommendations)
        ...
        assert any("more training data" in rec for rec in low_perf_result.optimization_recommendations)
...
class TestAdvancedOptimizationIntegration:
    ...
    @pytest.mark.asyncio
    async def test_advanced_optimization_fallback(self, enhanced_automl_service, sample_dataset):
    ...
    def test_objective_function_creation(self, enhanced_automl_service, sample_dataset):
        ...
        from pynomaly.application.services.automl_service import AlgorithmConfig, AlgorithmFamily
        ...
        objectives = ["auc", "training_time"]
        objective_func = service._create_advanced_objective_function(sample_dataset, config, objectives)
