...
from pynomaly.application.services.advanced_automl_service import (
    AdvancedAutoMLService, OptimizationObjective, ResourceConstraints,
    OptimizationHistory
)
...
class TestAdvancedAutoMLService:
    ...
    def test_dataset_characteristics_analysis(self, automl_service, sample_dataset):
        ...
        characteristics = automl_service._analyze_dataset_characteristics(sample_dataset)
    ...
    def test_generate_optimization_report(self, automl_service, sample_objectives, sample_constraints):
