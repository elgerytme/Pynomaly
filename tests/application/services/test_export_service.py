...
from pynomaly.application.dto.export_options import ExportOptions, ExportFormat, ExportDestination
...
class TestExportService:
    ...
    def test_get_supported_formats(self):
        ...
        with patch('pynomaly.application.services.export_service.ExcelAdapter') as mock_excel:
            mock_excel.return_value = MagicMock()
    ...
    def test_export_results_excel_success(self, sample_detection_result):
        ...
        with patch('pynomaly.application.services.export_service.ExcelAdapter') as mock_adapter_class:
    ...
    def test_export_results_unsupported_format(self, sample_detection_result):
        ...
        with patch('pynomaly.application.services.export_service.ExcelAdapter'):
            ...
            with pytest.raises(ValueError, match="Export format 'excel' is not supported"):
    ...
    def test_export_multiple_formats(self, sample_detection_result):
        ...
        with patch('pynomaly.application.services.export_service.ExcelAdapter') as mock_excel_class, \
             patch('pynomaly.application.services.export_service.PowerBIAdapter') as mock_powerbi_class:
            ...
            with tempfile.TemporaryDirectory() as tmp_dir:
                ...
                options_map = {
                    ExportFormat.POWERBI: ExportOptions().for_powerbi('test-workspace', 'test-dataset')
                }
