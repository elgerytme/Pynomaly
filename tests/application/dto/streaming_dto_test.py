...
class TestStreamDataBatchDTO:
    ...
    def test_to_pandas_conversion(self):
        ...
        data_points = [
            StreamDataPointDTO(timestamp=timestamp1, features={"feature1": 1.0, "feature2": 2.0}),
            StreamDataPointDTO(timestamp=timestamp2, features={"feature1": 1.5, "feature2": 2.5})
        ]
