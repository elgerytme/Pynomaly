...
class TestStreamingDetectionUseCase:
    ...
    @pytest.fixture
    def use_case(self, mock_detector_repository, mock_metrics_collector, 
                 mock_checkpoint_manager, mock_backpressure_handler):
    ...
    def sample_configuration(self):
        ...
        return StreamConfigurationDTO(
            ...
            checkpoint=CheckpointConfigDTO(
                enabled=True,
                interval_ms=30000,
                storage_path="/tmp/test_checkpoints"
            )
        )
    ...
    def mock_detector(self):
        ...
        detector.predict_proba = Mock(return_value=np.array([
...
class TestStreamProcessing:
    ...
    @pytest.mark.asyncio
    async def test_process_batch_success(self, use_case, sample_batch, 
                                       sample_configuration, mock_detector,
    ...
    @pytest.mark.asyncio
    async def test_process_batch_detector_not_found(self, use_case, sample_batch,
    ...
    @pytest.mark.asyncio
    async def test_process_batch_detector_error(self, use_case, sample_batch,
                                              sample_configuration, mock_detector,
                                              mock_detector_repository):
    ...
    @pytest.mark.asyncio
    async def test_process_single_data_point(self, use_case, sample_data_points,
                                           sample_configuration, mock_detector,
                                           mock_detector_repository):
    ...
    @pytest.mark.asyncio
    async def test_batch_aggregation(self, use_case, sample_data_points,
                                   sample_configuration):
...
class TestBackpressureHandling:
    ...
    @pytest.mark.asyncio
    async def test_backpressure_detection(self, use_case, sample_batch,
                                        sample_configuration, mock_backpressure_handler):
    ...
    @pytest.mark.asyncio
    async def test_backpressure_handling_oldest_drop(self, use_case, sample_data_points):
    ...
    @pytest.mark.asyncio
    async def test_backpressure_handling_newest_drop(self, use_case, sample_data_points):
...
class TestMetricsCollection:
    ...
    @pytest.mark.asyncio
    async def test_collect_metrics(self, use_case, sample_configuration,
    ...
    @pytest.mark.asyncio
    async def test_update_metrics_on_processing(self, use_case, sample_batch,
                                              sample_configuration, mock_detector,
                                              mock_detector_repository,
                                              mock_metrics_collector):
...
class TestCheckpointManagement:
    ...
    @pytest.mark.asyncio
    async def test_save_checkpoint(self, use_case, sample_configuration,
    ...
    @pytest.mark.asyncio
    async def test_load_checkpoint(self, use_case, sample_configuration,
                                 mock_checkpoint_manager):
    ...
    @pytest.mark.asyncio
    async def test_checkpoint_cleanup(self, use_case, sample_configuration,
                                    mock_checkpoint_manager):
...
class TestErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_stream_processing_error_recovery(self, use_case, sample_batch,
                                                  sample_configuration, mock_detector,
                                                  mock_detector_repository):
...
class TestConcurrentProcessing:
    ...
    @pytest.mark.asyncio
    async def test_concurrent_batch_processing(self, use_case, sample_data_points,
                                             sample_configuration, mock_detector,
                                             mock_detector_repository):
...
class TestPerformanceCharacteristics:
    ...
    @pytest.mark.asyncio
    async def test_processing_throughput(self, use_case, sample_configuration,
                                       mock_detector, mock_detector_repository):
    ...
    async def test_memory_efficiency(self, use_case, sample_configuration):
        ...
        for i in range(10000):  # 10,000 data points
            point = StreamDataPointDTO(
                timestamp=base_time + timedelta(milliseconds=i),
                features={f"feature_{j}": float(i + j) for j in range(50)}  # 50 features
            )
            large_data_points.append(point)
    ...
    @pytest.mark.asyncio
    async def test_latency_characteristics(self, use_case, sample_data_points,
                                         sample_configuration, mock_detector,
                                         mock_detector_repository):
