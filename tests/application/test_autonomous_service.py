...
class TestAutonomousDetection:
    ...
    @pytest.mark.asyncio
    async def test_detect_autonomous_with_dataframe(self, autonomous_service, sample_dataframe):
        ...
        with patch.object(autonomous_service, '_run_detection_pipeline') as mock_pipeline:
            ...
            results = await autonomous_service.detect_autonomous(sample_dataframe, config)
