...
class TestApplicationWorkflows:
    ...
    async def test_complete_anomaly_detection_workflow(self, workflow_services):
        ...
        # Configure mocks
        workflow_services['detect_anomalies_use_case'].execute.return_value = mock_results
    ...
    async def test_model_training_and_evaluation_workflow(self, workflow_services):
        ...
        # Configure mocks
        workflow_services['train_detector_use_case'].execute.return_value = trained_detector
        workflow_services['evaluate_model_use_case'].execute.return_value = evaluation_results
    ...
    async def test_batch_processing_workflow(self, workflow_services):
        ...
        workflow_services['detection_service'].process_batch.return_value = batch_results
    ...
    async def test_real_time_detection_workflow(self, workflow_services):
        ...
        streaming_data = [
            ...
            {'timestamp': '2024-01-15T10:02:00Z', 'features': [5.0, 8.0, 2.0]},  # Anomaly
        ...
        workflow_services['detection_service'].detect_streaming.return_value = streaming_results
    ...
    async def test_ensemble_model_workflow(self, workflow_services):
        ...
        base_detectors = [
            ...
            {'id': str(uuid.uuid4()), 'algorithm': 'LocalOutlierFactor', 'weight': 0.35},
        ...
        # Configure mocks
        workflow_services['ensemble_service'].create_ensemble.return_value = ensemble_detector
        workflow_services['ensemble_service'].predict_ensemble.return_value = ensemble_results
    ...
    async def test_explainability_integration_workflow(self, workflow_services):
        ...
        # Configure mocks
        workflow_services['explainability_service'].explain_anomaly.return_value = explanation_results['local_explanation']
        workflow_services['explainability_service'].analyze_feature_importance.return_value = explanation_results['global_explanation']
    ...
    async def test_comprehensive_detection_pipeline(self, workflow_services):
        ...
        workflow_services['detection_service'].execute_pipeline.return_value = pipeline_results
    ...
    async def test_multi_tenant_workflow(self, workflow_services):
        ...
        workflow_services['detection_service'].process_multi_tenant.return_value = tenant_data
    ...
    async def test_disaster_recovery_workflow(self, workflow_services):
        ...
        with patch.object(workflow_services['detection_service'], 'health_check') as mock_health:
            ...
            workflow_services['detection_service'].initiate_failover.return_value = failover_results
