...
class TestMergeConfigurations:
    ...
    def test_merge_configurations_deep_copy(
        ...
        assert override_config.algorithm_config.algorithm_name == original_override_algorithm
    ...
    def test_merge_configurations_preserves_dataset_config(
        ...
        assert merged.dataset_config.dataset_path == base_config.dataset_config.dataset_path
        assert merged.dataset_config.validation_split == base_config.dataset_config.validation_split
        assert merged.dataset_config.feature_columns == base_config.dataset_config.feature_columns
...
class TestValidateConfigurationCompatibility:
    ...
    def test_validate_different_algorithms(
        self, 
        config1: ExperimentConfigurationDTO
    ):
    ...
    def test_validate_different_datasets(
        self, 
        config1: ExperimentConfigurationDTO
    ):
        ...
        issues = validate_configuration_compatibility(config1, config2_different_dataset)
    ...
    def test_validate_different_preprocessing_scaling(
        ...
        issues = validate_configuration_compatibility(config1, config2_different_scaling)
    ...
    def test_validate_none_dataset_paths(
        self, 
        config1: ExperimentConfigurationDTO
    ):
    ...
    def test_validate_none_preprocessing_configs(
        ...
        issues = validate_configuration_compatibility(config1, config2_none_preprocessing)
...
class TestEdgeCases:
    ...
    def test_merge_with_identical_configs(self):
        ...
        assert merged.algorithm_config.algorithm_name == config.algorithm_config.algorithm_name
    ...
    def test_merge_then_validate_workflow(self):
        ...
        experimental_override = ExperimentConfigurationDTO(
            ...
            algorithm_config=AlgorithmConfigurationDTO(
                ...
                algorithm_type="ensemble",
                parameters={"contamination": 0.15, "n_estimators": 200}  # Different params
            ),
            dataset_config=DatasetConfigurationDTO(
