...
class TestExportCLI:
    ...
    def test_tableau_export_basic(self, runner, sample_results_file):
        ...
        try:
            with patch(
                ...
                result = runner.invoke(
                    export_app, ["tableau", sample_results_file, output_path]
                )
    ...
    def test_tableau_export_hyper_format(self, runner, sample_results_file):
        ...
        try:
            with patch(
                ...
                result = runner.invoke(
                    export_app,
                    ["tableau", sample_results_file, output_path, "--format", "hyper"],
                )
    ...
    def test_csv_export_basic(self, runner, sample_results_file):
        ...
        try:
            result = runner.invoke(
                export_app, ["csv", sample_results_file, output_path]
            )
    ...
    def test_json_export_basic(self, runner, sample_results_file):
        ...
        try:
            result = runner.invoke(
                export_app, ["json", sample_results_file, output_path]
            )
    ...
    def test_json_export_formatted(self, runner, sample_results_file):
        ...
        try:
            result = runner.invoke(
                export_app,
                ["json", sample_results_file, output_path, "--pretty", "--indent", "4"],
            )
    ...
    def test_export_missing_input_file(self, runner):
        ...
        result = runner.invoke(
            export_app, ["excel", "/path/to/nonexistent.json", "output.xlsx"]
        )
    ...
    def test_export_invalid_format(self, runner, sample_results_file):
        ...
        result = runner.invoke(
            export_app, ["invalid-format", sample_results_file, "output.xyz"]
        )
    ...
    def test_powerbi_missing_workspace(self, runner, sample_results_file):
        ...
        result = runner.invoke(export_app, ["powerbi", sample_results_file])
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch(
                ...
                excel_result = runner.invoke(
                    export_app, ["excel", sample_results_file, str(excel_path)]
                )
            ...
            csv_result = runner.invoke(
                export_app, ["csv", sample_results_file, str(csv_path)]
            )
    ...
    def test_export_configuration_workflow(self, runner, sample_results_file):
        ...
        config = {
            ...
            "csv": {"separator": ",", "include_index": True, "date_format": "iso"},
        }
