...
"""
    ...
    def test_load_config_invalid_json(self):
        ...
        invalid_json = '{"base_url": "https://api.com", "timeout": 30.0,'  # Missing closing brace
...
class TestEnvironmentVariableLoading:
    ...
    def test_load_config_from_env_no_variables(self):
        ...
        env_vars_to_clear = [
            "PYNOMALY_BASE_URL", "PYNOMALY_API_KEY", "PYNOMALY_TIMEOUT",
            "PYNOMALY_MAX_RETRIES", "PYNOMALY_RETRY_DELAY", 
            "PYNOMALY_VERIFY_SSL", "PYNOMALY_DEBUG"
        ]
        
        clear_env = {var: None for var in env_vars_to_clear}
    ...
    def test_load_config_from_env_invalid_timeout(self):
        ...
        env_vars = {
            "PYNOMALY_TIMEOUT": "invalid_timeout"
        }
    ...
    def test_load_config_from_env_invalid_max_retries(self):
        ...
        env_vars = {
            "PYNOMALY_MAX_RETRIES": "not_a_number"
        }
...
class TestConfigMerging:
    ...
    def test_merge_configs_multiple(self):
        ...
        config1 = {
            "base_url": "https://config1.com",
            "timeout": 30.0,
            "max_retries": 3
        }
        
        config2 = {
            "base_url": "https://config2.com",
            "retry_delay": 1.5
        }
...
class TestConfigFileSaving:
    ...
    def test_save_config_to_yaml_file(self):
        ...
        config = PynomalyConfig(
            base_url="https://yaml.save.com",
            api_key="yaml-save-key",
            max_retries=5
        )
...
class TestConfigIntegration:
        ...
        try:
            with patch.dict(os.environ, env_vars):
                ...
                merged_dict = merge_configs(
                    file_config_obj.to_dict(),
                    env_config_obj.to_dict()
                )
    ...
    def test_config_home_directory_file(self):
        ...
        with patch("pathlib.Path.home") as mock_home:
            ...
            with patch("pathlib.Path.exists") as mock_exists:
                ...
                with patch("builtins.open", mock_open(read_data=json.dumps(home_config))):
    ...
    def test_config_relative_path_resolution(self):
        ...
        relative_config = {
            "base_url": "https://relative.api.com",
            "timeout": 25.0
        }
