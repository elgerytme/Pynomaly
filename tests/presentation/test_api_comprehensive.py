    ...
    def test_refresh_token(self, client: TestClient):
        ...
        with patch("pynomaly.infrastructure.auth.JWTAuthService"):
            ...
            with patch(
                ...
                response = client.post(
                    "/api/auth/refresh", json={"refresh_token": "valid_refresh_token"}
                )
            ...
            with patch(
                ...
                with patch(
                    ...
                    response = client.delete(
                        "/api/auth/api-keys/api_key_to_revoke", headers=auth_headers
                    )
...
class TestDetectorEndpoints:
    ...
    def test_create_detector_basic(self, client: TestClient, auth_headers):
        ...
        response = client.post(
            "/api/detectors/", json=detector_data, headers=auth_headers
        )
    ...
    def test_create_detector_with_advanced_parameters(
        ...
        detector_data = {
            ...
            "metadata": {"created_by": "test_user", "purpose": "fraud_detection"},
        }
    ...
    def test_list_detectors_with_pagination(self, client: TestClient, auth_headers):
        ...
        for i in range(5):
            client.post(
                "/api/detectors/",
                json={"name": f"Detector {i}", "algorithm": "IsolationForest"},
                headers=auth_headers,
            )
    ...
    def test_list_detectors_with_filters(self, client: TestClient, auth_headers):
        ...
        for algo in algorithms:
            client.post(
                "/api/detectors/",
                json={"name": f"{algo} Detector", "algorithm": algo},
                headers=auth_headers,
            )
    ...
    def test_update_detector(self, client: TestClient, auth_headers):
        ...
        create_response = client.post(
            "/api/detectors/",
            json={"name": "Update Test", "algorithm": "IsolationForest"},
            headers=auth_headers,
        )
        detector_id = create_response.json()["id"]
        ...
        response = client.put(
            f"/api/detectors/{detector_id}", json=update_data, headers=auth_headers
        )
    ...
    def test_detector_validation_endpoints(self, client: TestClient, auth_headers):
        ...
        response = client.post(
            "/api/detectors/",
            json={"name": "Invalid Detector", "algorithm": "NonExistentAlgorithm"},
            headers=auth_headers,
        )
    ...
    def test_delete_detector(self, client: TestClient, auth_headers):
        ...
        create_response = client.post(
            "/api/detectors/",
            json={"name": "Delete Test", "algorithm": "LOF"},
            headers=auth_headers,
        )
        detector_id = create_response.json()["id"]
    ...
    def test_detector_clone(self, client: TestClient, auth_headers):
        ...
        # Clone detector
        response = client.post(
            f"/api/detectors/{detector_id}/clone",
            json={"name": "Cloned Detector"},
            headers=auth_headers,
        )
    ...
    def test_detector_export_import(self, client: TestClient, auth_headers):
        ...
        export_response = client.get(
            f"/api/detectors/{detector_id}/export", headers=auth_headers
        )
        ...
        import_response = client.post(
            "/api/detectors/import", json=import_data, headers=auth_headers
        )
...
class TestDatasetEndpoints:
    ...
    def test_upload_csv_dataset(
        self, client: TestClient, auth_headers, sample_csv_data
    ):
    ...
    def test_upload_parquet_dataset(self, client: TestClient, auth_headers):
        ...
        with tempfile.NamedTemporaryFile(suffix=".parquet", delete=False) as tmp:
            ...
            with open(tmp.name, "rb") as f:
                ...
                data = {"name": "Parquet Dataset", "target_column": "label"}
    ...
    def test_list_datasets_with_metadata(
        self, client: TestClient, auth_headers, sample_csv_data
    ):
    ...
    def test_dataset_sample_with_options(
        self, client: TestClient, auth_headers, sample_csv_data
    ):
        ...
        for query, expected_size in test_cases:
            response = client.get(
                f"/api/datasets/{dataset_id}/sample{query}", headers=auth_headers
            )
    ...
    def test_dataset_statistics(
        ...
        # Get statistics
        response = client.get(
            f"/api/datasets/{dataset_id}/statistics", headers=auth_headers
        )
    ...
    def test_dataset_quality_analysis(self, client: TestClient, auth_headers):
        ...
        # Analyze quality
        response = client.get(
            f"/api/datasets/{dataset_id}/quality", headers=auth_headers
        )
    ...
    def test_dataset_preprocessing_options(
        self, client: TestClient, auth_headers, sample_csv_data
    ):
    ...
    def test_dataset_export_formats(
        ...
        for format_type in formats:
            ...
            if format_type == "csv":
                ...
                assert "application/octet-stream" in response.headers.get(
                    "content-type", ""
                )

    def test_dataset_delete_with_dependencies(
        self, client: TestClient, auth_headers, sample_csv_data
    ):
...
class TestDetectionEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_detector_training_workflow(
        self, async_client: AsyncClient, auth_headers, sample_csv_data
    ):
        ...
        train_response = await async_client.post(
            ...
            json={
                ...
                "save_model": True,
                "training_options": {"cross_validation": True, "cv_folds": 5},
            },
            headers=auth_headers,
        )
    ...
    @pytest.mark.asyncio
    async def test_anomaly_prediction(
        self, async_client: AsyncClient, auth_headers, sample_csv_data
    ):
        ...
        detector_response = await async_client.post(
            "/api/detectors/",
            json={"name": "Prediction Test", "algorithm": "IsolationForest"},
            headers=auth_headers,
        )
        detector_id = detector_response.json()["id"]
        ...
        await async_client.post(
            "/api/detection/train",
            json={"detector_id": detector_id, "dataset_id": train_dataset_id},
            headers=auth_headers,
        )
    ...
    async def test_batch_detection(self, async_client: AsyncClient, auth_headers):
        ...
        detector_response = await async_client.post(
            "/api/detectors/",
            json={"name": "Batch Test", "algorithm": "LOF"},
            headers=auth_headers,
        )
        detector_id = detector_response.json()["id"]
    ...
    async def test_ensemble_detection(
        ...
        for algo in algorithms:
            detector_response = await async_client.post(
                "/api/detectors/",
                json={"name": f"Ensemble {algo}", "algorithm": algo},
                headers=auth_headers,
            )
        ...
        # Ensemble prediction
        ensemble_response = await async_client.post(
            "/api/detection/ensemble",
            json={
    ...
    @pytest.mark.asyncio
    async def test_detection_results_management(
        self, async_client: AsyncClient, auth_headers
    ):
        """Test detection results storage and retrieval."""
        # Get recent results
        response = await async_client.get(
            "/api/detection/results", headers=auth_headers
        )
        ...
        response = await async_client.get(
            "/api/detection/results?detector_id=test_id", headers=auth_headers
        )
        assert response.status_code == 200
    ...
    @pytest.mark.asyncio
    async def test_detection_performance_metrics(
        self, async_client: AsyncClient, auth_headers
    ):
        """Test detection performance monitoring."""
        response = await async_client.get(
            "/api/detection/metrics", headers=auth_headers
        )
        ...
        response = await async_client.get(
            "/api/detection/metrics/detector_123", headers=auth_headers
        )
...
class TestExperimentEndpoints:
    ...
    def test_create_experiment(self, client: TestClient, auth_headers):
        ...
        response = client.post(
            "/api/experiments/", json=experiment_data, headers=auth_headers
        )
    ...
    def test_experiment_execution(
        ...
        create_response = client.post(
            ...
            json={
                "name": "Execution Test",
                "detectors": [{"algorithm": "IsolationForest"}, {"algorithm": "LOF"}],
            },
            headers=auth_headers,
        )
        experiment_id = create_response.json()["id"]
    ...
    def test_experiment_results_analysis(self, client: TestClient, auth_headers):
        ...
        create_response = client.post(
            "/api/experiments/",
            json={"name": "Results Test", "status": "completed"},
            headers=auth_headers,
        )
        experiment_id = create_response.json()["id"]
        ...
        response = client.get(
            f"/api/experiments/{experiment_id}/results", headers=auth_headers
        )
        ...
        # Get leaderboard
        response = client.get(
            f"/api/experiments/{experiment_id}/leaderboard", headers=auth_headers
        )
    ...
    def test_experiment_visualization_data(self, client: TestClient, auth_headers):
        ...
        create_response = client.post(
            "/api/experiments/", json={"name": "Viz Test"}, headers=auth_headers
        )
        experiment_id = create_response.json()["id"]

        # Get ROC curves data
        response = client.get(
            f"/api/experiments/{experiment_id}/visualizations/roc", headers=auth_headers
        )
        assert response.status_code == 200

        # Get precision-recall curves
        response = client.get(
            f"/api/experiments/{experiment_id}/visualizations/pr", headers=auth_headers
        )
        assert response.status_code == 200

        # Get confusion matrices
        response = client.get(
            f"/api/experiments/{experiment_id}/visualizations/confusion",
            headers=auth_headers,
        )
        assert response.status_code == 200
...
class TestAPIPerformance:
    ...
    def test_pagination_performance(self, client: TestClient, auth_headers):
        ...
        for i in range(50):
            client.post(
                "/api/detectors/",
                json={"name": f"Perf Test {i}", "algorithm": "IsolationForest"},
                headers=auth_headers,
            )
