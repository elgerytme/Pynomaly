...
class TestEndToEndAPIWorkflow:
    ...
    @pytest.mark.asyncio
    async def test_complete_detection_workflow(self, async_api_client: AsyncClient, auth_token, sample_csv_content):
        ...
        with patch('pynomaly.application.services.dataset_service.DatasetService.load_dataset') as mock_load:
            mock_dataset = Mock()
        ...
        with patch('pynomaly.application.services.detector_service.DetectorService.create_detector') as mock_create:
            mock_detector = Mock()
        ...
        with patch('pynomaly.application.services.detection_service.DetectionService.train_detector') as mock_train:
            mock_train_result = {
                "success": True,
                "training_time_ms": 1500,
                "model_metrics": {
                    "fit_time": 0.15,
                    "score_samples_time": 0.05
                },
                "validation_results": {
                    "precision": 0.92,
                    "recall": 0.88,
        ...
        with patch('pynomaly.application.services.detection_service.DetectionService.detect_anomalies') as mock_predict:
        ...
        results_response = await async_api_client.get(
            f"/api/detection/results?detector_id={detector_id}",
            headers=headers
        )
    ...
    @pytest.mark.asyncio
    async def test_experiment_workflow(self, async_api_client: AsyncClient, auth_token, sample_csv_content):
        ...
        with patch('pynomaly.application.services.experiment_service.ExperimentService.create_experiment') as mock_create_exp:
        ...
        with patch('pynomaly.application.services.experiment_service.ExperimentService.execute_experiment') as mock_execute:
            mock_execution_result = {
                ...
                "results": [
                    {
                        "algorithm": "IsolationForest",
                        "metrics": {"precision": 0.94, "recall": 0.89, "f1_score": 0.915, "roc_auc": 0.96},
                        "training_time_ms": 1200,
                        "prediction_time_ms": 50
                    },
                    {
                        "algorithm": "LOF",
                        "metrics": {"precision": 0.91, "recall": 0.92, "f1_score": 0.915, "roc_auc": 0.94},
                        "training_time_ms": 2300,
                        "prediction_time_ms": 120
                    },
                    {
                        "algorithm": "OCSVM",
                        "metrics": {"precision": 0.88, "recall": 0.85, "f1_score": 0.865, "roc_auc": 0.92},
        ...
        leaderboard_response = await async_api_client.get(
            f"/api/experiments/{experiment_id}/leaderboard",
            headers=headers
        )
    ...
    @pytest.mark.asyncio
    async def test_batch_operations(self, async_api_client: AsyncClient, auth_token, sample_csv_content):
        ...
        with patch('pynomaly.application.services.detection_service.DetectionService.batch_detect_anomalies') as mock_batch:
            mock_batch_result = {
                "batch_id": "batch_123",
                "status": "completed",
                "results": [
                    {"dataset_id": dataset_ids[1], "anomaly_count": 2, "anomaly_rate": 0.25},
                    {"dataset_id": dataset_ids[2], "anomaly_count": 3, "anomaly_rate": 0.375}
                ],
                "summary": {
                    "total_datasets": 2,
                    "total_anomalies": 5,
...
class TestWebUIIntegration:
    ...
    def test_web_to_api_integration(self, web_client: TestClient, api_client: TestClient):
...
class TestCrossPlatformIntegration:
    ...
    def test_api_cli_web_data_flow(self, api_client: TestClient, web_client: TestClient, auth_token, sample_csv_content):
        ...
        with patch('pynomaly.application.services.detector_service.DetectorService.create_detector') as mock_create:
            ...
            api_response = api_client.post("/api/detectors/", json=detector_config, headers=headers)
        ...
        with patch('pynomaly.presentation.web.app.upload_dataset') as mock_upload:
            ...
            web_response = web_client.post("/htmx/datasets/upload", files=files, data=data)
        ...
        with patch('pynomaly.presentation.web.app.get_detection_results') as mock_results:
            mock_results.return_value = {
                "results": [
                    {"id": "result1", "detector": "Cross-Platform Detector", "anomalies": 3}
                ]
            }
    ...
    def test_concurrent_access_across_interfaces(self, api_client: TestClient, web_client: TestClient, auth_token):
    ...
    def test_session_consistency_across_interfaces(self, api_client: TestClient, web_client: TestClient):
        ...
        # Login via API
        with patch('pynomaly.infrastructure.auth.JWTAuthService.authenticate_user') as mock_auth:
...
class TestErrorHandlingIntegration:
    ...
    def test_api_error_propagation_to_web(self, web_client: TestClient):
        ...
        with patch('requests.post') as mock_post:
            ...
            mock_response.json.return_value = {"detail": "Invalid detector configuration"}
    ...
    def test_database_connection_error_handling(self, api_client: TestClient, auth_token):
...
class TestPerformanceIntegration:
    ...
    def test_end_to_end_performance(self, api_client: TestClient, auth_token, sample_csv_content):
        ...
        with patch('pynomaly.application.services.dataset_service.DatasetService.load_dataset') as mock_load, \
             patch('pynomaly.application.services.detector_service.DetectorService.create_detector') as mock_create, \
             patch('pynomaly.application.services.detection_service.DetectionService.train_detector') as mock_train, \
             patch('pynomaly.application.services.detection_service.DetectionService.detect_anomalies') as mock_predict:
            ...
            mock_predict.return_value = {"anomaly_count": 50, "predictions": [0] * 950 + [1] * 50}
            ...
            # Upload
            upload_response = api_client.post("/api/datasets/upload", files=files, data=data, headers=headers)
            dataset_id = upload_response.json()["id"]
            
            # Create detector
            detector_response = api_client.post("/api/detectors/", json={
            ...
            # Train
            train_response = api_client.post("/api/detection/train", json={
                "detector_id": detector_id,
                "dataset_id": dataset_id
            }, headers=headers)
            
            # Predict
            predict_response = api_client.post("/api/detection/predict", json={
                "detector_id": detector_id,
                "dataset_id": dataset_id
            }, headers=headers)
    ...
    def test_concurrent_operations_performance(self, api_client: TestClient, auth_token):
...
class TestSecurityIntegration:
    ...
    def test_authentication_consistency(self, api_client: TestClient, web_client: TestClient, auth_token):
    ...
    def test_input_validation_consistency(self, api_client: TestClient, web_client: TestClient, auth_token):
        ...
        api_response = api_client.post("/api/detectors/", json=malicious_data, headers=api_headers)
