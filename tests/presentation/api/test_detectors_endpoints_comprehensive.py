...
from pynomaly.application.dto import DetectorDTO, CreateDetectorDTO, UpdateDetectorDTO
...
class TestDetectorEndpoints:
    ...
    def mock_user(self):
        ...
        with patch('pynomaly.presentation.api.deps.get_current_user') as mock:
            user = {
                ...
                "roles": ["user"],
                "permissions": ["detector:create", "detector:read", "detector:update", "detector:delete"]
            }
    ...
    def test_list_detectors_success(self, client, mock_container, mock_user, sample_detector_dto):
    ...
    def test_list_detectors_with_algorithm_filter(self, client, mock_container, mock_user, sample_detector_dto):
    ...
    def test_list_detectors_with_fitted_filter(self, client, mock_container, mock_user, sample_detector_dto):
    ...
    def test_list_detectors_with_pagination(self, client, mock_container, mock_user, sample_detector_dto):
    ...
    def test_create_detector_success(self, client, mock_container, mock_user, sample_create_detector_dto, sample_detector_dto):
    ...
    def test_create_detector_invalid_hyperparameters(self, client, mock_container, mock_user):
        """Test detector creation with invalid hyperparameters."""
        mock_adapter = mock_container.pyod_adapter.return_value
        mock_adapter.validate_hyperparameters.side_effect = ValueError("Invalid parameter: n_estimators must be positive")
    ...
    def test_get_detector_by_id_success(self, client, mock_container, mock_user, sample_detector_dto):
    ...
    def test_get_detector_hyperparameters(self, client, mock_container, mock_user, sample_detector_dto):
    ...
    def test_get_detector_metadata(self, client, mock_container, mock_user, sample_detector_dto):
    ...
    def test_update_detector_success(self, client, mock_container, mock_user, sample_detector_dto):
    ...
    def test_update_detector_not_found(self, client, mock_container, mock_user):
        ...
        response = client.put("/api/v1/detectors/99999999-9999-9999-9999-999999999999", json=update_data)
        
        assert response.status_code == 404

    def test_update_detector_hyperparameters_only(self, client, mock_container, mock_user, sample_detector_dto):
    ...
    def test_update_detector_validation_error(self, client, mock_container, mock_user, sample_detector_dto):
    ...
    def test_update_fitted_detector_restriction(self, client, mock_container, mock_user, sample_detector_dto):
    ...
    def test_delete_detector_success(self, client, mock_container, mock_user, sample_detector_dto):
    ...
    def test_delete_detector_not_found(self, client, mock_container, mock_user):
        ...
        response = client.delete("/api/v1/detectors/99999999-9999-9999-9999-999999999999")
        
        assert response.status_code == 404

    def test_delete_detector_in_use(self, client, mock_container, mock_user, sample_detector_dto):
    ...
    def test_list_supported_algorithms(self, client, mock_container, mock_user):
        ...
        mock_sklearn.list_algorithms.return_value = [
            "EllipticEnvelope", "LocalOutlierFactor"
        ]
    ...
    def test_validate_algorithm_hyperparameters(self, client, mock_container, mock_user):
        ...
        response = client.post("/api/v1/detectors/validate-hyperparameters", json=validation_data)
    ...
    def test_get_detector_performance_metrics(self, client, mock_container, mock_user, sample_detector_dto):
    ...
    def test_get_detector_training_history(self, client, mock_container, mock_user, sample_detector_dto):
    ...
    def test_export_detector_model(self, client, mock_container, mock_user, sample_detector_dto):
    ...
    def test_import_detector_model(self, client, mock_container, mock_user, sample_detector_dto):
    ...
    def test_bulk_detector_operations(self, client, mock_container, mock_user, sample_detector_dto):
    ...
    def test_compare_detectors(self, client, mock_container, mock_user):
        ...
        mock_service.compare_detectors.return_value = {
            "detectors": [
                {"id": "detector-1", "name": "IF Detector", "algorithm": "IsolationForest"},
                {"id": "detector-2", "name": "LOF Detector", "algorithm": "LocalOutlierFactor"}
            ],
            "comparison_metrics": {
                "accuracy": [0.95, 0.92],
                "precision": [0.93, 0.89],
...
class TestDetectorEndpointsIntegration:
    ...
    def test_complete_detector_lifecycle(self, client):
        ...
        with patch('pynomaly.presentation.api.deps.get_current_user') as mock_auth:
            ...
            with patch('pynomaly.presentation.api.deps.get_container') as mock_container:
                ...
                # Verify lifecycle
                responses = [create_response, list_response, get_response, update_response, delete_response]
    ...
    def test_detector_algorithm_workflow(self, client):
        ...
        with patch('pynomaly.presentation.api.deps.get_current_user') as mock_auth:
            mock_auth.return_value = {"user_id": "test", "permissions": ["detector:read"]}
