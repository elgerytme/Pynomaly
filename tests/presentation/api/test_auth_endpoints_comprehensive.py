...
from pynomaly.infrastructure.auth import JWTAuthService, TokenResponse, UserModel
...
class TestAuthEndpoints:
    ...
    def test_register_duplicate_username(self, client, mock_auth_service, valid_user_data):
    ...
    def test_refresh_token_invalid(self, client, mock_auth_service):
        ...
        mock_auth_service.refresh_access_token.side_effect = AuthenticationError("Invalid refresh token")
    ...
    def test_refresh_token_expired(self, client, mock_auth_service):
        ...
        mock_auth_service.refresh_access_token.side_effect = AuthenticationError("Refresh token expired")
    ...
    def test_change_password_wrong_current(self, client, mock_auth_service):
        ...
        with patch('pynomaly.infrastructure.auth.get_current_active_user') as mock_user:
            ...
            mock_auth_service.change_password.side_effect = AuthenticationError("Current password incorrect")
    ...
    def test_reset_password_invalid_token(self, client, mock_auth_service):
        ...
        mock_auth_service.reset_password.side_effect = AuthenticationError("Invalid reset token")
    ...
    def test_logout_all_sessions(self, client, mock_auth_service):
        ...
        with patch('pynomaly.infrastructure.auth.get_current_active_user') as mock_user:
            ...
            mock_auth_service.logout_all_sessions.return_value = 3  # Number of sessions terminated
    ...
    def test_verify_mfa_setup(self, client, mock_auth_service):
        ...
        with patch('pynomaly.infrastructure.auth.get_current_active_user') as mock_user:
            ...
            headers = {"Authorization": "Bearer valid.access.token"}
            response = client.post("/api/v1/auth/mfa/verify", json=verify_data, headers=headers)
    ...
    def test_complete_auth_workflow(self, client):
        ...
        with patch('pynomaly.infrastructure.auth.JWTAuthService') as mock_service:
            ...
            if login_response.status_code == 200:
                ...
                with patch('pynomaly.infrastructure.auth.get_current_active_user') as mock_user:
                    mock_user.return_value = UserModel(id="test-user", username="testuser")
