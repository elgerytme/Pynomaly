...
class TestDetectionEndpoints:
    ...
    def sample_result_dto(self):
        ...
        return DetectionResultDTO(
            ...
            metadata={"execution_time": 0.5, "anomaly_count": 2, "total_samples": 5},
            created_at=datetime.utcnow(),
        )
    ...
    def test_train_detector_invalid_request(self, client, mock_user):
        ...
        invalid_request = {"detector_id": "invalid-uuid", "dataset_id": "also-invalid"}
    ...
    def test_train_detector_not_found(self, client, mock_container, mock_user):
        ...
        mock_use_case.execute = AsyncMock(
            side_effect=HTTPException(status_code=404, detail="Detector not found")
        )
    ...
    def test_train_detector_background_task(
        self, client, mock_container, mock_user, sample_detector_dto
    ):
    ...
    def test_detect_anomalies_success(
        self, client, mock_container, mock_user, sample_result_dto
    ):
    ...
    def test_detect_anomalies_batch(
        ...
        mock_use_case = mock_container.detect_anomalies_use_case.return_value
        mock_use_case.execute = AsyncMock(
            return_value=[sample_result_dto, sample_result_dto]
        )
    ...
    def test_detect_anomalies_invalid_detector(self, client, mock_container, mock_user):
        ...
        mock_use_case = mock_container.detect_anomalies_use_case.return_value
        mock_use_case.execute = AsyncMock(
            side_effect=HTTPException(status_code=400, detail="Detector not trained")
        )
    ...
    def test_evaluate_detector_cross_validation(
    ...
    def test_list_detection_results(
        self, client, mock_container, mock_user, sample_result_dto
    ):
    ...
    def test_filter_detection_results(
        self, client, mock_container, mock_user, sample_result_dto
    ):
    ...
    def test_delete_detection_results(
        self, client, mock_container, mock_user, sample_result_dto
    ):
    ...
    def test_real_time_detection_endpoint(self, client, mock_container, mock_user):
        ...
        mock_service.detect_real_time = AsyncMock(
            return_value={
                "anomaly_score": 0.85,
                "is_anomaly": True,
                "confidence": 0.92,
    ...
    def test_streaming_detection_endpoint(self, client, mock_container, mock_user):
        ...
        mock_service = Mock()
        mock_service.start_stream = AsyncMock(
            return_value={
