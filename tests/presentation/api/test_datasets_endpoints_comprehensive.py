...
class TestDatasetEndpoints:
    ...
    def sample_dataset_dto(self):
        ...
        return DatasetDTO(
            ...
            metadata={"source": "test", "quality_score": 0.95, "encoding": "utf-8"},
        )
    ...
    def test_list_datasets_success(
        self, client, mock_container, mock_user, sample_dataset_dto
    ):
    ...
    def test_create_dataset_from_upload_success(
        self, client, mock_container, mock_user, sample_csv_data, sample_dataset_dto
    ):
    ...
    def test_create_dataset_large_file(self, client, mock_container, mock_user):
        ...
        large_data = pd.DataFrame(
            {"feature1": range(100000), "feature2": range(100000, 200000)}
        )
    ...
    def test_get_dataset_data_preview(
        self, client, mock_container, mock_user, sample_csv_data
    ):
        ...
        mock_repo.get_data_preview.return_value = {
            ...
            "sample": [{"feature1": 3.0, "feature2": 2.5, "feature3": "A"}],
        }
    ...
    def test_update_dataset_not_found(self, client, mock_container, mock_user):
        ...
        response = client.put(
            "/api/v1/datasets/99999999-9999-9999-9999-999999999999", json=update_data
        )

        assert response.status_code == 404

    def test_update_dataset_validation_error(
        self, client, mock_container, mock_user, sample_dataset_dto
    ):
    ...
    def test_delete_dataset_not_found(self, client, mock_container, mock_user):
        ...
        response = client.delete(
            "/api/v1/datasets/99999999-9999-9999-9999-999999999999"
        )
    ...
    def test_dataset_statistics(self, client, mock_container, mock_user):
        ...
        statistics = {
            ...
            "correlations": {"feature1_feature2": 0.123},
        }
    ...
    def test_dataset_feature_engineering(
        self, client, mock_container, mock_user, sample_dataset_dto
    ):
        ...
        transformations = {
            "operations": [
                ...
                {"type": "encode", "features": ["feature3"], "method": "one_hot"},
            ]
        }

        dataset_id = str(sample_dataset_dto.id)
        response = client.post(
            f"/api/v1/datasets/{dataset_id}/transform", json=transformations
        )
    ...
    def test_bulk_dataset_operations(
        self, client, mock_container, mock_user, sample_dataset_dto
    ):
