...
from pynomaly.presentation.web.htmx_endpoints import (
    htmx_detection_results,
    htmx_training_progress,
    htmx_dataset_preview,
    htmx_model_metrics,
    htmx_system_status,
    htmx_alerts_panel,
    htmx_analytics_chart,
    htmx_file_upload_progress
)
...
class TestHTMXDetectionResults:
    ...
    def test_htmx_detection_results_success(self):
        ...
        with patch('pynomaly.presentation.web.dependencies.get_detection_service') as mock_service:
    ...
    def test_htmx_detection_results_error_handling(self):
        ...
        with patch('pynomaly.presentation.web.dependencies.get_detection_service') as mock_service:
            mock_service.return_value.detect_anomalies.side_effect = Exception("Detection failed")
    ...
    def test_htmx_detection_results_streaming(self):
        ...
        with patch('pynomaly.presentation.web.dependencies.get_detection_service') as mock_service:
            mock_service.return_value.detect_anomalies_stream.return_value = [
                ...
                {"progress": 100, "final_results": {"anomaly_scores": [0.1, 0.2, 0.9, 0.1]}}
            ]
...
class TestHTMXTrainingProgress:
    ...
    def test_htmx_training_progress_running(self):
        ...
        with patch('pynomaly.presentation.web.dependencies.get_training_service') as mock_service:
            ...
            response = self.client.get(
                "/htmx/training/progress/train-123",
                headers={"HX-Request": "true"}
            )
...
class TestHTMXDatasetPreview:
    ...
    def test_htmx_dataset_preview_success(self):
        ...
        with patch('pynomaly.presentation.web.dependencies.get_dataset_service') as mock_service:
            ...
            response = self.client.get(
                "/htmx/dataset/preview/dataset-123",
                headers={"HX-Request": "true"}
            )
...
class TestHTMXModelMetrics:
    ...
    def test_htmx_model_metrics_success(self):
        ...
        with patch('pynomaly.presentation.web.dependencies.get_model_service') as mock_service:
...
class TestHTMXSystemStatus:
    ...
    def test_htmx_system_status_healthy(self):
        ...
        with patch('pynomaly.presentation.web.dependencies.get_system_service') as mock_service:
    ...
    def test_htmx_system_status_error(self):
        ...
        with patch('pynomaly.presentation.web.dependencies.get_system_service') as mock_service:
            mock_service.return_value.get_system_status.side_effect = Exception("System status unavailable")
...
class TestHTMXFileUploadProgress:
    ...
    def test_htmx_file_upload_progress_success(self):
        ...
        with patch('pynomaly.presentation.web.dependencies.get_upload_service') as mock_service:
            ...
            response = self.client.get(
                "/htmx/upload/progress/upload-123",
                headers={"HX-Request": "true"}
            )
...
class TestHTMXWebSocketIntegration:
    ...
    def test_htmx_websocket_message_template(self):
        ...
        response = self.client.get(
                "/htmx/websocket/message-template",
                headers={"HX-Request": "true"}
            )
...
class TestHTMXErrorHandling:
    ...
    def test_htmx_validation_error(self):
        ...
        assert "Invalid data format" in html_content or "Validation failed" in html_content
    
    def test_htmx_server_error(self):
        """Test HTMX server error handling."""
        with patch('pynomaly.presentation.web.dependencies.get_detection_service') as mock_service:
            mock_service.return_value.detect_anomalies.side_effect = Exception("Internal server error")
