...
class TestMemoryOptimizedDataLoader:
    ...
    def test_csv_loading(self):
        ...
        try:
            ...
            reconstructed = pd.concat([chunk.data for chunk in chunks], ignore_index=True)
...
class TestDataValidator:
    ...
    def test_duplicate_validation(self):
        ...
        consistency_issues = result.get_issues_by_category(ValidationCategory.CONSISTENCY)
    ...
    def test_custom_validation_rules(self):
        ...
        def custom_rule(df, threshold=5):
            from src.pynomaly.infrastructure.data_processing.data_validator import ValidationIssue, ValidationCategory, ValidationSeverity
        ...
        custom_issues = [issue for issue in result.issues if 'Custom rule' in issue.message]
...
class TestFileValidation:
    ...
    def test_file_extension_validation(self):
        ...
        try:
            ...
            assert any('unsupported' in issue.message.lower() for issue in warning_issues)
    ...
    def test_large_file_validation(self):
        ...
        with patch('pathlib.Path.stat') as mock_stat:
            ...
            with patch('pathlib.Path.exists', return_value=True):
                ...
                warning_issues = result.get_issues_by_severity(ValidationSeverity.WARNING)
                assert any('large file' in issue.message.lower() for issue in warning_issues)
...
class TestMemoryMetrics:
    ...
    def test_memory_metrics_dict_conversion(self):
        ...
        required_keys = ['total_mb', 'available_mb', 'used_mb', 'percent_used', 'process_mb', 'timestamp']
