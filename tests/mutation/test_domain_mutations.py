...
from pynomaly.domain.value_objects import (
    AnomalyScore, ContaminationRate, ConfidenceInterval, ThresholdConfig
)
...
class TestConfidenceIntervalMutations:
    ...
    def test_confidence_interval_contains_logic(self):
        ...
        test_values = [ci.lower_bound, ci.upper_bound, (ci.lower_bound + ci.upper_bound) / 2]
