...
class TestCriticalDomainLogic:
    ...
    def test_threshold_calculation_logic_mutations(self):
        ...
        threshold_same = calculator.calculate_threshold(all_same_scores, contamination=0.1)
    ...
    def test_dataset_validation_mutations(self):
        ...
        with pytest.raises((ValueError, AssertionError)):
            Dataset(name="test", features=features, targets=np.array([0, 1]))  # Wrong length
    ...
    def test_detector_contamination_usage_mutations(self):
        ...
        min_detector = Detector(
            name="min_detector",
            algorithm="test",
            contamination=ContaminationRate(0.0)
        )
        ...
        max_detector = Detector(
            name="max_detector", 
            algorithm="test",
            contamination=ContaminationRate(0.5)
        )
...
class TestMutationSensitiveEdgeCases:
    ...
    def test_single_value_arrays(self):
        ...
        threshold_single = calculator.calculate_threshold(single_score, contamination=0.0)
