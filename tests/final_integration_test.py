...
'''
        ...
        try:
            ...
            for endpoint in endpoints:
                try:
                    ...
                    test_name = endpoint.replace("/", "root" if endpoint == "/" else endpoint[1:])
    ...
    def _test_domain_imports(self):
        ...
        try:
            ...
            return {"success": True, "entities_imported": 4, "value_objects_imported": 2}
        except Exception as e:
    ...
    def _test_application_imports(self):
        ...
        try:
            ...
            return {"success": True, "services_imported": True, "use_cases_imported": True}
        except Exception as e:
            return {"success": False, "error": str(e)}
    ...
    def test_integration_workflows(self):
        ...
        try:
            ...
            result = subprocess.run(
                [str(self.project_root / "run_pynomaly.py"), "dataset", "info", str(test_file)],
                capture_output=True,
                text=True,
                timeout=30
            )
    ...
    def generate_summary(self):
        ...
        categories = ["cli_tests", "api_tests", "core_functionality", "integration_workflows"]
        ...
        for category in categories:
            if category in self.results:
                ...
                if total > 0:
                    ...
                    summary[f"{category.replace('_tests', '').replace('_functionality', '').replace('_workflows', '')}_success_rate"] = success_rate
        ...
        if summary["total_tests"] > 0:
            summary["overall_success_rate"] = (summary["successful_tests"] / summary["total_tests"]) * 100
