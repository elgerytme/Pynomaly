...
class DatasetsPage(BasePage):
    ...
    def __init__(self, page: Page, base_url: str = "http://localhost:8000"):
        ...
        self.dataset_description_input_selector = "#dataset-description, textarea[name='description']"
    ...
    def wait_for_datasets_page_load(self):
        ...
        self.page.wait_for_selector(f"{self.datasets_table_selector}, .empty-state", timeout=self.default_timeout)
    ...
    def fill_dataset_form(self, name: str, description: str = ""):
        ...
        if description:
            desc_input = self.wait_for_element_visible(self.dataset_description_input_selector)
            desc_input.clear()
    ...
    def delete_dataset(self, dataset_name: str):
        ...
        dataset_row = self.page.locator(f"{self.datasets_table_selector} tr:has-text('{dataset_name}')")
        
        if dataset_row.is_visible():
            delete_button = dataset_row.locator(".delete-button, button[data-action='delete']")
            delete_button.click()
