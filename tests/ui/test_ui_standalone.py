...
class TestPynomalaUIStandalone:
    ...
    def test_dashboard_loads(self, page_setup):
        ...
        page.screenshot(
            path=str(screenshots_dir / "test_dashboard_loads.png"), full_page=True
        )
    ...
    def test_mobile_responsiveness(self, page_setup):
        ...
        screenshots_dir.mkdir(exist_ok=True)
        page.screenshot(
            path=str(screenshots_dir / "test_mobile_menu.png"), full_page=True
        )
    ...
    def test_detectors_page(self, page_setup):
        ...
        screenshots_dir.mkdir(exist_ok=True)
        page.screenshot(
            path=str(screenshots_dir / "test_detectors_page.png"), full_page=True
        )
    ...
    def test_datasets_page(self, page_setup):
        ...
        screenshots_dir.mkdir(exist_ok=True)
        page.screenshot(
            path=str(screenshots_dir / "test_datasets_page.png"), full_page=True
        )
    ...
    def test_detection_page(self, page_setup):
        ...
        screenshots_dir.mkdir(exist_ok=True)
        page.screenshot(
            path=str(screenshots_dir / "test_detection_page.png"), full_page=True
        )
    ...
    def test_visualizations_page(self, page_setup):
        ...
        screenshots_dir.mkdir(exist_ok=True)
        page.screenshot(
            path=str(screenshots_dir / "test_visualizations_page.png"), full_page=True
        )
    ...
    def test_exports_page(self, page_setup):
        ...
        screenshots_dir.mkdir(exist_ok=True)
        page.screenshot(
            path=str(screenshots_dir / "test_exports_page.png"), full_page=True
        )
