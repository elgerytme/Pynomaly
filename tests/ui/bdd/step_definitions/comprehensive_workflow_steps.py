...
def setup_security_analyst_persona(page: Page):
    ...
    test_context["permissions"] = ["monitor_security", "investigate_threats", "manage_alerts"]
    test_context["page"] = page
...
def setup_ml_engineer_persona(page: Page):
    ...
    test_context["permissions"] = ["deploy_models", "manage_infrastructure", "monitor_production"]
    test_context["page"] = page
...
@given(parsers.parse("the dataset contains {records:d} transactions with {fraud_rate:g}% fraud rate"))
...
def verify_training_status(page: Page):
    ...
    expect(page.locator("[data-testid='training-status']")).to_contain_text("Training in progress")
...
def verify_training_completion(page: Page, timeout: int):
    ...
    expect(page.locator("[data-testid='training-complete']")).to_be_visible(timeout=timeout * 1000)
...
def verify_monitoring_active(page: Page):
    ...
    expect(page.locator("[data-testid='monitoring-status']")).to_contain_text("Real-time monitoring active")
...
@then(parsers.parse("I should receive an immediate security alert within {timeout:d} seconds"))
def verify_security_alert(page: Page, timeout: int):
    """Verify security alert is received."""
    expect(page.locator("[data-testid='security-alert']")).to_be_visible(timeout=timeout * 1000)
...
def verify_anomalous_traffic_highlight(page: Page):
    ...
    expect(page.locator("[data-testid='anomalous-traffic'].highlighted")).to_be_visible()
...
def verify_deployment_completion(page: Page, timeout: int):
    ...
    expect(page.locator("[data-testid='deployment-complete']")).to_be_visible(timeout=timeout * 60000)
...
def verify_upload_performance(page: Page):
    ...
    expect(page.locator("[data-testid='upload-complete']")).to_be_visible(timeout=300000)
