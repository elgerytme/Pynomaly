...
"""
    ...
    def test_ml_framework_integration_workflow(self):
        ...
        for framework, config in ml_frameworks.items():
            ...
            with patch(f'pynomaly.infrastructure.adapters.{framework}_adapter.{adapter_class}') as mock_adapter:
    ...
    def test_streaming_integration_workflow(self):
        ...
        try:
            ...
            streaming_data = [
                ...
                {"timestamp": "2024-01-01T00:02:00Z", "features": [10.0, 20.0, 30.0]}  # Anomaly
            ]
            ...
            consumed_data = mock_kafka_processor.consume(topic="anomaly_data", timeout=5)
            ...
            for data_point in consumed_data:
                ...
                if anomaly_score > 0.4:  # Threshold for anomaly
                    ...
                    publish_result = mock_redis_processor.publish("anomaly_alerts", alert)
...
class TestComponentIntegrationPhase3:
    ...
    def test_monitoring_integration(self):
        ...
        monitoring_components = {
            "prometheus": {
                "metrics": ["http_requests_total", "detection_time_seconds", "anomaly_detection_accuracy"],
                "enabled": True
            },
            "opentelemetry": {
        ...
        with patch.dict('sys.modules', {
            ...
            cache_scenarios = {
                ...
                "dataset_metadata_cache": {
                    ...
                    "value": {"features": 30, "samples": 284807, "anomaly_rate": 0.001727},
                    "ttl": 1800
                },
                "detection_results_cache": {
                    "key": "results:detector_123:dataset_456",
                    "value": {"anomaly_scores": [0.1, 0.2, 0.9], "cached_at": "2024-01-01T00:00:00Z"},
                    "ttl": 300
                }
            }
    ...
    def test_data_pipeline_integration(self):
        ...
        pipeline_stages = {
            ...
            "preprocessing": {
                "steps": ["validation", "cleaning", "transformation", "feature_engineering"],
    ...
    def test_phase3_integration_completion(self):
        ...
        for requirement in phase3_requirements:
            ...
            assert "integration" in requirement or "workflow" in requirement, f"{requirement} should be integration-related"
        
        # Verify comprehensive integration coverage
        assert len(phase3_requirements) >= 12, "Should have comprehensive Phase 3 integration coverage"
