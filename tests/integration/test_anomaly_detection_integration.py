...
class TestAnomalyDetectionIntegration:
    ...
    def test_service_layer_integration(
        self, container: Container, sample_dataset, sample_detector
    ):
        ...
        with patch.object(detection_service, "_save_result") as mock_save:
            ...
            with patch.object(detection_service, "_run_detection") as mock_detection:
                ...
                result = detection_service.detect_anomalies(
                    sample_dataset, sample_detector
                )
            ...
            def slow_detection(*args, **kwargs):
                ...
                return DetectionResult(
                    ...
                    scores=[
                        ...
                        for _ in range(len(large_dataset.data))
                    ],
    ...
    def test_error_handling_integration(self, container: Container, sample_dataset):
        ...
        invalid_detector = Detector(algorithm_name="InvalidAlgorithm", parameters={})
...
class TestDataPipelineIntegration:
    ...
    def test_data_transformation_integration(
        self, container: Container, sample_dataset
    ):
...
class TestAsyncIntegration:
    ...
    async def test_async_detection_integration(
        self, container: Container, sample_dataset, sample_detector
    ):
        ...
        with patch.object(async_service, "_run_async_detection") as mock_async:
            ...
            result = await async_service.detect_anomalies_async(
                sample_dataset, sample_detector
            )
    ...
    async def test_concurrent_detection_integration(
        self, container: Container, sample_dataset
    ):
    ...
    async def test_async_batch_processing_integration(
        self, container: Container, sample_detector
    ):
        ...
        with patch.object(async_service, "_run_batch_detection") as mock_batch:
            ...
            results = await async_service.detect_anomalies_batch_async(
                datasets, sample_detector
            )
...
class TestAPIIntegration:
    ...
    def test_api_error_handling_integration(self, client):
        ...
        invalid_request = {
            ...
            "detector": {"algorithm_name": "InvalidAlgorithm", "parameters": {}},
        }
    ...
    def test_database_query_integration(self, db_session, sample_dataset):
        ...
        with patch.object(db_session, "query") as mock_query:
            ...
            result = (
                ...
                .filter(Dataset.id == sample_dataset.id)
                .first()
            )
...
class TestPerformanceIntegration:
    ...
    def test_throughput_integration(self, container: Container, benchmark_data):
        ...
        for size, dataset in datasets.items():
            with patch.object(detection_service, "_run_detection") as mock_detection:
                ...
                execution_time = end_time - start_time
                throughput = (
                    len(dataset.data) / execution_time
                    if execution_time > 0
                    else float("inf")
                )
    ...
    def test_concurrent_performance_integration(
        self, container: Container, sample_dataset
    ):
