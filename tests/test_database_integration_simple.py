...
class TestDatabaseIntegrationSimple:
    ...
    @pytest.mark.asyncio
    async def test_async_detector_repository_basic_operations(self, test_async_database_repositories):
    ...
    @pytest.mark.asyncio
    async def test_async_dataset_repository_basic_operations(self, test_async_database_repositories):
    ...
    @pytest.mark.asyncio 
    async def test_async_result_repository_basic_operations(self, test_async_database_repositories):
    ...
    def test_async_repository_wrappers_are_properly_configured(self, test_async_database_repositories):
