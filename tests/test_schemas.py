#!/usr/bin/env python3
"""Simple test script to validate the schemas package."""
...
try:
    ...
    from pynomaly.schemas.analytics import (
    ...
    from pynomaly.schemas.analytics.anomaly_kpis import AnomalySeverity, AnomalyCategory
    from pynomaly.schemas.analytics.system_health import SystemStatus
    ...
    from pynomaly.schemas.analytics.financial_impact import ROICalculation
