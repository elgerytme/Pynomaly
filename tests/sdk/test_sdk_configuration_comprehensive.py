...
class TestSDKConfigurationManagement:
    ...
    def mock_config_sdk(self):
        ...
        class MockConfigSDK:
            ...
            def create_configuration(self, config_name: str, config_data: Dict[str, Any]) -> str:
            ...
            def load_configuration_from_file(self, file_path: str, config_name: str = None) -> str:
            ...
            def save_configuration_to_file(self, config_id: str, file_path: str, format: str = None) -> bool:
            ...
            def get_active_configuration(self) -> Optional[Dict[str, Any]]:
                ...
                if not self.active_config or self.active_config not in self.configurations:
            ...
            def update_configuration(self, config_id: str, updates: Dict[str, Any]) -> bool:
                ...
                try:
                    ...
                    self.configurations[config_id]["updated_at"] = "2023-10-01T11:00:00Z"
            ...
            def get_configuration_value(self, key_path: str, config_id: str = None) -> Any:
            ...
            def set_configuration_value(self, key_path: str, value: Any, config_id: str = None) -> bool:
            ...
            def _validate_configuration(self, config: Dict[str, Any]) -> Dict[str, Any]:
                ...
                if 'algorithms' in config:
                    for algo_name, params in config['algorithms'].items():
                        ...
                        if isinstance(params, dict):
                            validation_errors = self._validate_algorithm_params(algo_name, params)
                ...
                if 'data' in config and 'validation' in config['data']:
                    ...
                    if 'min_samples' in validation_params:
                        if not isinstance(validation_params['min_samples'], int) or validation_params['min_samples'] < 1:
                            errors.append("data.validation.min_samples must be a positive integer")
            ...
            def _validate_algorithm_params(self, algorithm: str, params: Dict[str, Any]) -> List[str]:
                ...
                if algorithm == "IsolationForest":
                    if 'contamination' in params:
                        ...
                        if not (0.0 < contamination < 0.5):
                            errors.append(f"IsolationForest contamination must be between 0 and 0.5, got {contamination}")
                    
                    if 'n_estimators' in params:
                        n_estimators = params['n_estimators']
                        if not isinstance(n_estimators, int) or n_estimators < 1:
                            errors.append(f"IsolationForest n_estimators must be positive integer, got {n_estimators}")
                
                elif algorithm == "LocalOutlierFactor":
                    if 'n_neighbors' in params:
                        n_neighbors = params['n_neighbors']
                        if not isinstance(n_neighbors, int) or n_neighbors < 1:
                            errors.append(f"LocalOutlierFactor n_neighbors must be positive integer, got {n_neighbors}")
                
                elif algorithm == "OneClassSVM":
                    if 'nu' in params:
                        nu = params['nu']
                        if not (0.0 < nu <= 1.0):
                            errors.append(f"OneClassSVM nu must be between 0 and 1, got {nu}")
            ...
            def _convert_ini_to_dict(self, config_parser: configparser.ConfigParser) -> Dict[str, Any]:
            ...
            def _convert_dict_to_ini(self, config: Dict[str, Any]) -> configparser.ConfigParser:
    ...
    def test_configuration_creation_and_management(self, mock_config_sdk):
        ...
        assert active_config["algorithms"]["LocalOutlierFactor"]["contamination"] == 0.15
    ...
    def test_configuration_file_operations(self, mock_config_sdk):
        ...
        try:
            ...
            assert loaded_config["algorithms"]["IsolationForest"]["contamination"] == 0.2
    ...
    def test_configuration_value_access(self, mock_config_sdk):
        ...
        assert sdk.get_configuration_value("algorithms.IsolationForest.contamination") == 0.1
        ...
        # Test setting values
        assert sdk.set_configuration_value("algorithms.IsolationForest.contamination", 0.15)
        assert sdk.get_configuration_value("algorithms.IsolationForest.contamination") == 0.15
    ...
    def test_environment_variable_overrides(self, mock_config_sdk):
        ...
        sdk.set_environment_override("PYNOMALY_CONTAMINATION", "algorithms.IsolationForest.contamination")
        sdk.set_environment_override("PYNOMALY_N_ESTIMATORS", "algorithms.IsolationForest.n_estimators")
        sdk.set_environment_override("PYNOMALY_NORMALIZE", "data.preprocessing.normalize")
        ...
        try:
            ...
            assert active_config["algorithms"]["IsolationForest"]["contamination"] == 0.2
    ...
    def test_configuration_updates_and_history(self, mock_config_sdk):
        ...
        assert final_config["algorithms"]["IsolationForest"]["contamination"] == 0.15  # Still the valid value
