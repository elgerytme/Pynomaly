...
class TestSDKCoreInterface:
    ...
    def test_sdk_dataset_loading_from_file(self, mock_pynomaly_sdk, sample_data_files):
        ...
        if 'csv' in sample_data_files:
            dataset_id = sdk.load_dataset(sample_data_files['csv'], name="CSV Test Dataset")
        ...
        if 'json' in sample_data_files:
            dataset_id = sdk.load_dataset(sample_data_files['json'], name="JSON Test Dataset")
    ...
    def test_sdk_model_creation_and_management(self, mock_pynomaly_sdk):
        ...
        try:
            ...
            assert not sdk.delete_model(model_id1)  # Should return False for non-existent model
