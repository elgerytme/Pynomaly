...
class TestSDKEnsembleMethods:
    ...
    def mock_ensemble_sdk(self):
        ...
        class MockEnsembleSDK:
            ...
            def train_ensemble(self, ensemble_id: str, dataset_id: str) -> Dict[str, Any]:
                ...
                successful_models = sum(1 for r in training_results.values() if r["success"])
            ...
            def detect_with_ensemble(self, ensemble_id: str, dataset_id: str) -> str:
                ...
                if aggregation_method == "voting":
                    ensemble_labels = self._aggregate_voting(
                        model_predictions, 
                        ensemble["voting_threshold"]
                    )
                    ensemble_scores = self._aggregate_scores_average(model_scores)
                elif aggregation_method == "weighted_average":
                    weights = {name: data["weight"] for name, data in ensemble["models"].items()}
                    ensemble_scores = self._aggregate_scores_weighted(model_scores, weights)
            ...
            def _aggregate_voting(self, predictions: Dict[str, np.ndarray], threshold: float) -> np.ndarray:
            ...
            def _aggregate_scores_average(self, scores: Dict[str, List[float]]) -> List[float]:
            ...
            def _aggregate_scores_weighted(self, scores: Dict[str, List[float]], weights: Dict[str, float]) -> List[float]:
            ...
            def load_dataset(self, data: Union[pd.DataFrame, np.ndarray], name: str = None) -> str:
    ...
    def test_ensemble_creation_and_training(self, mock_ensemble_sdk):
        ...
        try:
            ...
            assert training_result["successful_models"] <= training_result["total_models"]
            ...
            def save_model(self, model_id: str, file_path: str) -> bool:
                ...
                try:
                    ...
                    save_data = {
                        ...
                        "adapter": model_data["adapter"]  # This includes the trained model
                    }
            ...
            def load_model(self, file_path: str) -> str:
                ...
                try:
                    ...
                    if save_data["trained"]:
                        self.models[model_id]["trained_at"] = datetime.fromisoformat(save_data["trained_at"])
...
class TestSDKPerformanceOptimization:
    ...
    def mock_performance_sdk(self):
        ...
        class MockPerformanceSDK:
            ...
            def train_model_with_profiling(self, model_id: str, dataset_id: str) -> Dict[str, Any]:
                ...
                try:
                    ...
                    return {
                        ...
                        "samples_per_second": dataset.n_samples / training_time if training_time > 0 else 0
                    }
            ...
            def predict_with_profiling(self, model_id: str, dataset_id: str) -> Dict[str, Any]:
                ...
                try:
                    ...
                    return {
                        ...
                        "predictions_per_second": len(scores) / prediction_time if prediction_time > 0 else 0,
            ...
            def batch_predict(self, model_id: str, datasets: List[str], batch_size: int = None) -> List[Dict[str, Any]]:
            ...
            def _process_batch(self, model_id: str, dataset_ids: List[str]) -> List[Dict[str, Any]]:
            ...
            def get_performance_metrics(self, model_id: str) -> Dict[str, Any]:
                ...
                if profile["training_time"] and profile["prediction_time"]:
                    metrics["speed_ratio"] = profile["training_time"] / profile["prediction_time"]
    ...
    def test_batch_prediction_performance(self, mock_performance_sdk):
        ...
        try:
            ...
            batch_results_sized = sdk.batch_predict(model_id, prediction_datasets, batch_size=2)
