...
from pynomaly.infrastructure.adapters.tensorflow_adapter import TensorFlowAdapter, HAS_TENSORFLOW
...
class TestTensorFlowAdapter:
    ...
    def test_get_algorithm_info(self):
        ...
        assert info["description"] == "Deep autoencoder for anomaly detection using reconstruction error"
