...
class TestFederatedCoordinator:
    ...
    async def test_register_participants(self, coordinator, base_detector, test_participants):
    ...
    async def test_start_training_round(self, coordinator, base_detector, test_participants):
    ...
    async def test_receive_model_update(self, coordinator, base_detector, test_participants):
    ...
    async def test_complete_training_round(self, coordinator, base_detector, test_participants):
    ...
    async def test_participant_trust_score_updates(
        ...
        for participant in test_participants[:2]:
            ...
            assert participant.trust_score >= initial_trust_scores[participant.participant_id]
        
        for participant in test_participants[2:4]:
            # Non-contributing participants should have lower trust
            assert participant.trust_score < initial_trust_scores[participant.participant_id]

    async def test_federation_status(self, coordinator, base_detector, test_participants):
    ...
    async def test_byzantine_tolerance(self, coordinator, base_detector, test_participants):
    ...
    async def test_multiple_federations(self, coordinator, base_detector, test_participants):
    ...
    async def test_coordinator_shutdown(self, coordinator, base_detector, test_participants):
