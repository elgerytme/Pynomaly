...
class TestModelSelector:
    ...
    def model_selector(self):
        ...
        return ModelSelector(
            primary_metric="f1_score", secondary_metrics=["precision", "recall"]
        )
    ...
    def diverse_models(self):
        ...
        return [
            ModelPerformanceMetrics(
                ...
                metrics={"f1_score": 0.85, "precision": 0.95, "recall": 0.77},
            ),
            ModelPerformanceMetrics(
                model_id="high_recall",
                metrics={"f1_score": 0.84, "precision": 0.75, "recall": 0.95},
            ),
            ModelPerformanceMetrics(
                model_id="balanced",
                metrics={"f1_score": 0.88, "precision": 0.85, "recall": 0.92},
            ),
            ModelPerformanceMetrics(
                model_id="poor_model",
                metrics={"f1_score": 0.60, "precision": 0.55, "recall": 0.65},
            ),
        ]
    ...
    def test_initialization(self):
        ...
        selector = ModelSelector(
            primary_metric="accuracy", secondary_metrics=["precision", "recall"]
        )
    ...
    def test_rank_models(self, model_selector, sample_models):
        ...
        with patch(
            ...
            with patch.object(
                model_selector.pareto_optimizer, "find_pareto_optimal"
            ) as mock_pareto:
    ...
    def test_significant_difference_mock_ttest(self, model_selector, sample_models):
        ...
        with patch(
            ...
            significant = model_selector.significant_difference(
                sample_models[0], sample_models[1]
            )
    ...
    def test_select_best_model_complete_workflow(self, model_selector, sample_models):
        ...
        with patch.object(model_selector, "rank_models") as mock_rank:
            ...
            with patch.object(model_selector, "significant_difference") as mock_sig:
                ...
                assert (
                    "Selected model_1 based on primary ranking of f1_score"
                    in best_model_selection["rationale"]
                )
                assert (
                    "model_1 is part of the Pareto front"
                    in best_model_selection["rationale"]
                )
    ...
    def test_tie_breaking_logic(self, model_selector):
        ...
        tied_models = [
            ...
            ModelPerformanceMetrics(
                model_id="model_b",
                metrics={"f1_score": 0.85, "precision": 0.85, "recall": 0.85},
            ),
            ModelPerformanceMetrics(
                model_id="model_c",
                metrics={"f1_score": 0.85, "precision": 0.90, "recall": 0.80},
            ),
        ]
        ...
        with patch(
            ...
            with patch.object(
                ...
                assert (
                    "Selected model_a based on primary ranking of f1_score"
                    in selection["rationale"]
                )
    ...
    def test_edge_case_single_model(self, model_selector):
        ...
        single_model = [
            ModelPerformanceMetrics(
                model_id="only_model",
                metrics={"f1_score": 0.8, "precision": 0.75, "recall": 0.85},
            )
        ]
    ...
    def test_different_primary_metrics(self):
        ...
        accuracy_selector = ModelSelector(
            primary_metric="accuracy", secondary_metrics=["precision", "recall"]
        )
        assert accuracy_selector.primary_metric == "accuracy"

        # Test with precision as primary metric
        precision_selector = ModelSelector(
            primary_metric="precision", secondary_metrics=["f1_score", "recall"]
        )
    ...
    def test_error_handling_empty_metrics(self, model_selector):
        ...
        empty_metrics_model = ModelPerformanceMetrics(
            model_id="empty_model", metrics={}
        )

        with pytest.raises(KeyError):
            model_selector.significant_difference(
                empty_metrics_model, empty_metrics_model
            )
