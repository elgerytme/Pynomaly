...
class TestAnomalyType:
    ...
    def test_enum_in_dictionary(self):
        ...
        assert type_descriptions[AnomalyType.POINT] == "Individual data points that are anomalous"
        assert type_descriptions[AnomalyType.CONTEXTUAL] == "Anomalous in specific context"
    ...
    def test_anomaly_type_filtering(self):
        ...
        local_scope = [t for t in all_types if t in [AnomalyType.POINT, AnomalyType.LOCAL]]
        ...
        global_scope = [t for t in all_types if t in [AnomalyType.GLOBAL, AnomalyType.COLLECTIVE]]
