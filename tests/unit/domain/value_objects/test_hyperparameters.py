...
class TestHyperparameterRange:
    ...
    def test_validation_categorical_without_choices(self):
        ...
        with pytest.raises(ValueError, match="Choices required for categorical parameter"):
            HyperparameterRange(
                name="test",
                type=ParameterType.CATEGORICAL
            )
    ...
    def test_validation_float_without_bounds(self):
        ...
        with pytest.raises(ValueError, match="Low and high bounds required for float parameter"):
            HyperparameterRange(
                name="test",
                type=ParameterType.FLOAT
            )
    ...
    def test_validation_int_without_bounds(self):
        ...
        with pytest.raises(ValueError, match="Low and high bounds required for int parameter"):
            HyperparameterRange(
                name="test",
                type=ParameterType.INT
            )
...
class TestHyperparameterSpace:
    ...
    def test_get_numeric_parameters_method(self):
        ...
        space = HyperparameterSpace(parameters={"param1": param1, "param2": param2, "param3": param3})
...
class TestHyperparameterSet:
    ...
    def test_update_method(self):
        ...
        assert new_param_set.parameters == {"param1": 0.5, "param2": "a", "param3": True}
...
class TestUtilityFunctions:
    ...
    def test_boolean_parameter_function(self):
        ...
        param = boolean_parameter(
            name="bootstrap",
            default=True,
            description="Whether to use bootstrap"
        )
...
class TestIntegrationScenarios:
    ...
    def test_edge_cases(self):
        ...
        space = HyperparameterSpace(
            parameters={
                f"param_{i}": float_parameter(f"param_{i}", 0.0, 1.0)
                for i in range(10)
            }
        )
