...
class TestConfidenceIntervalProperties:
    ...
    def test_to_dict(self):
        ...
        expected_keys = ["lower", "upper", "confidence_level", "method", "width", "midpoint", "margin_of_error"]
...
class TestConfidenceIntervalClassMethods:
    ...
    def test_from_bounds(self):
        ...
        ci = ConfidenceInterval.from_bounds(0.2, 0.8, confidence_level=0.90, method="manual")
    ...
    def test_from_samples_numpy(self):
        ...
        ci = ConfidenceInterval.from_samples(samples, confidence_level=0.95, method="bootstrap")
