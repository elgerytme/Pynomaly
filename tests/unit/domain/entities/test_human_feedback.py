...
class TestHumanFeedback:
    ...
    def test_binary_classification_validation(self):
        ...
        with pytest.raises(ValueError, match="Binary classification feedback must be boolean"):
            HumanFeedback(
                feedback_id="fb_001",
                sample_id="sample_123",
                annotator_id="annotator_456",
    ...
    def test_confidence_rating_validation(self):
        ...
        with pytest.raises(ValueError, match="Confidence rating must be between 0 and 1"):
            HumanFeedback(
                feedback_id="fb_001",
                sample_id="sample_123",
                annotator_id="annotator_456",
    ...
    def test_score_correction_validation(self):
        ...
        # Invalid value out of range
        with pytest.raises(ValueError, match="Score correction must be between 0 and 1"):
            HumanFeedback(
                feedback_id="fb_001",
                sample_id="sample_123",
                annotator_id="annotator_456",
    ...
    def test_feature_importance_validation(self):
        ...
        with pytest.raises(ValueError, match="Feature importance dictionary cannot be empty"):
            HumanFeedback(
                feedback_id="fb_001",
                sample_id="sample_123",
                annotator_id="annotator_456",
