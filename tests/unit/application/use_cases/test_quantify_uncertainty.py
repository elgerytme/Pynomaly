...
from pynomaly.application.use_cases.quantify_uncertainty import QuantifyUncertaintyUseCase
...
from pynomaly.domain.services.uncertainty_service import UncertaintyQuantificationService
...
class TestQuantifyUncertaintyUseCase:
    ...
    def test_execute_uncertainty_request_bootstrap(self, use_case, mock_uncertainty_service, sample_detection_results):
        ...
        mock_uncertainty_metrics = {
            ...
            "confidence_interval_mean": ConfidenceInterval.from_bounds(0.4, 0.7, method="bootstrap_mean"),
            "confidence_interval_std": ConfidenceInterval.from_bounds(0.2, 0.4, method="bootstrap_std"),
            "entropy": 0.85
        }
        
        mock_uncertainty_service.calculate_prediction_uncertainty.return_value = mock_uncertainty_metrics
    ...
    def test_execute_uncertainty_request_normal(self, use_case, mock_uncertainty_service, sample_detection_results):
        ...
        mock_uncertainty_metrics = {
            ...
            "variance_score": 0.09,
            "coefficient_of_variation": 0.545,
            "confidence_interval_mean": ConfidenceInterval.from_bounds(0.4, 0.7, method="normal"),
            "entropy": 0.85
        }
        ...
        assert "mean" in response.confidence_intervals
        assert "std" not in response.confidence_intervals  # Not available for normal method
    
    def test_execute_uncertainty_request_bayesian(self, use_case, mock_uncertainty_service, sample_detection_results):
        ...
        mock_uncertainty_metrics = {
            ...
            "variance_score": 0.09,
            "coefficient_of_variation": 0.545,
            "confidence_interval_mean": ConfidenceInterval.from_bounds(0.3, 0.8, method="bayesian"),
            "entropy": 0.85
        }
    ...
    def test_execute_empty_detection_results(self, use_case):
        ...
        with pytest.raises(ValueError, match="Cannot quantify uncertainty without detection results"):
            use_case.execute(request)
    
    def test_execute_ensemble_uncertainty(self, use_case, mock_uncertainty_service, sample_ensemble_results):
        ...
        mock_ensemble_metrics = {
            ...
            "ensemble_confidence_interval": ConfidenceInterval.from_bounds(0.4, 0.7, method="ensemble")
        }
        
        mock_model_uncertainty = {
            "mean_score": 0.5,
            "std_score": 0.2,
            "confidence_interval_mean": ConfidenceInterval.from_bounds(0.3, 0.7, method="bootstrap")
        }
        
        mock_uncertainty_service.calculate_ensemble_uncertainty.return_value = mock_ensemble_metrics
        mock_uncertainty_service.calculate_prediction_uncertainty.return_value = mock_model_uncertainty
    ...
    def test_execute_ensemble_uncertainty_empty_results(self, use_case):
        ...
        with pytest.raises(ValueError, match="Cannot quantify ensemble uncertainty without results"):
    ...
    def test_calculate_bayesian_interval(self, use_case, mock_uncertainty_service):
        ...
        mock_uncertainty_service.calculate_bayesian_confidence_interval.return_value = expected_ci
    ...
    def test_calculate_prediction_interval(self, use_case, mock_uncertainty_service):
        ...
        expected_ci = ConfidenceInterval.from_bounds(-0.1, 0.9, method="prediction_interval")
        
        mock_uncertainty_service._calculate_prediction_interval.return_value = expected_ci
    ...
    def test_calculate_confidence_intervals_bootstrap(self, use_case, mock_uncertainty_service, sample_detection_results):
    ...
    def test_calculate_confidence_intervals_normal(self, use_case, mock_uncertainty_service, sample_detection_results):
        """Test _calculate_confidence_intervals method with normal."""
        mock_ci_mean = ConfidenceInterval.from_bounds(0.4, 0.6, method="normal")
        
        mock_uncertainty_service.calculate_normal_confidence_interval.return_value = mock_ci_mean
    ...
    def test_calculate_additional_metrics(self, use_case, mock_uncertainty_service, sample_detection_results):
        """Test _calculate_additional_metrics method."""
        mock_prediction_interval = ConfidenceInterval.from_bounds(0.0, 1.0, method="prediction_interval")
        mock_uncertainty_service._calculate_prediction_interval.return_value = mock_prediction_interval
    ...
    def test_calculate_ensemble_disagreement(self, use_case, sample_ensemble_results):
        ...
        disagreement_metrics = use_case._calculate_ensemble_disagreement(ensemble_results)
    ...
    def test_uncertainty_response_to_dict(self, sample_detection_results):
        ...
        uncertainty_metrics = {
            "mean_score": 0.5,
            "std_score": 0.3,
            "confidence_interval_mean": ConfidenceInterval.from_bounds(0.4, 0.6, method="bootstrap")
        }
        ...
        assert isinstance(result_dict["uncertainty_metrics"]["confidence_interval_mean"], dict)
