...
class TestDataLoaderProtocol:
    ...
    def test_protocol_runtime_checkable(self):
        ...
        class ConcreteLoader:
            def load(self, source: str | Path, name: str | None = None, **kwargs: Any) -> Dataset:
...
class TestBatchDataLoaderProtocol:
    ...
    def test_protocol_runtime_checkable(self):
        ...
        class ConcreteBatchLoader:
            ...
            def load_batch(
                self, source: str | Path, batch_size: int, name: str | None = None, **kwargs: Any
            ) -> Iterator[Dataset]:
...
class TestDatabaseLoaderProtocol:
    ...
    def test_load_query_method_signature(self):
        ...
        result = mock_loader.load_query("SELECT * FROM table", "connection", name="test")
        assert result == mock_dataset
    ...
    def test_load_table_method_signature(self):
        ...
        result = mock_loader.load_table("table_name", "connection", schema="public", name="test")
        assert result == mock_dataset
    ...
    def test_protocol_runtime_checkable(self):
        ...
        class ConcreteDatabaseLoader:
            ...
            def load_query(
                self, query: str, connection: str | Any, name: str | None = None, **kwargs: Any
            ) -> Dataset:
                return Mock(spec=Dataset)
...
class TestProtocolInteractions:
    ...
    def test_protocol_with_kwargs(self):
        ...
        mock_loader.load.assert_called_with("test.csv", name="test", delimiter=",", header=True)
