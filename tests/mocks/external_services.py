...
class MockDatabaseClient:
    ...
    def execute(self, query: str, params: Optional[Dict[str, Any]] = None) -> MagicMock:
...
class MockPrometheusClient:
    ...
    def get_histogram_buckets(self, name: str, labels: Optional[Dict[str, str]] = None) -> List[float]:
