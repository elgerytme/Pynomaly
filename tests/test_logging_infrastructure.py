...
class TestStructuredLogger:
    ...
    def test_performance_logging(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            from pynomaly.infrastructure.logging.structured_logger import PerformanceLogger
...
class TestLogAggregator:
    ...
    def test_log_stream_creation(self):
        ...
        error_stream = aggregator.create_stream(
            "errors",
            LogStreamType.REALTIME,
            LogFilter(levels=["ERROR", "CRITICAL"])
        )
...
class TestLogAnalyzer:
    ...
    def test_pattern_detection(self):
        ...
        error_entries = [
            LogEntry(level="ERROR", message=f"Database error {i}", logger_name="db.connector")
            for i in range(15)
        ]
        ...
        error_spike_patterns = [p for p in patterns if p.pattern_type == PatternType.ERROR_SPIKE]
    ...
    def test_custom_pattern_rules(self):
        ...
        custom_rule = PatternRule(
            ...
            conditions={
                "message_pattern": r"authentication.*failed",
                "min_count": 3
            },
    ...
    def test_statistical_anomaly_detection(self):
        ...
        for i in range(20):
            ...
            batch_size = 10 + (i % 5) - 2
            batch = [
                LogEntry(level="INFO", message=f"Normal message {j}", logger_name="app.service")
        ...
        anomalous_batch = [
            LogEntry(level="INFO", message=f"Spike message {j}", logger_name="app.service")
...
class TestTracingManager:
    ...
    def test_trace_context_injection(self):
        ...
        child_span = tracer.start_span("child-operation", parent_context=extracted_context)
...
class TestIntegration:
    ...
    def test_end_to_end_workflow(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            service.log("info", "User request started", user_id="test-user", endpoint="/api/detect")
