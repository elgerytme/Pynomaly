...
class TestDataGenerator:
    ...
    def generate_mixed_type_dataset(
        ...
        normal_categories = np.random.choice(['A', 'B', 'C'], n_normal, p=[0.5, 0.3, 0.2])
        anomaly_categories = np.random.choice(['A', 'B', 'C', 'D'], n_anomalies, p=[0.1, 0.1, 0.2, 0.6])
