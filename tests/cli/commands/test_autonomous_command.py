...
class TestAutonomousCommand:
    ...
    def test_autonomous_detect_help(self):
        ...
        assert "automatic" in result.stdout.lower() or "autonomous" in result.stdout.lower()
    ...
    def test_autonomous_profile_help(self):
        ...
        assert "analysis" in result.stdout.lower() or "profiling" in result.stdout.lower()
    ...
    def test_autonomous_detect_basic(self, mock_dataset_service, mock_autonomous_service):
    ...
    @patch('pynomaly.presentation.cli.commands.autonomous.autonomous_service')
    @patch('pynomaly.presentation.cli.commands.autonomous.dataset_service')
    def test_autonomous_detect_with_config(self, mock_dataset_service, mock_autonomous_service):
    ...
    @patch('pynomaly.presentation.cli.commands.autonomous.autonomous_service')
    @patch('pynomaly.presentation.cli.commands.autonomous.dataset_service')
    def test_autonomous_detect_with_output_dir(self, mock_dataset_service, mock_autonomous_service):
    ...
    @patch('pynomaly.presentation.cli.commands.autonomous.autonomous_service')
    @patch('pynomaly.presentation.cli.commands.autonomous.dataset_service')
    def test_autonomous_detect_with_algorithm_strategy(self, mock_dataset_service, mock_autonomous_service):
    ...
    @patch('pynomaly.presentation.cli.commands.autonomous.autonomous_service')
    @patch('pynomaly.presentation.cli.commands.autonomous.dataset_service')
    def test_autonomous_profile_basic(self, mock_dataset_service, mock_autonomous_service):
    ...
    @patch('pynomaly.presentation.cli.commands.autonomous.autonomous_service')
    @patch('pynomaly.presentation.cli.commands.autonomous.dataset_service')
    def test_autonomous_profile_with_detailed_analysis(self, mock_dataset_service, mock_autonomous_service):
        ...
        mock_profile = {
            ...
            "detailed_analysis": {
                "correlation_matrix": [[1.0, 0.8, 0.6], [0.8, 1.0, 0.7], [0.6, 0.7, 1.0]],
    ...
    @patch('pynomaly.presentation.cli.commands.autonomous.autonomous_service')
    @patch('pynomaly.presentation.cli.commands.autonomous.dataset_service')
    def test_autonomous_profile_with_visualizations(self, mock_dataset_service, mock_autonomous_service):
        ...
        mock_profile = {
            "dataset_info": {"samples": 5, "features": 3},
            "visualizations": {
                "generated_plots": ["distribution.png", "correlation.png", "outliers.png"],
    ...
    @patch('pynomaly.presentation.cli.commands.autonomous.autonomous_service')
    @patch('pynomaly.presentation.cli.commands.autonomous.dataset_service')
    def test_autonomous_quick_basic(self, mock_dataset_service, mock_autonomous_service):
    ...
    @patch('pynomaly.presentation.cli.commands.autonomous.autonomous_service')
    @patch('pynomaly.presentation.cli.commands.autonomous.dataset_service')
    def test_autonomous_quick_with_threshold(self, mock_dataset_service, mock_autonomous_service):
    ...
    def test_autonomous_detect_invalid_algorithm_strategy(self):
        ...
        result = self.runner.invoke(app, [
            "auto", "detect",
            "--dataset", str(self.test_data_file),
            "--algorithm-strategy", "invalid_strategy"
        ])
    ...
    @patch('pynomaly.presentation.cli.commands.autonomous.autonomous_service')
    @patch('pynomaly.presentation.cli.commands.autonomous.dataset_service')
    def test_autonomous_detect_large_dataset(self, mock_dataset_service, mock_autonomous_service):
        ...
        result = self.runner.invoke(app, [
            "auto", "detect",
            "--dataset", str(self.large_dataset_file)
        ])
    ...
    @patch('pynomaly.presentation.cli.commands.autonomous.autonomous_service')
    @patch('pynomaly.presentation.cli.commands.autonomous.dataset_service')
    def test_autonomous_detect_with_timeout(self, mock_dataset_service, mock_autonomous_service):
    ...
    @patch('pynomaly.presentation.cli.commands.autonomous.autonomous_service')
    @patch('pynomaly.presentation.cli.commands.autonomous.dataset_service')
    def test_autonomous_profile_then_detect(self, mock_dataset_service, mock_autonomous_service):
        ...
        # Profile first
        profile_result = self.runner.invoke(app, [
            "auto", "profile",
            "--dataset", str(self.test_data_file)
        ])
    ...
    @patch('pynomaly.presentation.cli.commands.autonomous.autonomous_service')
    @patch('pynomaly.presentation.cli.commands.autonomous.dataset_service')
    def test_autonomous_detect_json_output(self, mock_dataset_service, mock_autonomous_service):
    ...
    @patch('pynomaly.presentation.cli.commands.autonomous.autonomous_service')
    @patch('pynomaly.presentation.cli.commands.autonomous.dataset_service')
    def test_autonomous_profile_html_report(self, mock_dataset_service, mock_autonomous_service):
    ...
    @patch('pynomaly.presentation.cli.commands.autonomous.autonomous_service')
    @patch('pynomaly.presentation.cli.commands.autonomous.dataset_service')
    def test_autonomous_detect_custom_preprocessing(self, mock_dataset_service, mock_autonomous_service):
    ...
    @patch('pynomaly.presentation.cli.commands.autonomous.autonomous_service')
    @patch('pynomaly.presentation.cli.commands.autonomous.dataset_service')
    def test_autonomous_detect_ensemble_mode(self, mock_dataset_service, mock_autonomous_service):
    ...
    def test_autonomous_detect_single_feature(self):
        ...
        result = self.runner.invoke(app, [
            "auto", "detect",
            "--dataset", str(single_feature_file)
        ])
    ...
    def test_autonomous_detect_with_missing_values(self):
        ...
        missing_values_file.write_text("feature1,feature2\n1.0,2.0\n,3.0\n3.0,\n4.0,5.0\n")
        
        result = self.runner.invoke(app, [
            "auto", "detect",
            "--dataset", str(missing_values_file)
        ])
    ...
    @patch('pynomaly.presentation.cli.commands.autonomous.autonomous_service')
    @patch('pynomaly.presentation.cli.commands.autonomous.dataset_service')
    def test_autonomous_detect_memory_limit(self, mock_dataset_service, mock_autonomous_service):
    ...
    @patch('pynomaly.presentation.cli.commands.autonomous.autonomous_service')
    @patch('pynomaly.presentation.cli.commands.autonomous.dataset_service')  
    def test_autonomous_detect_parallel_processing(self, mock_dataset_service, mock_autonomous_service):
