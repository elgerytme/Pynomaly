...
class TestConfigCommands:
    ...
    def sample_config_data(self):
        ...
        return {
            ...
            "contamination": 0.1,
            "random_state": 42,
            "hyperparameters": {"n_estimators": 100, "max_features": 1.0},
        }
    ...
    def test_capture_configuration_validation_issues(
        ...
        with patch("asyncio.run", return_value=mock_response):
            ...
            result = runner.invoke(app, ["capture", "automl", "--params", params_file])
    ...
    def test_capture_configuration_params_file_not_found(self, runner):
        ...
        result = runner.invoke(
            app, ["capture", "automl", "--params", "/nonexistent/params.json"]
        )
    ...
    def test_export_configurations_invalid_uuid(self, runner):
        ...
        result = runner.invoke(
            app, ["export", "invalid-uuid", "--output", "/tmp/export.json"]
        )
    ...
    def test_export_configurations_failure(self, mock_service_class, runner):
        ...
        with patch("asyncio.run", return_value=mock_response):
            ...
            result = runner.invoke(
                app, ["export", config_id, "--output", "/tmp/export.json"]
            )
    ...
    def test_import_configurations_success(self, mock_repo_class, runner):
        ...
        with patch("asyncio.run", return_value=3):
            with tempfile.NamedTemporaryFile(
                ...
                import_data = {
                    "configurations": [
                        ...
                        {
                            "name": "config2",
                            "algorithm_config": {"algorithm_name": "LOF"},
                        },
                        {
                            "name": "config3",
                            "algorithm_config": {"algorithm_name": "OneClassSVM"},
                        },
                    ]
                }
            ...
            result = runner.invoke(
                app, ["import", import_file, "--storage", "/tmp/configs"]
            )
    ...
    def test_import_configurations_dry_run(self, mock_repo_class, runner):
        ...
        result = runner.invoke(app, ["import", import_file, "--dry-run"])
    ...
    def test_list_configurations_success(
        ...
        with patch("asyncio.run", return_value=[sample_configuration]):
            result = runner.invoke(
                app, ["list", "--storage", "/tmp/configs", "--limit", "10"]
            )
    ...
    def test_show_configuration_success(
        ...
        with patch("asyncio.run", return_value=sample_configuration):
            ...
            result = runner.invoke(
                app, ["show", config_id, "--performance", "--lineage"]
            )
    ...
    def test_show_configuration_json_format(
        ...
        with patch("asyncio.run", return_value=sample_configuration):
            ...
            result = runner.invoke(app, ["show", config_id, "--format", "json"])
    ...
    def test_show_configuration_yaml_format(
        ...
        with patch("asyncio.run", return_value=sample_configuration):
            ...
            with patch("yaml.dump", return_value="name: test_config\n"):
                result = runner.invoke(app, ["show", config_id, "--format", "yaml"])
    ...
    def test_show_configuration_invalid_uuid(self, runner):
        ...
        result = runner.invoke(app, ["show", "invalid-uuid"])
...
class TestConfigCommandsErrorHandling:
    ...
    def test_import_configuration_exception(self, mock_repo_class, runner):
        ...
        result = runner.invoke(app, ["import", import_file])
