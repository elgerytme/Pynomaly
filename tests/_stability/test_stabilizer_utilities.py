...
class TestTimingManager:
    ...
    def test_wait_for_condition_success(self):
        ...
        start_time = time.time()
        result = manager.wait_for_condition(condition, timeout=1.0, polling_interval=0.05)
    ...
    def test_wait_for_condition_timeout(self):
        ...
        start_time = time.time()
        result = manager.wait_for_condition(condition, timeout=0.2, polling_interval=0.05)
        elapsed = time.time() - start_time
...
class TestStabilityIntegration:
    ...
    def test_full_stabilization_integration(self):
        ...
        with stabilizer.stabilized_test("integration_test"):
            ...
            assert test_obj in stabilizer.resource_manager.active_resources["temp_objects"]
