...
from pynomaly.infrastructure.auth.rbac import RoleBasedAccessControl, Role, Permission
...
class TestRoleBasedAccessControl:
    ...
    def test_users(self):
        ...
        return {
            ...
            "admin": {
                ...
                "role": "admin",
                "permissions": ["read:datasets", "write:datasets", "delete:datasets", "admin:users", "admin:system"]
            }
        }
    ...
    def test_rbac_role_hierarchy(self, rbac_system):
        ...
        assert rbac_system.check_permission(admin_user, "read:datasets")  # viewer permission
    ...
    def test_security_policy_enforcement(self):
        ...
        assert not acm.validate_password_policy(weak_password, security_policy["password_policy"])
        assert acm.validate_password_policy(strong_password, security_policy["password_policy"])
