...
from pynomaly.infrastructure.auth.jwt_auth import JWTAuthService, UserModel, TokenPayload, TokenResponse
...
class TestJWTAuthServiceSecurity:
    ...
    def test_jwt_timing_attack_resistance(self, auth_service):
        ...
        valid_token = auth_service.create_access_token(UserModel(
            id="user1", username="user1", email="test@example.com", hashed_password="hash"
        )).access_token
    ...
    def test_jwt_algorithm_confusion_prevention(self, auth_service, sample_user):
        ...
        token_response = auth_service.create_access_token(sample_user)
        payload_data = auth_service.decode_token(token_response.access_token).model_dump()
...
class TestMiddlewareSecurity:
    ...
    def test_permission_checker_authorization_bypass(self):
        ...
        # Mock auth service
        auth_service = Mock()
        auth_service.require_permissions.side_effect = AuthorizationError("Insufficient permissions")
    ...
    def test_bearer_token_extraction_security(self):
        ...
        for headers in malicious_headers:
            ...
            # Mock auth service
            auth_service = Mock()
            auth_service.get_current_user.side_effect = AuthenticationError("Invalid token")
...
class TestSecurityIntegration:
    ...
    def test_security_edge_cases(self, mock_settings):
        ...
        for username, email in edge_cases:
            ...
            authenticated = auth_service.authenticate_user(email, "EdgeCasePassword123!")
