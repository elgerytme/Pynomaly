...
from src.pynomaly.infrastructure.monitoring.production_monitor import (
    ProductionMonitor, LogLevel, ErrorReport, AuditEvent, 
    get_monitor, init_monitor, log_info
)
from src.pynomaly.infrastructure.monitoring.health_service import HealthStatus
from src.pynomaly.infrastructure.monitoring.performance_monitor import PerformanceMetrics
...
class TestProductionMonitor:
    ...
    def test_error_reporting(self):
        ...
        try:
            ...
            error_id = monitor.report_error(
                ...
                context={"data": "test"}, severity="high"
            )
    ...
    def test_operation_monitoring(self):
        ...
        with monitor.monitor_operation("test_operation", "test_component") as request_id:
            assert request_id
    ...
    def test_operation_monitoring_with_error(self):
        ...
        assert len(monitor.error_reports) == 1
        error_log = [log for log in monitor.log_entries if log.level == LogLevel.ERROR][0]
    ...
    async def test_async_operation_monitoring(self):
        ...
        async with monitor.monitor_async_operation("async_test", "test_component") as request_id:
            assert request_id
    ...
    async def test_health_check_integration(self):
        ...
        with patch.object(monitor.health_service, 'perform_comprehensive_health_check', 
