    ...
    def test_dependency_scanning(self, security_gate):
        ...
        dependency_scan = {
            "outdated_dependencies": [
                {"name": "numpy", "current": "1.20.0", "latest": "1.24.0", "severity": "medium"},
                {"name": "pandas", "current": "1.3.0", "latest": "2.0.0", "severity": "high"}
            ],
            "vulnerable_dependencies": [
                {"name": "pillow", "version": "8.0.0", "vulnerabilities": ["CVE-2023-98765"]}
            ],
            "license_issues": []
        }
        ...
        complexity_metrics = {
            "cyclomatic_complexity": {
                ...
                "functions_over_threshold": [
                    {"name": "complex_function", "complexity": 12, "file": "src/module.py"}
                ]
            },
...
class TestCICDIntegration:
            ...
            "jobs": {
                "quality-gates": {
                    ...
                    "steps": [
                        ...
                        {"name": "Run Performance Gate", "run": "python -m pytest tests/performance/"}
                    ]
                }
            }
        }
    ...
    def test_quality_metrics_reporting(self):
        ...
        scores = [
            ...
            min(quality_metrics["performance"]["avg_response_time_ms"] / 10, 100),  # Normalized
