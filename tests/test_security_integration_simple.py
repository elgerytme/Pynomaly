...
class TestSecurityIntegrationSimple:
    ...
    def test_security_exceptions_are_importable(self):
        ...
        authz_error = AuthorizationError("Access denied", user_id="123", required_permission="read")
    ...
    def test_encryption_services_available(self):
        ...
        try:
            from pynomaly.infrastructure.security import EncryptionService, EncryptionConfig
