...
class TestBoundaryConditions:
    ...
    def test_string_boundary_conditions(self):
        ...
        whitespace_string = "   \t\n  "
        whitespace_result = validator.validate_string(whitespace_string, strip_whitespace=True)
        assert not whitespace_result.is_valid
        
        # Test string with special characters
        special_chars = "!@#$%^&*()[]{}|\\:;\"'<>,.?/~`"
        special_result = validator.validate_string(special_chars, allow_special_chars=False)
...
class TestDataTypeEdgeCases:
    ...
    def test_mixed_data_types(self):
        ...
        mixed_data = pd.DataFrame({
            ...
            'mixed_string_numeric': ['1', '2.5', 'abc', '4', '5'],  # Mixed string/numeric-like
    ...
    def test_categorical_edge_cases(self):
        ...
        from pynomaly.infrastructure.data.categorical_processor import CategoricalProcessor
...
class TestMemoryAndPerformanceEdges:
    ...
    def test_memory_efficient_operations(self):
        ...
        from pynomaly.infrastructure.data.memory_efficient import MemoryEfficientProcessor
    ...
    def test_streaming_data_edge_cases(self):
        ...
        try:
            schema_result = processor.process_stream_with_schema_evolution(schema_stream)
...
class TestStatisticalEdgeCases:
    ...
    def test_distribution_edge_cases(self):
        ...
        from pynomaly.infrastructure.statistics.distributions import DistributionAnalyzer
    ...
    def test_time_series_edge_cases(self):
        ...
        assert abs(seasonal_analysis['period'] - 365) < 10  # Should detect ~365 day cycle
        ...
        irregular_analysis = analyzer.analyze_frequency(irregular_dates, irregular_values)
