...
class TestSemanticVersion:
    ...
    def test_semantic_version_validation(self):
        ...
        valid_versions = [
            ...
            "1.0.0-alpha", "1.0.0-beta.1", "1.0.0-rc.1+build.1"
        ]
...
class TestPerformanceMetrics:
    ...
    def test_performance_metrics_aggregation(self):
        ...
        metrics_list = [
            PerformanceMetrics(accuracy=0.90, precision=0.85, recall=0.88, f1_score=0.86),
            PerformanceMetrics(accuracy=0.92, precision=0.87, recall=0.90, f1_score=0.88),
            PerformanceMetrics(accuracy=0.88, precision=0.83, recall=0.86, f1_score=0.84)
        ]
        ...
        with pytest.raises(InvalidValueError):
            ThresholdConfig(
                ...
                ensemble_methods=[
                    ...
                    {"method": "statistical", "method_type": "zscore", "weight": 0.6}  # Total > 1
                ]
            )
