...
class TestDetectorTraining:
    ...
    def test_train_with_valid_dataset_returns_training_result(self):
        ...
        mock_adapter.score.return_value = [0.1, 0.2, 0.15, 0.18, 0.12, 0.9]  # High score for outlier
...
class TestDetectorDetection:
    ...
    def test_detect_with_fitted_detector_returns_detection_result(self):
        ...
        mock_adapter.score.return_value = [0.1, 0.15, 0.12, 0.95]  # High score for outlier
    ...
    def test_detect_with_unfitted_detector_raises_error(self):
        ...
        # Act & Assert
        with pytest.raises(ValueError, match="Detector must be fitted before detection"):
