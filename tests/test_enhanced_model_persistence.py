...
from pynomaly.domain.entities.model_version import ModelVersion, ModelStatus
...
class MockDetector(Detector):
    ...
    def __init__(self, name: str = "test_detector", algorithm: str = "test_algo", fitted: bool = True):
        super().__init__(
            name=name,
...
class TestEnhancedModelPersistenceService:
    ...
    @pytest.mark.asyncio
    async def test_serialize_model_pickle_format(self, persistence_service, mock_detector, sample_performance_metrics):
    ...
    @pytest.mark.asyncio
    async def test_serialize_model_joblib_format(self, persistence_service, mock_detector, sample_performance_metrics):
    ...
    async def test_serialize_unfitted_detector_raises_error(self, persistence_service):
        ...
        with pytest.raises(ModelSerializationError, match="is not fitted"):
            await persistence_service.serialize_model(
                detector=unfitted_detector,
                version=version
            )
    
    @pytest.mark.asyncio
    async def test_serialize_with_compression(self, persistence_service, mock_detector, sample_performance_metrics):
    ...
    @pytest.mark.asyncio
    async def test_deserialize_model(self, persistence_service, mock_detector, sample_performance_metrics):
        ...
        # Then deserialize
        deserialized_detector = await persistence_service.deserialize_model(model_version)
    ...
    @pytest.mark.asyncio
    async def test_deserialize_with_compression(self, persistence_service, mock_detector, sample_performance_metrics):
    ...
    @pytest.mark.asyncio
    async def test_checksum_verification_success(self, persistence_service, mock_detector, sample_performance_metrics):
    ...
    @pytest.mark.asyncio
    async def test_list_model_versions(self, persistence_service, mock_detector, sample_performance_metrics):
    ...
    @pytest.mark.asyncio
    async def test_list_model_versions_with_filter(self, persistence_service, mock_detector, sample_performance_metrics):
    ...
    @pytest.mark.asyncio
    async def test_get_model_version(self, persistence_service, mock_detector, sample_performance_metrics):
    ...
    @pytest.mark.asyncio
    async def test_get_latest_version(self, persistence_service, mock_detector, sample_performance_metrics):
    ...
    async def test_compare_versions(self, persistence_service, mock_detector):
        ...
        metrics1 = PerformanceMetrics(
            ...
            training_time=100.0, inference_time=5.0, model_size=1024
        )
        
        metrics2 = PerformanceMetrics(
            accuracy=0.95, precision=0.90, recall=0.88, f1_score=0.89,
            training_time=120.0, inference_time=4.0, model_size=2048
        )
    ...
    @pytest.mark.asyncio
    async def test_delete_model_version(self, persistence_service, mock_detector, sample_performance_metrics):
    ...
    @pytest.mark.asyncio
    async def test_delete_deployed_version_without_force_fails(self, persistence_service, mock_detector, sample_performance_metrics):
    ...
    @pytest.mark.asyncio
    async def test_export_model_bundle(self, persistence_service, mock_detector, sample_performance_metrics, temp_storage_path):
        ...
        expected_files = ["model", "config", "metadata", "requirements", "examples", "deploy_script"]
    ...
    @pytest.mark.asyncio
    async def test_create_model_archive(self, persistence_service, mock_detector, sample_performance_metrics, temp_storage_path):
        ...
        with zipfile.ZipFile(archive_path, "r") as zf:
            ...
            expected_files = [
                "model_config.json", "metadata.json", 
                "requirements.txt", "example_usage.py", "deploy.py"
            ]
    ...
    @pytest.mark.asyncio
    async def test_unsupported_format_raises_error(self, persistence_service, mock_detector):
