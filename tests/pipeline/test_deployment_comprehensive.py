...
class TestDeploymentPipeline:
    ...
    def mock_deployment_environment(self):
        ...
        class MockDeploymentEnvironment:
            ...
            def provision_infrastructure(self, environment: str, config: Dict[str, Any]) -> Dict[str, Any]:
                ...
                provisioning_result = {
                    ...
                    "resources": {
                        ...
                        "cluster_nodes": [f"node-{i}" for i in range(infrastructure_config["compute"]["replicas"])],
                        "database_endpoint": "db.internal.com:5432" if infrastructure_config["storage"]["database"] else None
                    }
                }
                ...
                self._log_deployment_event(f"Infrastructure provisioned for {environment}", {
                    "infrastructure_id": infrastructure_id,
                    "environment": environment
                })
            ...
            def deploy_application(self, environment: str, artifacts: List[str], 
                ...
                deployment_result = {
                    ...
                    "endpoints": infrastructure["endpoints"] if deployment_success else {},
                ...
                self.rollback_history[environment] = self.rollback_history[environment][-10:]
            ...
            def _simulate_deployment_step(self, step_name: str, environment: str, base_duration: float) -> Dict[str, Any]:
                ...
                actual_duration = base_duration * (0.8 + 0.4 * 0.5)  # 80-120% of base duration
            ...
            def setup_monitoring(self, deployment_id: str, monitoring_config: Dict[str, Any]) -> Dict[str, Any]:
                ...
                monitoring_setup = {
                    ...
                    "metrics": {
                        ...
                        "scrape_interval": monitoring_config.get("scrape_interval", "30s"),
                    ...
                    "alerting": {
                        ...
                        "channels": monitoring_config.get("alert_channels", ["email", "slack"]),
                ...
                self._log_deployment_event(f"Monitoring setup for deployment {deployment_id}", {
                    "deployment_id": deployment_id,
                    "environment": environment
                })
            ...
            def _create_default_alert_rules(self, environment: str) -> List[Dict[str, Any]]:
                """Create default alert rules for environment."""
                # Environment-specific alert thresholds
                thresholds = {
                    "development": {"error_rate": 0.10, "response_time": 2000, "cpu": 80, "memory": 85},
                    "staging": {"error_rate": 0.05, "response_time": 1000, "cpu": 70, "memory": 80},
                    "production": {"error_rate": 0.02, "response_time": 500, "cpu": 60, "memory": 75}
                }
            ...
            def validate_deployment(self, deployment_id: str) -> Dict[str, Any]:
                ...
                validation_checks = {
                    "endpoint_health": self._check_endpoint_health(deployment["endpoints"]),
                    "service_availability": self._check_service_availability(deployment),
                    "database_connectivity": self._check_database_connectivity(deployment),
                    "external_dependencies": self._check_external_dependencies(deployment),
                    "performance_baseline": self._check_performance_baseline(deployment),
                    "security_configuration": self._check_security_configuration(deployment)
                }
                
                all_checks_passed = all(check["passed"] for check in validation_checks.values())
            ...
            def _check_endpoint_health(self, endpoints: Dict[str, str]) -> Dict[str, Any]:
            ...
            def _check_service_availability(self, deployment: Dict[str, Any]) -> Dict[str, Any]:
                """Check service availability."""
                # Mock service availability check
                expected_replicas = deployment.get("config", {}).get("replicas", 2)
                available_replicas = expected_replicas  # Assume all replicas are available
            ...
            def _check_database_connectivity(self, deployment: Dict[str, Any]) -> Dict[str, Any]:
                ...
                return {
                    ...
                    "message": "Database connection successful" if connection_successful else "Database connection failed"
                }
            
            def _check_external_dependencies(self, deployment: Dict[str, Any]) -> Dict[str, Any]:
                """Check external dependencies."""
                # Mock external dependency checks
                dependencies = deployment.get("config", {}).get("external_dependencies", [])
                ...
                all_available = all(result["available"] for result in dependency_results.values())
                
                return {
                    "passed": all_available,
                    "dependencies": dependency_results,
                    "message": "All dependencies available" if all_available else "Some dependencies unavailable"
                }
            
            def _check_performance_baseline(self, deployment: Dict[str, Any]) -> Dict[str, Any]:
                ...
                performance_passed = (
                    current_metrics["response_time_p95"] <= baseline_metrics["response_time_p95"] and
                    current_metrics["throughput_rps"] >= baseline_metrics["throughput_rps"] and
                    current_metrics["error_rate"] <= baseline_metrics["error_rate"] and
                    current_metrics["cpu_usage"] <= baseline_metrics["cpu_usage"] and
                ...
                return {
                    ...
                    "message": "Performance within baseline" if performance_passed else "Performance below baseline"
                }
            
            def _check_security_configuration(self, deployment: Dict[str, Any]) -> Dict[str, Any]:
                ...
                return {
                    ...
                    "message": "Security configuration valid" if all_secure else "Security issues found"
                }
            
            def rollback_deployment(self, environment: str, target_version: str = None) -> Dict[str, Any]:
                ...
                if len(successful_deployments) < 2:
                    return {"error": "No previous successful deployment found", "success": False}
                
                # Find target deployment
                if target_version:
                    target_deployment = next(
                        (d for d in reversed(successful_deployments) if d["version"] == target_version),
                        None
                    )
                else:
                    # Get previous successful deployment
                    target_deployment = successful_deployments[-2] if len(successful_deployments) >= 2 else None
                
                if not target_deployment:
                    return {"error": f"Target version {target_version} not found", "success": False}
                ...
                self._log_deployment_event(f"Rollback completed for {environment}", {
                    "rollback_id": rollback_id,
                    "environment": environment,
                    "target_version": target_deployment["version"]
                })
            ...
            def _log_deployment_event(self, message: str, context: Dict[str, Any] = None):
            ...
            def get_deployment_logs(self, environment: str = None, limit: int = 50) -> List[Dict[str, Any]]:
                """Get deployment logs."""
                logs = self.deployment_logs
                
                if environment:
                    logs = [log for log in logs if log.get("context", {}).get("environment") == environment]
    ...
    def test_infrastructure_provisioning(self, mock_deployment_environment):
        ...
        for environment in environments:
            ...
            provisioning_result = deploy_env.provision_infrastructure(environment, config)
            ...
            assert infra_config["networking"]["load_balancer"] == config["load_balancer"]
    ...
    def test_application_deployment(self, mock_deployment_environment):
        ...
        provisioning_result = deploy_env.provision_infrastructure(environment, infra_config)
        assert provisioning_result["status"] == "provisioned"
        
        # Deploy application
        artifacts = [
            "pynomaly-1.0.0-py3-none-any.whl",
            "pynomaly-1.0.0.tar.gz"
        ]
        ...
        deployment_result = deploy_env.deploy_application(environment, artifacts, app_config)
    ...
    def test_deployment_monitoring_setup(self, mock_deployment_environment):
        ...
        infra_result = deploy_env.provision_infrastructure(environment, {
            "replicas": 3, "load_balancer": True, "ssl": True
        })
        ...
        monitoring_result = deploy_env.setup_monitoring(deployment_id, monitoring_config)
        ...
        expected_alerts = ["high_error_rate", "high_response_time", "high_cpu_usage", "high_memory_usage", "service_down"]
        ...
        error_rate_rule = next(rule for rule in alert_rules if rule["name"] == "high_error_rate")
        ...
        assert dashboards_config["custom_dashboards"] == ["business_metrics", "sla_dashboard"]
    ...
    def test_deployment_rollback(self, mock_deployment_environment):
        ...
        specific_rollback = deploy_env.rollback_deployment(environment, target_version="1.0.0")
        ...
        rollback_bad_version = deploy_env.rollback_deployment(environment, target_version="999.0.0")
    ...
    def test_multi_environment_deployment_workflow(self, mock_deployment_environment):
        ...
        for environment in environments:
            ...
            if environment == "development":
                ...
                config = {"replicas": 3, "resources": "high", "database": True, "monitoring": "full"}
            ...
            # Validate deployment
            validation_result = deploy_env.validate_deployment(deployment_result["deployment_id"])
            assert validation_result["valid"]
