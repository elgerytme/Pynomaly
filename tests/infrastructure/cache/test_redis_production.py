...
class TestProductionRedisCache:
    ...
    def production_cache(self, mock_settings, mock_redis):
        ...
        with patch('pynomaly.infrastructure.cache.redis_production.redis.Redis', return_value=mock_redis):
    ...
    async def test_cache_initialization(self, mock_settings):
        ...
        with patch('pynomaly.infrastructure.cache.redis_production.redis.Redis') as mock_redis_class:
    ...
    async def test_sentinel_initialization(self, mock_settings):
        ...
        with patch('pynomaly.infrastructure.cache.redis_production.redis.sentinel.Sentinel') as mock_sentinel_class:
    ...
    async def test_tag_invalidation(self, production_cache, mock_redis):
        ...
        mock_redis.pipeline.return_value.__enter__.return_value.execute.return_value = [1, 1, 1, 1]
    ...
    async def test_circuit_breaker_timeout(self, production_cache):
        ...
        production_cache.circuit_breaker_last_failure = datetime.utcnow() - timedelta(seconds=120)
    ...
    async def test_cache_warming(self, production_cache, mock_redis):
        ...
        mock_redis.pipeline.return_value.__enter__.return_value.execute.return_value = [True, True, True]
