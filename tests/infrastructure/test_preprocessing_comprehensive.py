...
class TestDataCleaner:
    ...
    def test_handle_missing_values_drop_rows(self, data_cleaner, sample_dataset_with_missing):
    ...
    def test_handle_missing_values_drop_columns(self, data_cleaner, sample_dataset_with_missing):
    ...
    def test_handle_missing_values_fill_mean(self, data_cleaner, sample_dataset_with_missing):
    ...
    def test_handle_missing_values_fill_median(self, data_cleaner, sample_dataset_with_missing):
    ...
    def test_handle_missing_values_fill_constant(self, data_cleaner, sample_dataset_with_missing):
    ...
    def test_handle_missing_values_knn_impute(self, data_cleaner, sample_dataset_with_missing):
    ...
    def test_handle_missing_values_specific_columns(self, data_cleaner, sample_dataset_with_missing):
    ...
    def test_detect_outliers_iqr(self, data_cleaner, sample_dataset_with_outliers):
        ...
        extreme_values = sample_dataset_with_outliers.data.loc[outlier_indices, 'feature_1']
    ...
    def test_handle_outliers_remove(self, data_cleaner, sample_dataset_with_outliers):
        ...
        cleaned = data_cleaner.handle_outliers(
            sample_dataset_with_outliers,
            strategy=OutlierStrategy.REMOVE,
            method="iqr"
        )
    ...
    def test_handle_infinite_values(self, data_cleaner):
        ...
        cleaned = data_cleaner.handle_infinite_values(
            dataset,
            strategy="remove"
        )
    ...
    def test_comprehensive_cleaning(self, data_cleaner):
        ...
        data = pd.DataFrame({
            'feature_1': [1.0, np.nan, 3.0, 1.0, 100.0],  # Missing, duplicate, outlier
...
class TestDataTransformer:
    ...
    def test_scale_features_minmax(self, data_transformer, numeric_dataset):
        ...
        scaled = data_transformer.scale_features(
            numeric_dataset,
            strategy=ScalingStrategy.MINMAX,
            feature_range=(0, 1)
        )
    ...
    def test_encode_categorical_onehot(self, data_transformer, categorical_dataset):
        ...
        category_1_cols = [col for col in encoded.data.columns if col.startswith('category_1_')]
    ...
    def test_select_features_correlation(self, data_transformer, numeric_dataset):
        ...
        numeric_dataset.data['correlated_feature'] = numeric_dataset.data['feature_1'] * 1.01
        ...
        feature_cols = [col for col in selected.data.columns if col.startswith('feature') or col.startswith('correlated')]
        original_cols = [col for col in numeric_dataset.data.columns if col.startswith('feature') or col.startswith('correlated')]
    ...
    def test_convert_data_types_optimize(self, data_transformer):
        ...
        optimized = data_transformer.convert_data_types(
            dataset,
...
class TestPreprocessingPipeline:
    ...
    def test_pipeline_fit_transform_convenience(self, sample_dataset):
        ...
        pipeline = PreprocessingPipeline()
        pipeline.add_step("clean_missing", "handle_missing_values", {"strategy": "fill_mean"})
