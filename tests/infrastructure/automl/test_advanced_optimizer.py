...
@pytest.mark.skipif(
    not pytest.importorskip("optuna", minversion="3.0.0"),
...
class TestAdvancedHyperparameterOptimizer:
    ...
    def test_basic_optimization(self, basic_config, temp_storage, sample_parameter_space):
    ...
    def test_parameter_sampling(self, basic_config, temp_storage, sample_parameter_space):
        ...
        with patch('optuna.create_study') as mock_create_study:
            ...
            mock_trial.suggest_float.side_effect = [0.01, 0.2]  # learning_rate, dropout_rate
    ...
    def test_dataset_similarity_calculation(self, basic_config, temp_storage):
        ...
        similarity_identical = optimizer._calculate_dataset_similarity(profile1, profile1)
        ...
        similarity_different = optimizer._calculate_dataset_similarity(profile1, profile3)
...
class TestMultiObjectiveOptimization:
    ...
    def test_multi_objective_optimization(self, multi_objective_config, temp_storage, sample_parameter_space):
...
class TestMetaLearning:
    ...
    def test_warm_start_parameter_generation(self, meta_learning_config, temp_storage, sample_dataset_profile):
        ...
        if warm_start_params:
            assert len(warm_start_params) <= meta_learning_config.meta_learning.warm_start_trials
    ...
    def test_similar_datasets_identification(self, meta_learning_config, temp_storage):
        ...
        assert similarity_similar > meta_learning_config.meta_learning.similarity_threshold
...
class TestOptimizationInsights:
    ...
    def test_insights_generation(self, basic_config, temp_storage):
        ...
        from pynomaly.infrastructure.automl.advanced_optimizer import OptimizationTrial, OptimizationResult
