...
class TestCrossAdapterCompatibility:
    ...
    def test_adapter_result_consistency(self, standardized_dataset):
        ...
        # Mock PyOD adapter
        with patch('pynomaly.infrastructure.adapters.pyod_adapter.importlib.import_module') as mock_pyod_import:
        ...
        with patch('pynomaly.infrastructure.adapters.sklearn_adapter.importlib.import_module') as mock_sklearn_import:
    ...
    def test_adapter_score_normalization(self, standardized_dataset):
        ...
        with patch('pynomaly.infrastructure.adapters.pyod_adapter.importlib.import_module') as mock_import:
            ...
            mock_model = Mock()
            mock_model.fit.return_value = None
            mock_model.decision_function.return_value = np.random.uniform(-100, 100, 1000)
            mock_model_class.return_value = mock_model
...
class TestAdapterErrorHandlingConsistency:
    ...
    def test_adapter_not_fitted_errors(self):
        ...
        with patch('pynomaly.infrastructure.adapters.pyod_adapter.importlib.import_module') as mock_import:
            ...
            mock_dataset.get_numeric_features.return_value = ['f1', 'f2', 'f3', 'f4', 'f5']
...
class TestAdapterPerformanceCharacteristics:
    ...
    def test_adapter_scalability_indicators(self):
        ...
        for algorithm, expected_time, expected_space in algorithms_and_complexities:
            with patch('pynomaly.infrastructure.adapters.pyod_adapter.importlib.import_module') as mock_import:
                mock_import.return_value = Mock()
                setattr(mock_import.return_value, algorithm.replace("IsolationForest", "IForest"), Mock())
