...
from pynomaly.infrastructure.data_loaders.enhanced_parquet_loader import EnhancedParquetLoader
...
class TestEnhancedParquetLoader:
    ...
    def test_init_pyarrow_missing(self):
        ...
        with patch('importlib.import_module', side_effect=ImportError("No module named 'pyarrow'")):
    ...
    def test_init_fastparquet_missing(self):
        ...
        with patch('importlib.import_module', side_effect=ImportError("No module named 'fastparquet'")):
    ...
    def test_load_success(self, mock_exists, mock_read_parquet):
        ...
        with patch.object(loader, 'validate', return_value=True), \
            ...
            result = loader.load("test.parquet", name="test_dataset", target_column="target")
    ...
    def test_load_target_column_not_found(self, mock_exists, mock_read_parquet):
        ...
        with patch.object(loader, 'validate', return_value=True), \
            ...
            with pytest.raises(DataValidationError, match="Target column 'missing' not found"):
    ...
    def test_validate_directory_with_parquet_files(self, mock_glob, mock_is_dir, mock_exists):
    ...
    @patch('pathlib.Path.is_dir')
    @patch('pathlib.Path.glob')
    def test_validate_directory_no_parquet_files(self, mock_glob, mock_is_dir, mock_exists):
    ...
    def test_validate_corrupt_parquet(self, mock_suffix, mock_is_file, mock_exists):
        ...
        with patch('pyarrow.parquet.read_metadata', side_effect=Exception("Corrupt file")):
