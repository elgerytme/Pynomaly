...
class TestDatabaseLoader:
    ...
    def test_supported_formats(self):
        ...
        expected_formats = ["postgresql", "mysql", "sqlite", "mssql", "oracle", "snowflake"]
    ...
    def test_get_engine_connection_failure(self, mock_create_engine):
        ...
        with pytest.raises(DataValidationError, match="Failed to create database connection"):
    ...
    def test_load_batch_query(self, mock_read_sql):
        ...
        with patch.object(loader, '_get_engine', return_value=mock_engine):
            batches = list(loader.load_batch(
                "SELECT * FROM test_table",
                batch_size=2,
                connection="sqlite:///test.db"
            ))
    ...
    def test_load_batch_no_connection(self):
        ...
        with pytest.raises(DataValidationError, match="No database connection provided"):
    ...
    def test_estimate_size_query(self):
        ...
        with patch.object(loader, '_get_engine', return_value=mock_engine):
            result = loader.estimate_size("SELECT * FROM large_table WHERE condition = 1")
    ...
    def test_list_schemas(self, mock_inspect):
        ...
        mock_inspector = Mock()
        mock_inspector.get_schema_names.return_value = ["public", "private", "analytics"]
        mock_inspect.return_value = mock_inspector
    ...
    def test_validate_connection_error(self):
        ...
        with patch.object(loader, '_get_engine', side_effect=Exception("Connection failed")):
    ...
    def test_load_connection_string_no_query_or_table(self):
        ...
        with pytest.raises(DataValidationError, match="Either table_name or query must be provided"):
