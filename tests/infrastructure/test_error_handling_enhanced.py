...
from pynomaly.domain.exceptions import (
    DetectorError, AdapterError, ValidationError, SecurityError,
    ModelError, DataError, ConfigurationError, NetworkError
)
...
class TestErrorHandler:
    ...
    def test_error_notification_system(self, error_handler):
        ...
        with patch('pynomaly.infrastructure.notifications.email_notifier.send_email') as mock_email, \
             patch('pynomaly.infrastructure.notifications.slack_notifier.send_message') as mock_slack:
...
class TestFallbackStrategy:
    ...
    def test_computation_fallback(self, fallback_strategy):
        ...
        result = fallback_strategy.execute_with_fallback(
            primary_operation=lambda: gpu_computation(data),
            context={"data": data}
        )
...
class TestErrorRecovery:
    ...
    def test_model_corruption_recovery(self):
        ...
        with patch.object(recovery, 'load_backup_model', side_effect=load_backup_model):
            ...
            result = recovery.recover_from_corruption(
                primary_loader=load_corrupted_model,
                model_id="test_model"
            )
    ...
    def test_network_error_recovery(self):
        ...
        result = recovery.recover_from_network_error(
            operation=unreliable_network_call,
            max_retries=3,
            backoff_factor=1.5
        )
    ...
    def test_concurrent_error_handling(self):
        ...
        from pynomaly.infrastructure.error_handling.concurrent import ConcurrentErrorHandler
...
class TestErrorHandlingIntegration:
    ...
    def test_distributed_error_handling(self):
        ...
        from pynomaly.infrastructure.error_handling.distributed import DistributedErrorHandler
