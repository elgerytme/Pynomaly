...
from pynomaly.infrastructure.monitoring.prometheus_metrics import (
    PrometheusMetricsService, initialize_metrics, get_metrics_service,
    MetricDefinition
)
...
class TestPrometheusMetricsService:
    ...
    def test_init_without_prometheus(self):
        ...
        with patch('pynomaly.infrastructure.monitoring.prometheus_metrics.PROMETHEUS_AVAILABLE', False):
